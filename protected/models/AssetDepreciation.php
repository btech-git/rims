 ...
 * @property Users $user
 */
class AssetDepreciation extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('transaction_number, transaction_date, transaction_time, asset_id, user_id', 'required'),
			array('number_of_month, asset_id, user_id', 'numerical', 'integerOnly'=>true),
			array('transaction_number', 'length', 'max'=>50),
			array('amount', 'length', 'max'=>18),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, transaction_number, transaction_date, transaction_time, amount, number_of_month, asset_id, user_id', 'safe', 'on'=>'search'),
		);
	}
