...
class VehicleInspection extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('work_order_number', 'length', 'max'=>20),
			array('status', 'length', 'max'=>10),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, vehicle_id, inspection_id, inspection_date, work_order_number, status, plate_number, service_advisor_id', 'safe', 'on'=>'search'),
		);
	}
