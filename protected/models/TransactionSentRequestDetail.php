 ...
 * @property string $sent_request_quantity_left
...
class TransactionSentRequestDetail extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('sent_request_id, product_id, unit_id, ', 'numerical', 'integerOnly' => true),
            array('unit_price, amount', 'length', 'max' => 18),
            array('quantity, sent_request_quantity_left, delivery_quantity', 'length', 'max' => 10),
