 ...
 * @property DivisionWarehouse[] $divisionWarehouses
...
class Division extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, name, status, code, is_deleted', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'divisionBranches' => array(self::HAS_MANY, 'DivisionBranch', 'division_id'),
			'divisionPositions' => array(self::HAS_MANY, 'DivisionPosition', 'division_id'),
			'employeeBranchDivisionPositionLevels' => array(self::HAS_MANY, 'EmployeeBranchDivisionPositionLevel', 'division_id'),
			'warehouseDivisions' => array(self::HAS_MANY, 'WarehouseDivision', 'division_id'),
		);
	}
