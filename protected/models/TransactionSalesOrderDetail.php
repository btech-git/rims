 ...
 * @property string $sales_order_quantity_left
 *
...
class TransactionSalesOrderDetail extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('sales_order_id, product_id, unit_id, discount_step, discount1_type, discount1_temp_quantity, discount2_type, discount2_temp_quantity, discount3_type, discount3_temp_quantity, discount4_type, discount4_temp_quantity, discount5_type, discount5_temp_quantity', 'numerical', 'integerOnly' => true),
            array('retail_price, unit_price, amount, discount1_temp_price, discount2_temp_price, discount3_temp_price, discount4_temp_price, discount5_temp_price, total_price, discount, subtotal', 'length', 'max' => 18),
            array('discount1_nominal, discount2_nominal, discount3_nominal, discount4_nominal, discount5_nominal, quantity, total_quantity, delivery_quantity, sales_order_quantity_left', 'length', 'max' => 10),
