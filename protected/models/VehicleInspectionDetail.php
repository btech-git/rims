...
class VehicleInspectionDetail extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('vehicle_inspection_id, section_id, module_id, checklist_type_id, checklist_module_id, checklist_module_radio, checklist_module_id_after_service', 'numerical', 'integerOnly' => true),
            array('value, value_after_service', 'length', 'max' => 50),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('id, vehicle_inspection_id, section_id, module_id, checklist_type_id, checklist_module_id, value, checklist_module_radio, checklist_module_id_after_service, value_after_service', 'safe', 'on' => 'search'),
        );
    }
    ...
    public function attributeLabels() {
        return array(
            ...
            'value' => 'Value',
            'checklist_module_id_after_service' => 'Checklist Module After Service',
