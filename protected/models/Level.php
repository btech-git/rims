...
class Level extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('name', 'required'),
            array('name','unique', 'message'=>'This Level already exists.'),
			array('name', 'length', 'max'=>30),
			array('name', 'unique', 'message'=>'Name exists.'),
	...
	public function relations()
	{
		...
		return array(
			'employeeBranchDivisionPositionLevels' => array(self::HAS_MANY,'EmployeeBranchDivisionPositionLevel', 'level_id'),
			'positionLevels' => array(self::HAS_MANY, 'PositionLevel', 'level_id'),
		);
	}
