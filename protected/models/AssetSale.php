...
class AssetSale extends MonthlyTransactionActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('asset_purchase_id, user_id', 'numerical', 'integerOnly' => true),
            array('transaction_number', 'length', 'max' => 50),
            array('sale_price', 'length', 'max' => 18),
            array('note', 'safe'),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('id, transaction_number, transaction_date, transaction_time, sale_price, note, asset_purchase_id, user_id', 'safe', 'on' => 'search'),
        );
    }
    ...
    public function generateCodeNumber($currentMonth, $currentYear, $branchId) {
        ...
        $assetPurchase = AssetSale::model()->find(array(
            'order' => ' id DESC',
