...
//        $criteria->params = array(':userId' => Yii::app()->user->id);
    ...
    public function searchByPendingDelivery() {
        ...
        $criteria->condition = "EXISTS (
            ...
            WHERE t.id = d.transfer_request_id AND t.status_document NOT IN ('Draft', 'Rejected') AND t.destination_approval_status = 1 AND t.transfer_request_date > '2021-12-31'
