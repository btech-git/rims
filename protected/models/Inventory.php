...
class Inventory extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('product_id, warehouse_id, total_stock, minimal_stock', 'numerical', 'integerOnly'=>true),
	...
	{
		// return $date1.$date2;
		// $model = InventoryDetail::model()->findAllByAttributes(array('inventory_id'=>$inventoryid, 'transaction_type'=>'Movement')); 

		// var_dump($this->date1.$this->date2);
		// die();
