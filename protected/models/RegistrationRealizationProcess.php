...
class RegistrationRealizationProcess extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('registration_transaction_id, registration_service_id, checked, checked_by, service_id', 'numerical', 'integerOnly' => true),
            array('name', 'length', 'max' => 50),
            array('checked_date, detail', 'safe'),
            // The following rule is used by search().
            // Please remove those attributes that should not be searched.
            array('id, registration_transaction_id, registration_service_id, name, checked, checked_by, checked_date, detail, service_id', 'safe', 'on' => 'search'),
        );
    }
