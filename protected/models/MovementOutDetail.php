...
class MovementOutDetail extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('movement_out_header_id, delivery_order_detail_id, return_order_detail_id, registration_product_id, registration_service_id, product_id, quantity_transaction, warehouse_id, quantity, quantity_receive, quantity_receive_left', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, movement_out_header_id, delivery_order_detail_id, return_order_detail_id, registration_product_id, registration_service_id, product_id, quantity_transaction, warehouse_id, quantity, quantity_receive, quantity_receive_left', 'safe', 'on'=>'search'),
		);
	}
