...
class MovementInDetail extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('receive_item_detail_id, return_item_detail_id, movement_in_header_id, product_id, quantity_transaction, quantity, warehouse_id', 'numerical', 'integerOnly'=>true),
