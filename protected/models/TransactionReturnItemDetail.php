...
class TransactionReturnItemDetail extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('return_item_id, product_id, quantity, quantity_delivery, quantity_left, barcode_product, quantity_movement, quantity_movement_left', 'numerical', 'integerOnly'=>true),
