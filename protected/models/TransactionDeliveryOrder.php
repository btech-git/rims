...
class TransactionDeliveryOrder extends MonthlyTransactionActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            array('delivery_order_no, delivery_date, posting_date, date_created, sender_id, sender_branch_id', 'required'),
