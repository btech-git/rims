 ...
 * @property string $quantity_good
 * @property string $quantity_reject
 * @property string $quantity_more
...
class TransactionDetailReceive extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            array('purchase_order_id, purchase_order_detail_id, receive_order_id, purchase_request_detail_id', 'numerical', 'integerOnly' => true),
            array('quantity_good, quantity_reject, quantity_more', 'length', 'max' => 10),
