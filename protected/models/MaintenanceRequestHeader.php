...
class MaintenanceRequestHeader extends MonthlyTransactionActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('id, transaction_number, transaction_date, transaction_time, description, note, maintenance_type, priority_level, branch_id, user_id, user_id_supervisor, user_id_requestor, status, is_inactive', 'safe', 'on' => 'search'),
        );
    }
