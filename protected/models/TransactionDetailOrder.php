 ...
 * @property string $receive_quantity_left
...
class TransactionDetailOrder extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            array('purchase_order_id, purchase_order_detail_id, purchase_request_id, purchase_request_detail_id, supplier_id, product_id', 'numerical', 'integerOnly' => true),
            array('unit_price, total_price', 'length', 'max' => 18),
            array('purchase_order_quantity, purchase_order_quantity_left, receive_quantity, receive_quantity_left', 'length', 'max' => 10),
