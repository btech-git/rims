...
class RegistrationService extends CActiveRecord {
    ...
    public function searchByGeneralRepairIdleManagement() {
        ...
        $criteria->addCondition("registrationTransaction.work_order_number IS NOT NULL AND registrationTransaction.repair_type = 'GR' AND registrationTransaction.status <> 'Finished'");
