...
/**
 * This is the model class for table "{{movement_out_approval}}".
 *
 * The followings are the available columns in table '{{movement_out_approval}}':
 * @property integer $id
...
class MovementOutApproval extends CActiveRecord {
    ...
    protected function afterSave() {
        ...
        $history->transaction_number = $this->movementOut->movement_out_no;
        $history->transaction_date = $this->movementOut->date_posting;
