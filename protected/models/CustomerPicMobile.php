...
/**
 * This is the model class for table "rims_customer_pic_mobile".
 *
 * The followings are the available columns in table 'rims_customer_pic_mobile':
 * @property integer $id
 ...
 */
class CustomerPicMobile extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return CustomerPicMobile the static model class
	 */
	...
	{
		return 'rims_customer_pic_mobile';
	}
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, customer_pic_id, mobile_no, status', 'safe', 'on'=>'search'),
		);
	}
