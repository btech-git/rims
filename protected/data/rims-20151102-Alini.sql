...
--
-- Host: localhost
-- Generation Time: Nov 02, 2015 at 06:07 AM
...
ALTER TABLE `rims_customer_pic_mobile`
  ADD PRIMARY KEY (`id`),
  ADD KEY `customer_pic_id` (`customer_pic_id`);
...
ALTER TABLE `rims_employee`
  ...
  ADD KEY `province_id` (`province_id`),
  ADD KEY `city_id` (`city_id`),
  ADD KEY `home_city` (`home_city`),
  ADD KEY `home_province` (`home_province`);
...
ALTER TABLE `rims_employee_bank`
  ADD PRIMARY KEY (`id`),
  ADD KEY `bank_id` (`bank_id`,`employee_id`),
...
ALTER TABLE `rims_product`
  ADD PRIMARY KEY (`id`),
  ADD KEY `product_master_category_id` (`product_master_category_id`),
  ADD KEY `product_sub_master_category_id` (`product_sub_master_category_id`),
  ADD KEY `product_sub_category_id` (`product_sub_category_id`),
  ADD KEY `product_type_id` (`product_specification_type_id`),
  ADD KEY `car_make_id` (`vehicle_car_make_id`),
  ADD KEY `car_model_id` (`vehicle_car_model_id`);
...
ALTER TABLE `rims_product_specification_info`
  ADD PRIMARY KEY (`id`),
  ADD KEY `product_specification_type_id` (`product_specification_type_id`);
...
ALTER TABLE `rims_product_sub_master_category`
  ADD PRIMARY KEY (`id`),
  ADD KEY `product_category_id` (`product_master_category_id`);
...
ALTER TABLE `rims_supplier_bank`
  ADD PRIMARY KEY (`id`),
  ADD KEY `bank_id` (`bank_id`,`supplier_id`),
...
ALTER TABLE `rims_supplier_pic_mobile`
  ADD PRIMARY KEY (`id`),
  ADD KEY `supplier_pic_id` (`supplier_pic_id`);
...
ALTER TABLE `rims_vehicle`
  ...
  ADD KEY `car_sub_model_id` (`car_sub_model_id`);
...
ALTER TABLE `rims_warehouse_division`
  ADD PRIMARY KEY (`id`),
  ADD KEY `warehouse_id` (`warehouse_id`,`division_id`),
  ADD KEY `division_id` (`division_id`);
