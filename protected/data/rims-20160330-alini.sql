...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 30, 2016 at 06:17 AM
...
INSERT INTO `rims_equipment_branch` (`id`, `branch_id`, `equipment_id`, `purchase_date`, `age`, `eq_condition`, `status`) VALUES
(1, 1, 1, '2015-11-02', 64, 'Good', 'Active'),
(2, 3, 1, '2015-12-03', 33, 'Good', 'Active');
...
INSERT INTO `rims_equipment_maintenance` (`id`, `equipment_task_id`, `equipment_branch_id`, `employee_id`, `maintenance_date`, `next_maintenance_date`, `checked`, `notes`, `condition`, `status`) VALUES
(1, 1, 1, 27, '2016-01-04', '2016-01-06', 'not-checked', '', '', 'Active');
...
`id` int(11) NOT NULL,
  ...
  `quantity` int(11) NOT NULL,
  `subtotal` decimal(10,2) NOT NULL,
  `request_order_quantity_rest` int(11) NOT NULL,
  `receive_order_quantity` int(11) NOT NULL,
  `purchase_order_quantity_rest` int(11) NOT NULL,
  `notes` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `rims_transaction_request_order` (`id`, `request_order_no`, `request_order_date`, `request_type`, `branch_issued`, `main_branch`, `estimation_date`, `payment_estimation_date`, `notes`, `total`, `total_items`, `approved_by`, `approved_status`, `decline_memo`) VALUES
(2, 'RO01', '2016-03-23', '', 1, 2, '2016-03-15', '2016-03-17', '', '3090600.00', 10, 0, '', '');
...
`id` int(11) NOT NULL,
  ...
  `price` decimal(10,2) DEFAULT NULL,
  `subtotal` decimal(10,2) NOT NULL,
  `purchase_order_quantity` int(11) NOT NULL,
...
INSERT INTO `rims_transaction_request_order_detail` (`id`, `request_order_id`, `product_id`, `supplier_id`, `unit_id`, `discount_step`, `discount1_type`, `discount1_nominal`, `discount2_type`, `discount2_nominal`, `discount3_type`, `discount3_nominal`, `discount4_type`, `discount4_nominal`, `discount5_type`, `discount5_nominal`, `quantity`, `price`, `subtotal`, `purchase_order_quantity`, `request_order_quantity`, `notes`, `retail_price`) VALUES
(2, 2, 4, 1, 1, 1, 1, '10.00', NULL, '0.00', NULL, '0.00', NULL, '0.00', NULL, '0.00', 10, '309060.00', '3090600.00', 0, 0, '', '343400.00'),
(3, 2, 4, 2, 1, 1, 1, '10.00', NULL, '0.00', NULL, '0.00', NULL, '0.00', NULL, '0.00', 10, '309060.00', '3090600.00', 0, 0, '', '343400.00'),
(4, 2, 4, 1, 1, 1, 1, '10.00', NULL, '0.00', NULL, '0.00', NULL, '0.00', NULL, '0.00', 10, '309060.00', '3090600.00', 0, 0, '', '343400.00');
...
ALTER TABLE `rims_equipment_maintenance`
 ADD PRIMARY KEY (`id`), ADD KEY `equipment_task_id` (`equipment_task_id`), ADD KEY `equipment_branch_id` (`equipment_branch_id`), ADD KEY `employee_id` (`employee_id`);
...
ALTER TABLE `rims_transaction_purchase_order`
 ADD PRIMARY KEY (`id`), ADD KEY `supplier_id` (`supplier_id`), ADD KEY `branch_issued` (`branch_issued`);

--
-- Indexes for table `rims_transaction_purchase_order_detail`
--
ALTER TABLE `rims_transaction_purchase_order_detail`
 ADD PRIMARY KEY (`id`), ADD KEY `request_order_id` (`request_order_id`), ADD KEY `product_id` (`product_id`), ADD KEY `purchase_order_id` (`purchase_order_id`), ADD KEY `branch_addressed_to` (`branch_addressed_to`), ADD KEY `unit_id` (`unit_id`);
...
ADD CONSTRAINT `rims_equipment_branch_ibfk_2` FOREIGN KEY (`equipment_id`) REFERENCES `rims_equipments` (`id`);
