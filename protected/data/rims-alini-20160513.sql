...
--
-- Host: 127.0.0.1
-- Generation Time: May 13, 2016 at 11:46 AM
...
(6, 'RO012', '2016-04-15', 1, 4, 20160422, 0, 38250000, 100, NULL, 'Need Revise', '');
...
(1, 6, 1, 1, '0000-00-00', 1, 1, 1, '10.00', NULL, '0.00', NULL, '0.00', NULL, '0.00', NULL, '0.00', 100, 100, '343400.00', '382500.00', '38250000.00', 12, 88, '', '425000.00', NULL, NULL),
(2, 6, 2, 1, '0000-00-00', 1, 1, 1, '10.00', NULL, '0.00', NULL, '0.00', NULL, '0.00', NULL, '0.00', 100, 100, '343400.00', '382500.00', '38250000.00', 12, 88, '', '425000.00', NULL, NULL),
(3, 6, 1, 2, '0000-00-00', 1, 1, 1, '10.00', NULL, '0.00', NULL, '0.00', NULL, '0.00', NULL, '0.00', 100, 100, '343400.00', '382500.00', '38250000.00', NULL, 100, '', '425000.00', NULL, NULL);
...
--
-- Table structure for table `transaction_request_order_approval`
--

CREATE TABLE IF NOT EXISTS `transaction_request_order_approval` (
`id` int(11) NOT NULL,
  `request_order_detail_id` int(11) DEFAULT NULL,
...
--
-- Indexes for table `transaction_request_order_approval`
--
ALTER TABLE `transaction_request_order_approval`
 ADD PRIMARY KEY (`id`);
...
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `transaction_request_order_approval`
--
ALTER TABLE `transaction_request_order_approval`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
