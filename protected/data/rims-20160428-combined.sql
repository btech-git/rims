...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 28, 2016 at 06:35 AM
...
INSERT INTO `rims_company` (`id`, `name`, `address`, `province_id`, `city_id`, `phone`, `npwp`, `transaction_type`) VALUES
(1, 'Testing', 'test', 12, 38, '12314', '13214141242141', 'PKP');
...
(1, 2, 'Ewq23', 'Suzuki', '2016-04-01', 20, 100, 'Active'),
...
(7, 'PO012', '2016-04-19', 4, 1, '2016-04-02', '2016-05-15', 10, '9180000.00', '10098000.00', 24, 1, 'Approved', 'Testing', 'TEst');
...
`id` int(11) NOT NULL,
  ...
  `approved_status` varchar(20) DEFAULT NULL,
  `decline_memo` text,
  `branch_approved_id` int(11) DEFAULT NULL,
  `branch_approved_status` varchar(20) DEFAULT NULL,
  `branch_approved_notes` text
...
INSERT INTO `rims_transaction_request_order` (`id`, `request_order_no`, `request_order_date`, `request_type`, `branch_issued`, `main_branch`, `estimation_date`, `notes`, `total`, `total_items`, `approved_by`, `approved_status`, `decline_memo`, `branch_approved_id`, `branch_approved_status`, `branch_approved_notes`) VALUES
(5, 'RO01', '2016-03-08', 'Request for Transfer', 1, 2, '2016-06-01', 'TEsts', '0.00', 10, 1, '', 'TEst', 1, 'Need Revise', 'test'),
(6, 'RO012', '2016-04-15', 'Request for Purchase', 1, 4, '2016-04-22', 'Purchasing', '38250000.00', 100, NULL, 'Need Revise', '', NULL, NULL, NULL);
...
ADD CONSTRAINT `rims_equipment_maintenances_ibfk_4` FOREIGN KEY (`employee_id`) REFERENCES `rims_employee` (`id`);
