...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 19, 2015 at 05:00 AM
...
INSERT INTO `rims_product` (`id`, `code`, `manufacturer_code`, `name`, `description`, `production_year`, `extension`, `product_master_category_id`, `product_sub_master_category_id`, `product_sub_category_id`, `product_specification_type_id`, `vehicle_car_make_id`, `vehicle_car_model_id`, `purchase_price`, `recommended_selling_price`, `hpp`, `retail_price`, `stock`, `minimum_stock`, `margin_type`, `margin_amount`, `is_usable`, `status`) VALUES
(4, 'AA01', 12345, 'Test', 'Test', 1950, '1234', 1, 1, 1, NULL, NULL, NULL, NULL, '0.00', NULL, '1234.00', 1234, 123, 1, 123, 'No', 'Active');
...
--
-- Dumping data for table `rims_product_vehicle`
--

INSERT INTO `rims_product_vehicle` (`id`, `product_id`, `vehicle_car_make_id`, `vehicle_car_model_id`) VALUES
(3, 4, 1, 1);
...
ALTER TABLE `rims_chasis_code`
 ADD PRIMARY KEY (`id`), ADD KEY `car_make_id` (`car_make_id`);
