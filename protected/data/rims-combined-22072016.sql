...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 22, 2016 at 01:12 PM
...
--
-- Dumping data for table `rims_company`
--

INSERT INTO `rims_company` (`id`, `name`, `address`, `province_id`, `city_id`, `branch_id`, `phone`, `npwp`, `transaction_type`) VALUES
(1, 'Testing', 'test', 12, 38, 1, '12314', '13214141242141', 'PKP');
...
--
-- Dumping data for table `rims_company_bank`
--

INSERT INTO `rims_company_bank` (`id`, `company_id`, `bank_id`, `account_no`, `account_name`, `status`) VALUES
(1, 1, 7, '23132131', 'Alini T', '');
...
--
-- Dumping data for table `rims_company_branch`
--

INSERT INTO `rims_company_branch` (`id`, `company_id`, `branch_id`) VALUES
(1, 1, 1),
(2, 1, 2);
...
--
-- Table structure for table `rims_equipment_details`
--

CREATE TABLE IF NOT EXISTS `rims_equipment_details` (
`id` int(11) NOT NULL,
...
--
-- Dumping data for table `rims_equipment_details`
--

INSERT INTO `rims_equipment_details` (`id`, `equipment_id`, `equipment_code`, `brand`, `purchase_date`, `age`, `quantity`, `status`) VALUES
(2, 1, 'EWR4', 'hitachi', '2015-05-03', 357, 400, 'Active'),
(3, 3, 'EWR45', 'hitachi', '2016-04-01', 23, 150, 'Active'),
(7, 1, 'xvxdfs', 'fsf', '2016-05-01', 10, 0, 'Active'),
(8, 2, '123', 'ABC', '2016-07-04', 14, 0, 'Active'),
(9, 2, '456', 'DEF', '2016-07-01', 17, 0, 'Active');
...
--
-- Table structure for table `rims_equipment_maintenances`
--

CREATE TABLE IF NOT EXISTS `rims_equipment_maintenances` (
`id` int(11) NOT NULL,
  `equipment_id` int(11) NOT NULL,
  `equipment_task_id` int(11) NOT NULL,
  `equipment_detail_id` int(11) NOT NULL,
  `employee_id` int(11) NOT NULL,
  `maintenance_date` date NOT NULL,
  `next_maintenance_date` date NOT NULL,
  `check_date` date NOT NULL,
  `checked` enum('Checked','Un-checked') NOT NULL DEFAULT 'Checked',
  `notes` text NOT NULL,
  `equipment_condition` enum('Good','Bad','Check','Replacement') NOT NULL DEFAULT 'Good',
  `status` enum('Active','Inactive') NOT NULL DEFAULT 'Active'
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=44 ;

--
-- Dumping data for table `rims_equipment_maintenances`
--

INSERT INTO `rims_equipment_maintenances` (`id`, `equipment_id`, `equipment_task_id`, `equipment_detail_id`, `employee_id`, `maintenance_date`, `next_maintenance_date`, `check_date`, `checked`, `notes`, `equipment_condition`, `status`) VALUES
(1, 1, 2, 2, 29, '2016-05-07', '2016-11-05', '2016-05-07', 'Checked', '', 'Good', 'Active'),
(2, 1, 2, 2, 29, '2016-05-15', '2016-11-13', '2016-05-15', 'Checked', '', 'Good', 'Active'),
(3, 1, 1, 2, 27, '2016-05-01', '2017-05-01', '2016-05-01', 'Checked', '', 'Good', 'Active'),
(4, 1, 1, 2, 26, '2016-05-01', '2017-05-01', '2016-05-01', 'Checked', '', 'Good', 'Active'),
(5, 1, 1, 2, 29, '2016-05-01', '2017-05-01', '2016-05-01', 'Checked', '', 'Good', 'Active'),
(6, 1, 2, 2, 29, '2016-05-07', '2016-11-05', '2016-05-07', 'Checked', '', 'Good', 'Active'),
(7, 1, 2, 2, 29, '2016-05-15', '2016-11-13', '2016-05-15', 'Checked', '', 'Good', 'Active'),
(8, 2, 5, 8, 0, '2016-07-01', '2016-07-08', '0000-00-00', 'Checked', '', 'Good', 'Active'),
(9, 2, 5, 8, 0, '2016-07-08', '2016-07-15', '0000-00-00', 'Checked', '', 'Good', 'Active'),
(10, 2, 5, 8, 0, '2016-07-15', '2016-07-22', '2016-07-18', 'Checked', '', 'Good', 'Active'),
(11, 2, 5, 8, 0, '2016-07-22', '2016-07-29', '0000-00-00', 'Checked', '', 'Good', 'Active'),
(12, 2, 6, 8, 0, '2016-07-01', '2016-07-31', '0000-00-00', 'Checked', '', 'Good', 'Active'),
(13, 2, 6, 8, 0, '2016-07-31', '2016-08-30', '0000-00-00', 'Checked', '', 'Good', 'Active'),
(14, 2, 6, 8, 0, '2016-08-30', '2016-09-29', '0000-00-00', 'Checked', '', 'Good', 'Active'),
(15, 2, 6, 8, 0, '2016-09-29', '2016-10-29', '0000-00-00', 'Checked', '', 'Good', 'Active'),
(16, 2, 6, 8, 0, '2016-10-29', '2016-11-28', '0000-00-00', 'Checked', '', 'Good', 'Active'),
(17, 2, 6, 8, 0, '2016-11-28', '2016-12-28', '0000-00-00', 'Checked', '', 'Good', 'Active'),
(18, 2, 6, 8, 0, '2016-12-28', '2017-01-27', '0000-00-00', 'Checked', '', 'Good', 'Active'),
(19, 2, 6, 8, 0, '2017-01-27', '2017-02-26', '0000-00-00', 'Checked', '', 'Good', 'Active'),
(20, 2, 6, 8, 0, '2017-02-26', '2017-03-28', '0000-00-00', 'Checked', '', 'Good', 'Active'),
(21, 2, 6, 8, 0, '2017-03-28', '2017-04-27', '0000-00-00', 'Checked', '', 'Good', 'Active'),
(22, 2, 6, 8, 0, '2017-04-27', '2017-05-27', '0000-00-00', 'Checked', '', 'Good', 'Active'),
(23, 2, 6, 8, 0, '2017-05-27', '2017-06-26', '0000-00-00', 'Checked', '', 'Good', 'Active'),
(24, 2, 5, 9, 0, '2016-07-01', '2016-07-08', '0000-00-00', 'Checked', '', 'Good', 'Active'),
(25, 2, 5, 9, 0, '2016-07-08', '2016-07-15', '0000-00-00', 'Checked', '', 'Good', 'Active'),
(26, 2, 5, 9, 0, '2016-07-15', '2016-07-22', '0000-00-00', 'Checked', '', 'Good', 'Active'),
(27, 2, 5, 9, 0, '2016-07-22', '2016-07-29', '0000-00-00', 'Checked', '', 'Good', 'Active'),
(28, 2, 6, 9, 0, '2016-07-01', '2016-07-31', '0000-00-00', 'Checked', '', 'Good', 'Active'),
(29, 2, 6, 9, 0, '2016-07-31', '2016-08-30', '0000-00-00', 'Checked', '', 'Good', 'Active'),
(30, 2, 6, 9, 0, '2016-08-30', '2016-09-29', '0000-00-00', 'Checked', '', 'Good', 'Active'),
(31, 2, 6, 9, 0, '2016-09-29', '2016-10-29', '0000-00-00', 'Checked', '', 'Good', 'Active'),
(32, 2, 6, 9, 0, '2016-10-29', '2016-11-28', '0000-00-00', 'Checked', '', 'Good', 'Active'),
(33, 2, 6, 9, 0, '2016-11-28', '2016-12-28', '0000-00-00', 'Checked', '', 'Good', 'Active'),
(34, 2, 6, 9, 0, '2016-12-28', '2017-01-27', '0000-00-00', 'Checked', '', 'Good', 'Active'),
(35, 2, 6, 9, 0, '2017-01-27', '2017-02-26', '0000-00-00', 'Checked', '', 'Good', 'Active'),
(36, 2, 6, 9, 0, '2017-02-26', '2017-03-28', '0000-00-00', 'Checked', '', 'Good', 'Active'),
(37, 2, 6, 9, 0, '2017-03-28', '2017-04-27', '0000-00-00', 'Checked', '', 'Good', 'Active'),
(38, 2, 6, 9, 0, '2017-04-27', '2017-05-27', '0000-00-00', 'Checked', '', 'Good', 'Active'),
(39, 2, 6, 9, 0, '2017-05-27', '2017-06-26', '0000-00-00', 'Checked', '', 'Good', 'Active'),
(40, 3, 3, 3, 26, '2016-07-01', '2016-09-30', '2016-07-21', 'Checked', '', 'Good', 'Active'),
(41, 3, 3, 3, 0, '2016-09-30', '2016-12-30', '0000-00-00', 'Checked', '', 'Good', 'Active'),
(42, 3, 3, 3, 0, '2016-12-30', '2017-03-31', '0000-00-00', 'Checked', '', 'Good', 'Active'),
(43, 3, 3, 3, 0, '2017-03-31', '2017-06-30', '0000-00-00', 'Checked', '', 'Good', 'Active');
...
(5, 2, 'Weekly', 'Weekly', 'Active'),
(6, 2, 'Monthly', 'Monthly', 'Active');
...
`id` int(11) NOT NULL,
  ...
  `is_inventory` varchar(5) DEFAULT NULL
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=4 ;
...
INSERT INTO `rims_product_unit` (`id`, `product_id`, `unit_id`, `unit_type`, `is_inventory`) VALUES
(1, 1, 8, 'Main', 'Yes'),
(3, 1, 9, 'Service', 'No');
...
(2, 'GR-AC-2', 'COMB:OPPOSITE SIDE ', '123', 1, 1, 'Active', 1),
...
--
-- Table structure for table `rims_service_material`
--

CREATE TABLE IF NOT EXISTS `rims_service_material` (
`id` int(11) NOT NULL,
  `service_id` int(11) NOT NULL,
  `product_id` int(11) NOT NULL,
...
--
-- Dumping data for table `rims_service_material`
--

INSERT INTO `rims_service_material` (`id`, `service_id`, `product_id`, `easy`, `medium`, `hard`) VALUES
(5, 1, 1, 1, 2, 3),
(6, 1, 2, 1, 2, 3),
(9, 2, 1, 1, 2, 3),
(10, 2, 8, 4, 5, 6);
...
(2, 3, '2016-06-15', 'Pic 1', 'pic 1234', 'PT. Astra International', 'Purchasing', 'JL123134', 12, 40, '11340', '02198321212', 'pic@gmail.com', 'pic@sp3.com', '323138912313', 'Testing', 'Active');
...
--
-- Dumping data for table `rims_supplier_product`
--

INSERT INTO `rims_supplier_product` (`id`, `product_id`, `supplier_id`) VALUES
(1, 1, 2),
(2, 2, 2),
(3, 1, 1),
(4, 2, 1),
...
--
-- Table structure for table `rims_transaction_delivery_order`
--

CREATE TABLE IF NOT EXISTS `rims_transaction_delivery_order` (
`id` int(11) NOT NULL,
  ...
  `sent_request_id` int(11) DEFAULT NULL,
  `request_date` date DEFAULT NULL,
  `estimate_arrival_date` date DEFAULT NULL,
  `destination_branch` int(11) DEFAULT NULL,
  `customer_id` int(11) DEFAULT NULL
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=15 ;

--
-- Dumping data for table `rims_transaction_delivery_order`
--

INSERT INTO `rims_transaction_delivery_order` (`id`, `delivery_order_no`, `delivery_date`, `posting_date`, `sender_id`, `sender_branch_id`, `request_type`, `sales_order_id`, `sent_request_id`, `request_date`, `estimate_arrival_date`, `destination_branch`, `customer_id`) VALUES
(7, 'DO1S', '2016-07-21', '2016-07-21', 1, 2, 'Sales Order', 1, 1, '2016-07-18', '2016-08-07', NULL, 2),
(11, 'DO121', '2016-07-21', '2016-07-21', 1, 3, 'Sent Request', NULL, 1, '2016-07-18', '2016-07-18', 1, 2),
(13, 'DO1S', '2016-07-21', '2016-07-21', 1, 2, 'Sales Order', 1, NULL, '2016-07-18', '2016-08-07', NULL, 2),
(14, '1234', '2016-07-21', '2016-07-21', NULL, NULL, 'Sales Order', 1, NULL, '2016-07-18', '2016-08-07', NULL, 2);

-- --------------------------------------------------------

--
-- Table structure for table `rims_transaction_delivery_order_detail`
--

CREATE TABLE IF NOT EXISTS `rims_transaction_delivery_order_detail` (
`id` int(11) NOT NULL,
  `delivery_order_id` int(11) DEFAULT NULL,
  `sales_order_detail_id` int(11) DEFAULT NULL,
  `sent_request_detail_id` int(11) DEFAULT NULL,
  `product_id` int(11) DEFAULT NULL,
  `quantity_request` int(11) DEFAULT NULL,
  `quantity_delivery` int(11) DEFAULT NULL,
  `quantity_request_left` int(11) DEFAULT NULL,
  `note` text,
...
--
-- Dumping data for table `rims_transaction_delivery_order_detail`
--

INSERT INTO `rims_transaction_delivery_order_detail` (`id`, `delivery_order_id`, `sales_order_detail_id`, `sent_request_detail_id`, `product_id`, `quantity_request`, `quantity_delivery`, `quantity_request_left`, `note`, `barcode_product`, `temp_quantity`) VALUES
(3, 7, 1, NULL, 1, 100, 5, 95, '', '', 0),
(4, 11, NULL, 1, 6, 10, 5, 5, '', '', 0),
(6, 13, 1, NULL, 1, 100, 5, 95, '', '', NULL),
(7, 14, 1, NULL, 1, 100, 10, 80, '', '', NULL);

-- --------------------------------------------------------

--
-- Table structure for table `rims_transaction_detail_order`
--

CREATE TABLE IF NOT EXISTS `rims_transaction_detail_order` (
`id` int(11) NOT NULL,
  ...
  `purchase_order_quantity_left` int(11) DEFAULT NULL,
  `receive_quantity` int(11) DEFAULT NULL,
  `receive_quantity_left` int(11) DEFAULT NULL,
  `purchase_order_estimate_arrival_date` date DEFAULT NULL,
...
--
-- Dumping data for table `rims_transaction_detail_order`
--

INSERT INTO `rims_transaction_detail_order` (`id`, `purchase_order_id`, `purchase_order_detail_id`, `purchase_request_id`, `purchase_request_detail_id`, `purchase_order_quantity`, `purchase_order_quantity_left`, `receive_quantity`, `receive_quantity_left`, `purchase_order_estimate_arrival_date`, `unit_price`, `total_price`, `supplier_id`, `product_id`) VALUES
(5, 1, 1, 1, 1, 5, 5, NULL, NULL, '2016-08-17', '382500.00', NULL, 1, 1);

-- --------------------------------------------------------

--
-- Table structure for table `rims_transaction_detail_receive`
--

CREATE TABLE IF NOT EXISTS `rims_transaction_detail_receive` (
`id` int(11) NOT NULL,
  `purchase_order_id` int(11) DEFAULT NULL,
  `purchase_order_detail_id` int(11) DEFAULT NULL,
  `receive_order_id` int(11) DEFAULT NULL,
  `quantity_good` int(11) DEFAULT NULL,
  `quantity_reject` int(11) DEFAULT NULL,
  `quantity_more` int(11) DEFAULT NULL,
  `purchase_order_estimate_arrival_date` date DEFAULT NULL,
  `receive_order_estimate_arrival_date` date DEFAULT NULL,
  `purchase_request_detail_id` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
`id` int(11) NOT NULL,
  ...
  `status_document` varchar(30) DEFAULT NULL,
  `supplier_id` int(11) DEFAULT NULL,
  `payment_type` varchar(20) DEFAULT NULL,
  `estimate_date_arrival` date DEFAULT NULL,
  `requester_id` int(11) DEFAULT NULL,
  `requester_branch_id` int(11) DEFAULT NULL,
...
INSERT INTO `rims_transaction_purchase_order` (`id`, `purchase_order_no`, `purchase_order_date`, `status_document`, `supplier_id`, `payment_type`, `estimate_date_arrival`, `requester_id`, `requester_branch_id`, `main_branch_id`, `approved_id`, `total_quantity`, `total_price`) VALUES
(1, 'PO016', '2016-07-20', 'Draft', 1, 'Cash', '2016-08-17', NULL, NULL, 1, NULL, 5, '1912500.00');

-- --------------------------------------------------------

--
-- Table structure for table `rims_transaction_purchase_order_approval`
--

CREATE TABLE IF NOT EXISTS `rims_transaction_purchase_order_approval` (
`id` int(11) NOT NULL,
  `purchase_order_detail_id` int(11) NOT NULL,
  `revision` int(11) DEFAULT NULL,
  `approval_type` varchar(30) DEFAULT NULL,
  `date` date DEFAULT NULL,
...
`id` int(11) NOT NULL,
  ...
  `discount1_temp_quantity` int(11) DEFAULT NULL,
  `discount1_temp_price` decimal(18,2) DEFAULT NULL,
  `discount2_type` int(11) DEFAULT NULL,
  `discount2_nominal` decimal(10,2) DEFAULT NULL,
  `discount2_temp_quantity` int(11) DEFAULT NULL,
  `discount2_temp_price` decimal(18,2) DEFAULT NULL,
  `discount3_type` int(11) DEFAULT NULL,
  `discount3_nominal` decimal(10,2) DEFAULT NULL,
  `discount3_temp_quantity` int(11) DEFAULT NULL,
  `discount3_temp_price` decimal(18,2) DEFAULT NULL,
  `discount4_type` int(11) DEFAULT NULL,
  `discount4_nominal` decimal(10,2) DEFAULT NULL,
  `discount4_temp_quantity` int(11) DEFAULT NULL,
  `discount4_temp_price` decimal(18,2) DEFAULT NULL,
  `discount5_type` int(11) DEFAULT NULL,
  `discount5_nominal` decimal(10,2) DEFAULT NULL,
  `discount5_temp_quantity` int(11) DEFAULT NULL,
  `discount5_temp_price` decimal(18,2) DEFAULT NULL,
  `total_quantity` int(11) DEFAULT NULL,
  `total_price` decimal(18,2) DEFAULT NULL,
  `receive_quantity` int(11) DEFAULT NULL,
  `purchase_order_quantity_left` int(11) DEFAULT NULL
...
INSERT INTO `rims_transaction_purchase_order_detail` (`id`, `purchase_order_id`, `product_id`, `unit_id`, `retail_price`, `quantity`, `unit_price`, `amount`, `discount_step`, `discount1_type`, `discount1_nominal`, `discount1_temp_quantity`, `discount1_temp_price`, `discount2_type`, `discount2_nominal`, `discount2_temp_quantity`, `discount2_temp_price`, `discount3_type`, `discount3_nominal`, `discount3_temp_quantity`, `discount3_temp_price`, `discount4_type`, `discount4_nominal`, `discount4_temp_quantity`, `discount4_temp_price`, `discount5_type`, `discount5_nominal`, `discount5_temp_quantity`, `discount5_temp_price`, `total_quantity`, `total_price`, `receive_quantity`, `purchase_order_quantity_left`) VALUES
(1, 1, 1, 1, '425000.00', 5, '382500.00', 1000, 1, 1, '10.00', 5, '1912500.00', NULL, '0.00', NULL, '0.00', NULL, '0.00', NULL, '0.00', NULL, '0.00', NULL, '0.00', NULL, '0.00', NULL, '0.00', 5, '1912500.00', 2, 3);

-- --------------------------------------------------------

--
-- Table structure for table `rims_transaction_purchase_order_detail_request`
--

CREATE TABLE IF NOT EXISTS `rims_transaction_purchase_order_detail_request` (
`id` int(11) NOT NULL,
  `purchase_order_detail_id` int(11) NOT NULL,
  `purchase_request_id` int(11) DEFAULT NULL,
  `purchase_request_detail_id` int(11) DEFAULT NULL,
  `purchase_request_quantity` int(11) DEFAULT NULL,
  `estimate_date_arrival` date DEFAULT NULL,
  `purchase_request_branch_id` int(11) DEFAULT NULL,
  `purchase_order_quantity` int(11) DEFAULT NULL,
  `notes` text
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=6 ;

--
-- Dumping data for table `rims_transaction_purchase_order_detail_request`
--

INSERT INTO `rims_transaction_purchase_order_detail_request` (`id`, `purchase_order_detail_id`, `purchase_request_id`, `purchase_request_detail_id`, `purchase_request_quantity`, `estimate_date_arrival`, `purchase_request_branch_id`, `purchase_order_quantity`, `notes`) VALUES
(5, 1, 1, 1, 10, '2016-08-17', 1, 5, '');

-- --------------------------------------------------------

--
-- Table structure for table `rims_transaction_receive_item`
--

CREATE TABLE IF NOT EXISTS `rims_transaction_receive_item` (
`id` int(11) NOT NULL,
  `receive_item_no` varchar(30) DEFAULT NULL,
  `receive_item_date` date DEFAULT NULL,
  `arrival_date` date DEFAULT NULL,
  `recipient_id` int(11) DEFAULT NULL,
  `recipient_branch_id` int(11) DEFAULT NULL,
  `request_type` varchar(30) DEFAULT NULL,
  `request_date` date DEFAULT NULL,
  `estimate_arrival_date` date DEFAULT NULL,
  `destination_branch` int(11) DEFAULT NULL,
...
--
-- Dumping data for table `rims_transaction_receive_item`
--

INSERT INTO `rims_transaction_receive_item` (`id`, `receive_item_no`, `receive_item_date`, `arrival_date`, `recipient_id`, `recipient_branch_id`, `request_type`, `request_date`, `estimate_arrival_date`, `destination_branch`, `supplier_id`, `purchase_order_id`, `transfer_request_id`) VALUES
(3, 'RI1', '2016-07-18', '2016-07-18', 1, 1, 'Transfer Request', '2016-07-18', '2016-07-21', 2, NULL, NULL, 1),
(10, 'RI01001', '2016-07-20', '2016-07-20', 1, 1, 'Purchase Order', '2016-07-20', '2016-08-17', NULL, 1, 1, NULL),
(11, 'RI1', '2016-07-21', '2016-07-21', 1, 2, 'Purchase Order', '2016-07-20', '2016-08-17', NULL, 1, 1, NULL),
(13, 'RIT', '2016-07-20', '2016-07-20', 1, 3, 'Transfer Request', '2016-07-18', '2016-07-21', 2, NULL, NULL, 1),
(14, 'TTTT', '2016-07-21', '2016-07-21', 1, 1, 'Transfer Request', '2016-07-18', '2016-07-21', 2, NULL, NULL, 1);

-- --------------------------------------------------------

--
-- Table structure for table `rims_transaction_receive_item_detail`
--

CREATE TABLE IF NOT EXISTS `rims_transaction_receive_item_detail` (
`id` int(11) NOT NULL,
  `receive_item_id` int(11) DEFAULT NULL,
  `purchase_order_detail_id` int(11) DEFAULT NULL,
  `transfer_request_detail_id` int(11) DEFAULT NULL,
  `product_id` int(11) DEFAULT NULL,
  `qty_request` int(11) DEFAULT NULL,
  `qty_good` int(11) DEFAULT NULL,
  `qty_reject` int(11) DEFAULT NULL,
  `qty_more` int(11) DEFAULT NULL,
  `note` text,
  `qty_request_left` int(11) DEFAULT NULL,
  `barcode_product` varchar(30) DEFAULT NULL
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=9 ;

--
-- Dumping data for table `rims_transaction_receive_item_detail`
--

INSERT INTO `rims_transaction_receive_item_detail` (`id`, `receive_item_id`, `purchase_order_detail_id`, `transfer_request_detail_id`, `product_id`, `qty_request`, `qty_good`, `qty_reject`, `qty_more`, `note`, `qty_request_left`, `barcode_product`) VALUES
(6, 11, 1, NULL, 1, 5, 2, NULL, NULL, '', 3, ''),
(7, 13, NULL, 1, 1, 10, 5, NULL, NULL, '', 5, ''),
(8, 14, NULL, 1, 1, 10, 3, NULL, NULL, '', 2, '');
...
`id` int(11) NOT NULL,
  ...
  `main_branch_id` int(11) DEFAULT NULL,
  `main_branch_approved_by` int(11) DEFAULT NULL,
  `approved_by` int(11) DEFAULT NULL,
  `total_items` int(11) DEFAULT NULL,
  `total_price` decimal(18,2) DEFAULT NULL,
  `status_document` varchar(20) DEFAULT NULL,
  `notes` text
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=2 ;
...
INSERT INTO `rims_transaction_request_order` (`id`, `request_order_no`, `request_order_date`, `requester_id`, `requester_branch_id`, `main_branch_id`, `main_branch_approved_by`, `approved_by`, `total_items`, `total_price`, `status_document`, `notes`) VALUES
(1, 'RO012', '2016-07-18', 1, 1, 3, NULL, NULL, 10, '3825000.00', 'Draft', 'test');

-- --------------------------------------------------------

--
-- Table structure for table `rims_transaction_request_order_approval`
--

CREATE TABLE IF NOT EXISTS `rims_transaction_request_order_approval` (
`id` int(11) NOT NULL,
...
--
-- Dumping data for table `rims_transaction_request_order_approval`
--

INSERT INTO `rims_transaction_request_order_approval` (`id`, `request_order_detail_id`, `revision`, `approval_type`, `date`, `note`, `supervisor_id`) VALUES
(1, 1, 0, 'Revised', '2016-07-18', '5', 1);
...
`id` int(11) NOT NULL,
  ...
  `quantity` int(11) NOT NULL,
  `total_quantity` int(11) DEFAULT NULL,
  `last_buying_price` decimal(18,2) DEFAULT NULL,
  `unit_price` decimal(18,2) DEFAULT NULL,
  ...
  `amount_item` int(11) DEFAULT NULL,
  `discount1_temp_quantity` int(11) DEFAULT NULL,
  `discount1_temp_price` decimal(18,2) DEFAULT NULL,
  `discount2_temp_quantity` int(11) DEFAULT NULL,
  `discount2_temp_price` decimal(18,2) DEFAULT NULL,
...
INSERT INTO `rims_transaction_request_order_detail` (`id`, `request_order_id`, `product_id`, `supplier_id`, `estimated_arrival_date`, `unit_id`, `discount_step`, `discount1_type`, `discount1_nominal`, `discount2_type`, `discount2_nominal`, `discount3_type`, `discount3_nominal`, `discount4_type`, `discount4_nominal`, `discount5_type`, `discount5_nominal`, `quantity`, `total_quantity`, `last_buying_price`, `unit_price`, `total_price`, `purchase_order_quantity`, `request_order_quantity_rest`, `notes`, `retail_price`, `approval`, `amount_item`, `discount1_temp_quantity`, `discount1_temp_price`, `discount2_temp_quantity`, `discount2_temp_price`, `discount3_temp_quantity`, `discount3_temp_price`, `discount4_temp_quantity`, `discount4_temp_price`, `discount5_temp_quantity`, `discount5_temp_price`) VALUES
(1, 1, 1, 2, '2016-08-17', 1, 1, 1, '10.00', NULL, '0.00', NULL, '0.00', NULL, '0.00', NULL, '0.00', 10, 10, '225000.00', '382500.00', '3825000.00', NULL, 10, NULL, '425000.00', NULL, 1000, 10, '3825000.00', NULL, '0.00', NULL, '0.00', NULL, '0.00', NULL, '0.00');
...
`id` int(11) NOT NULL,
  `return_item_no` int(11) DEFAULT NULL,
  `return_item_date` date DEFAULT NULL,
  `delivery_order_id` int(11) DEFAULT NULL,
  `recipient_id` int(11) DEFAULT NULL,
  `recipient_branch_id` int(11) DEFAULT NULL,
  `request_type` varchar(30) DEFAULT NULL,
...
`id` int(11) NOT NULL,
  ...
  `note` text,
  `barcode_product` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- Table structure for table `rims_transaction_return_order`
--

CREATE TABLE IF NOT EXISTS `rims_transaction_return_order` (
`id` int(11) NOT NULL,
  `return_order_no` varchar(30) DEFAULT NULL,
  `return_order_date` date DEFAULT NULL,
  `receive_item_id` int(11) DEFAULT NULL,
  `recipient_id` int(11) DEFAULT NULL,
  `recipient_branch_id` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
--
-- Table structure for table `rims_transaction_return_order_detail`
--

CREATE TABLE IF NOT EXISTS `rims_transaction_return_order_detail` (
`id` int(11) NOT NULL,
...
--
-- Table structure for table `rims_transaction_sales_order`
--

CREATE TABLE IF NOT EXISTS `rims_transaction_sales_order` (
`id` int(11) NOT NULL,
  `sale_order_no` varchar(30) NOT NULL,
  `sale_order_date` date NOT NULL,
  `status_document` varchar(30) NOT NULL,
  `payment_type` varchar(30) NOT NULL,
  `estimate_arrival_date` date DEFAULT NULL,
  `requester_id` int(11) NOT NULL,
  `requester_branch_id` int(11) NOT NULL,
  `approved_id` int(11) DEFAULT NULL,
  `approved_branch_id` int(11) DEFAULT NULL,
  `customer_id` int(11) NOT NULL,
  `total_quantity` int(11) NOT NULL,
  `total_price` decimal(18,2) NOT NULL,
  `estimate_payment_date` date DEFAULT NULL
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=2 ;

--
-- Dumping data for table `rims_transaction_sales_order`
--

INSERT INTO `rims_transaction_sales_order` (`id`, `sale_order_no`, `sale_order_date`, `status_document`, `payment_type`, `estimate_arrival_date`, `requester_id`, `requester_branch_id`, `approved_id`, `approved_branch_id`, `customer_id`, `total_quantity`, `total_price`, `estimate_payment_date`) VALUES
(1, 'SO01', '2016-07-18', 'Draft', 'Cash', '2016-08-07', 1, 1, NULL, NULL, 2, 100, '38250000.00', NULL);

-- --------------------------------------------------------

--
-- Table structure for table `rims_transaction_sales_order_detail`
--

CREATE TABLE IF NOT EXISTS `rims_transaction_sales_order_detail` (
`id` int(11) NOT NULL,
  ...
  `sales_order_quantity_left` int(11) DEFAULT NULL
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=2 ;

--
-- Dumping data for table `rims_transaction_sales_order_detail`
--

INSERT INTO `rims_transaction_sales_order_detail` (`id`, `sales_order_id`, `product_id`, `unit_id`, `retail_price`, `quantity`, `unit_price`, `amount`, `discount_step`, `discount1_type`, `discount1_nominal`, `discount1_temp_quantity`, `discount1_temp_price`, `discount2_type`, `discount2_nominal`, `discount2_temp_quantity`, `discount2_temp_price`, `discount3_type`, `discount3_nominal`, `discount3_temp_quantity`, `discount3_temp_price`, `discount4_type`, `discount4_nominal`, `discount4_temp_quantity`, `discount4_temp_price`, `discount5_type`, `discount5_nominal`, `discount5_temp_quantity`, `discount5_temp_price`, `total_quantity`, `total_price`, `delivery_quantity`, `sales_order_quantity_left`) VALUES
(1, 1, 1, 1, '425000.00', 100, '382500.00', 1000, 1, 1, '10.00', 100, '38250000.00', NULL, '0.00', NULL, '0.00', NULL, '0.00', NULL, '0.00', NULL, '0.00', NULL, '0.00', NULL, '0.00', NULL, '0.00', 100, '38250000.00', 20, 80);

-- --------------------------------------------------------

--
-- Table structure for table `rims_transaction_sales_order_detail_approval`
--

CREATE TABLE IF NOT EXISTS `rims_transaction_sales_order_detail_approval` (
`id` int(11) NOT NULL,
...
--
-- Dumping data for table `rims_transaction_sales_order_detail_approval`
--

INSERT INTO `rims_transaction_sales_order_detail_approval` (`id`, `sales_order_detail_id`, `revision`, `approval_type`, `date`, `supervisor_id`, `note`) VALUES
(1, 1, 0, 'Revised', '2016-07-18', 1, 'test');

-- --------------------------------------------------------

--
-- Table structure for table `rims_transaction_sent_request`
--

CREATE TABLE IF NOT EXISTS `rims_transaction_sent_request` (
`id` int(11) NOT NULL,
  `sent_request_no` varchar(30) NOT NULL,
  `sent_request_date` date NOT NULL,
  `status_document` varchar(30) NOT NULL,
  `estimate_arrival_date` date NOT NULL,
  `requester_id` int(11) NOT NULL,
  `requester_branch_id` int(11) NOT NULL,
  `approved_by` int(11) DEFAULT NULL,
...
--
-- Dumping data for table `rims_transaction_sent_request`
--

INSERT INTO `rims_transaction_sent_request` (`id`, `sent_request_no`, `sent_request_date`, `status_document`, `estimate_arrival_date`, `requester_id`, `requester_branch_id`, `approved_by`, `destination_id`, `destination_branch_id`, `total_quantity`, `total_price`) VALUES
(1, 'SR1', '2016-07-18', 'Draft', '2016-07-18', 1, 1, NULL, NULL, 4, 10, '0.00');

-- --------------------------------------------------------

--
-- Table structure for table `rims_transaction_sent_request_approval`
--

CREATE TABLE IF NOT EXISTS `rims_transaction_sent_request_approval` (
`id` int(11) NOT NULL,
  `sent_request_detail_id` int(11) NOT NULL,
  `revision` int(11) DEFAULT NULL,
  `approval_type` varchar(30) DEFAULT NULL,
  `date` date DEFAULT NULL,
  `supervisor_id` int(11) DEFAULT NULL,
...
--
-- Dumping data for table `rims_transaction_sent_request_approval`
--

INSERT INTO `rims_transaction_sent_request_approval` (`id`, `sent_request_detail_id`, `revision`, `approval_type`, `date`, `supervisor_id`, `note`) VALUES
(1, 1, 0, 'Revised', '2016-07-18', 1, 'test');

-- --------------------------------------------------------

--
-- Table structure for table `rims_transaction_sent_request_detail`
--

CREATE TABLE IF NOT EXISTS `rims_transaction_sent_request_detail` (
`id` int(11) NOT NULL,
  `sent_request_id` int(11) NOT NULL,
  `product_id` int(11) NOT NULL,
  `quantity` int(11) NOT NULL,
  `unit_price` decimal(18,2) NOT NULL,
  `unit_id` int(11) DEFAULT NULL,
  `amount` int(11) DEFAULT NULL,
  `sent_request_quantity_left` int(11) DEFAULT NULL,
  `delivery_quantity` int(11) DEFAULT NULL
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=2 ;

--
-- Dumping data for table `rims_transaction_sent_request_detail`
--

INSERT INTO `rims_transaction_sent_request_detail` (`id`, `sent_request_id`, `product_id`, `quantity`, `unit_price`, `unit_id`, `amount`, `sent_request_quantity_left`, `delivery_quantity`) VALUES
(1, 1, 6, 10, '0.00', 1, 1000, 5, 5);

-- --------------------------------------------------------

--
-- Table structure for table `rims_transaction_transfer_request`
--

CREATE TABLE IF NOT EXISTS `rims_transaction_transfer_request` (
`id` int(11) NOT NULL,
  `transfer_request_no` varchar(30) NOT NULL,
...
--
-- Dumping data for table `rims_transaction_transfer_request`
--

INSERT INTO `rims_transaction_transfer_request` (`id`, `transfer_request_no`, `transfer_request_date`, `status_document`, `estimate_arrival_date`, `requester_id`, `requester_branch_id`, `approved_by`, `destination_id`, `destination_branch_id`, `total_quantity`, `total_price`) VALUES
(1, 'TR1', '2016-07-18', 'Draft', '2016-07-21', 1, 1, NULL, NULL, 2, 10, '0.00');

-- --------------------------------------------------------

--
-- Table structure for table `rims_transaction_transfer_request_approval`
--

CREATE TABLE IF NOT EXISTS `rims_transaction_transfer_request_approval` (
`id` int(11) NOT NULL,
  `transfer_request_detail_id` int(11) NOT NULL,
  `revision` int(11) DEFAULT NULL,
  `approval_type` varchar(30) DEFAULT NULL,
  `date` date DEFAULT NULL,
  `supervisor_id` int(11) DEFAULT NULL,
...
--
-- Dumping data for table `rims_transaction_transfer_request_approval`
--

INSERT INTO `rims_transaction_transfer_request_approval` (`id`, `transfer_request_detail_id`, `revision`, `approval_type`, `date`, `supervisor_id`, `note`) VALUES
(1, 1, 0, 'Revised', '2016-07-18', 1, 'change quantity to 50');

-- --------------------------------------------------------

--
-- Table structure for table `rims_transaction_transfer_request_detail`
--

CREATE TABLE IF NOT EXISTS `rims_transaction_transfer_request_detail` (
`id` int(11) NOT NULL,
  ...
  `amount` int(11) DEFAULT NULL,
  `receive_quantity` int(11) DEFAULT NULL,
  `transfer_request_quantity_left` int(11) DEFAULT NULL
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=2 ;

--
-- Dumping data for table `rims_transaction_transfer_request_detail`
--

INSERT INTO `rims_transaction_transfer_request_detail` (`id`, `transfer_request_id`, `product_id`, `quantity`, `unit_price`, `unit_id`, `amount`, `receive_quantity`, `transfer_request_quantity_left`) VALUES
(1, 1, 1, 10, '0.00', 1, 1000, 8, 2);
...
--
-- Table structure for table `rims_unit_conversion`
--

CREATE TABLE IF NOT EXISTS `rims_unit_conversion` (
`id` int(11) NOT NULL,
...
--
-- Dumping data for table `rims_unit_conversion`
--

INSERT INTO `rims_unit_conversion` (`id`, `unit_from_id`, `unit_to_id`, `multiplier`) VALUES
(1, 8, 9, '1000.000000'),
(2, 9, 8, '0.001000');
...
(1, 'B01-W01', 'Warehouse1', 'Testing', 3, 1, 'Inactive'),
...
--
-- Dumping data for table `rims_warehouse_section`
--

INSERT INTO `rims_warehouse_section` (`id`, `warehouse_id`, `code`, `product_id`, `rack_number`, `status`) VALUES
(1, 1, 'A0', 1, '1', ''),
(2, 1, 'A1', 8, '2', ''),
(50, 2, 'A0', 1, '1', ''),
(51, 2, 'A1', 8, '2', ''),
...
ALTER TABLE `rims_company`
 ADD PRIMARY KEY (`id`), ADD KEY `province_id` (`province_id`), ADD KEY `city_id` (`city_id`), ADD KEY `branch_id` (`branch_id`), ADD KEY `branch_id_2` (`branch_id`);
...
--
-- Indexes for table `rims_equipment_details`
--
ALTER TABLE `rims_equipment_details`
...
--
-- Indexes for table `rims_equipment_maintenances`
--
ALTER TABLE `rims_equipment_maintenances`
 ADD PRIMARY KEY (`id`), ADD KEY `equipment_id` (`equipment_id`), ADD KEY `equipment_task_id` (`equipment_task_id`), ADD KEY `employee_id` (`employee_id`), ADD KEY `employee_id_2` (`employee_id`), ADD KEY `equipment_detail_id` (`equipment_detail_id`);
...
--
-- Indexes for table `rims_service_material`
--
ALTER TABLE `rims_service_material`
...
--
-- Indexes for table `rims_transaction_delivery_order`
--
ALTER TABLE `rims_transaction_delivery_order`
 ADD PRIMARY KEY (`id`), ADD KEY `sender_id` (`sender_id`), ADD KEY `sender_branch_id` (`sender_branch_id`), ADD KEY `sales_order_id` (`sales_order_id`), ADD KEY `sent_request_id` (`sent_request_id`), ADD KEY `customer_id` (`customer_id`), ADD KEY `destination_branch` (`destination_branch`);

--
-- Indexes for table `rims_transaction_delivery_order_detail`
--
ALTER TABLE `rims_transaction_delivery_order_detail`
 ADD PRIMARY KEY (`id`), ADD KEY `delivery_order_id` (`delivery_order_id`), ADD KEY `product_id` (`product_id`), ADD KEY `sales_order_detail_id` (`sales_order_detail_id`), ADD KEY `sent_request_detail_id` (`sent_request_detail_id`);

--
-- Indexes for table `rims_transaction_detail_order`
--
ALTER TABLE `rims_transaction_detail_order`
 ADD PRIMARY KEY (`id`), ADD KEY `purchase_order_id` (`purchase_order_id`), ADD KEY `purchase_request_id` (`purchase_request_id`), ADD KEY `purchase_request_detail_id` (`purchase_request_detail_id`), ADD KEY `supplier_id` (`supplier_id`), ADD KEY `product_id` (`product_id`);

--
-- Indexes for table `rims_transaction_detail_receive`
--
ALTER TABLE `rims_transaction_detail_receive`
 ADD PRIMARY KEY (`id`), ADD KEY `purchase_order_id` (`purchase_order_id`), ADD KEY `purchase_order_detail_id` (`purchase_order_detail_id`), ADD KEY `receive_order_id` (`receive_order_id`), ADD KEY `purchase_request_detail_id` (`purchase_request_detail_id`);

--
-- Indexes for table `rims_transaction_purchase_order`
--
ALTER TABLE `rims_transaction_purchase_order`
 ADD PRIMARY KEY (`id`), ADD KEY `supplier_id` (`supplier_id`), ADD KEY `requester_id` (`requester_id`), ADD KEY `requester_branch_id` (`requester_branch_id`), ADD KEY `main_branch_id` (`main_branch_id`), ADD KEY `main_branch_approved_id` (`approved_id`);

--
-- Indexes for table `rims_transaction_purchase_order_approval`
--
ALTER TABLE `rims_transaction_purchase_order_approval`
 ADD PRIMARY KEY (`id`), ADD KEY `purchase_order_detail_id` (`purchase_order_detail_id`);

--
-- Indexes for table `rims_transaction_purchase_order_detail`
--
ALTER TABLE `rims_transaction_purchase_order_detail`
 ADD PRIMARY KEY (`id`), ADD KEY `purchase_order_id` (`purchase_order_id`), ADD KEY `product_id` (`product_id`), ADD KEY `unit_id` (`unit_id`);

--
-- Indexes for table `rims_transaction_purchase_order_detail_request`
--
ALTER TABLE `rims_transaction_purchase_order_detail_request`
 ADD PRIMARY KEY (`id`), ADD KEY `purchase_order_detail_id` (`purchase_order_detail_id`), ADD KEY `purchase_request_id` (`purchase_request_id`), ADD KEY `purchase_request_detail_id` (`purchase_request_detail_id`), ADD KEY `purchase_request_branch_id` (`purchase_request_branch_id`);

--
-- Indexes for table `rims_transaction_receive_item`
--
ALTER TABLE `rims_transaction_receive_item`
 ADD PRIMARY KEY (`id`), ADD KEY `recipient_branch_id` (`recipient_branch_id`), ADD KEY `destination_branch` (`destination_branch`), ADD KEY `supplier_id` (`supplier_id`), ADD KEY `purchase_order_id` (`purchase_order_id`), ADD KEY `transfer_request_id` (`transfer_request_id`);

--
-- Indexes for table `rims_transaction_receive_item_detail`
--
ALTER TABLE `rims_transaction_receive_item_detail`
 ADD PRIMARY KEY (`id`), ADD KEY `receive_item_id` (`receive_item_id`), ADD KEY `receive_item_id_2` (`receive_item_id`), ADD KEY `product_id` (`product_id`), ADD KEY `purchase_order_detail_id` (`purchase_order_detail_id`), ADD KEY `transfer_request_detail_id` (`transfer_request_detail_id`);

--
-- Indexes for table `rims_transaction_request_order`
--
ALTER TABLE `rims_transaction_request_order`
 ADD PRIMARY KEY (`id`), ADD KEY `requester_id` (`requester_id`), ADD KEY `requester_branch_id` (`requester_branch_id`), ADD KEY `main_branch_id` (`main_branch_id`), ADD KEY `main_branch_approved_by` (`main_branch_approved_by`), ADD KEY `approved_by` (`approved_by`);

--
-- Indexes for table `rims_transaction_request_order_approval`
--
ALTER TABLE `rims_transaction_request_order_approval`
 ADD PRIMARY KEY (`id`), ADD KEY `request_order_detail_id` (`request_order_detail_id`);
...
ALTER TABLE `rims_transaction_return_item`
 ADD PRIMARY KEY (`id`), ADD KEY `recipient_id` (`recipient_id`), ADD KEY `recipient_branch_id` (`recipient_branch_id`), ADD KEY `sent_request_id` (`sent_request_id`), ADD KEY `destination_branch` (`destination_branch`), ADD KEY `sales_order_id` (`sales_order_id`), ADD KEY `customer_id` (`customer_id`);

--
-- Indexes for table `rims_transaction_return_item_detail`
--
ALTER TABLE `rims_transaction_return_item_detail`
 ADD PRIMARY KEY (`id`), ADD KEY `return_item_id` (`return_item_id`), ADD KEY `product_id` (`product_id`);

--
-- Indexes for table `rims_transaction_return_order`
--
ALTER TABLE `rims_transaction_return_order`
 ADD PRIMARY KEY (`id`), ADD KEY `receive_item_id` (`receive_item_id`), ADD KEY `recipient_id` (`recipient_id`), ADD KEY `recipient_branch_id` (`recipient_branch_id`);

--
-- Indexes for table `rims_transaction_return_order_detail`
--
ALTER TABLE `rims_transaction_return_order_detail`
 ADD PRIMARY KEY (`id`), ADD KEY `return_order_id` (`return_order_id`);

--
-- Indexes for table `rims_transaction_sales_order`
--
ALTER TABLE `rims_transaction_sales_order`
 ADD PRIMARY KEY (`id`), ADD KEY `requester_id` (`requester_id`), ADD KEY `requester_branch_id` (`requester_branch_id`), ADD KEY `customer_id` (`customer_id`), ADD KEY `approved_branch_id` (`approved_branch_id`);

--
-- Indexes for table `rims_transaction_sales_order_detail`
--
ALTER TABLE `rims_transaction_sales_order_detail`
 ADD PRIMARY KEY (`id`), ADD KEY `product_id` (`product_id`), ADD KEY `unit_id` (`unit_id`), ADD KEY `sales_order_id` (`sales_order_id`);

--
-- Indexes for table `rims_transaction_sales_order_detail_approval`
--
ALTER TABLE `rims_transaction_sales_order_detail_approval`
 ADD PRIMARY KEY (`id`), ADD KEY `sales_order_detail_id` (`sales_order_detail_id`);

--
-- Indexes for table `rims_transaction_sent_request`
--
ALTER TABLE `rims_transaction_sent_request`
 ADD PRIMARY KEY (`id`), ADD KEY `requester_id` (`requester_id`), ADD KEY `requester_branch_id` (`requester_branch_id`), ADD KEY `approved_by` (`approved_by`), ADD KEY `destination_id` (`destination_id`), ADD KEY `destination_branch_id` (`destination_branch_id`);

--
-- Indexes for table `rims_transaction_sent_request_approval`
--
ALTER TABLE `rims_transaction_sent_request_approval`
 ADD PRIMARY KEY (`id`), ADD KEY `purchase_order_detail_id` (`sent_request_detail_id`);

--
-- Indexes for table `rims_transaction_sent_request_detail`
--
ALTER TABLE `rims_transaction_sent_request_detail`
 ADD PRIMARY KEY (`id`), ADD KEY `product_id` (`product_id`), ADD KEY `product_id_2` (`product_id`), ADD KEY `unit_id` (`unit_id`), ADD KEY `transfer_request_id` (`sent_request_id`);

--
-- Indexes for table `rims_transaction_transfer_request`
--
ALTER TABLE `rims_transaction_transfer_request`
 ADD PRIMARY KEY (`id`), ADD KEY `requester_id` (`requester_id`), ADD KEY `requester_branch_id` (`requester_branch_id`), ADD KEY `approved_by` (`approved_by`), ADD KEY `destination_id` (`destination_id`), ADD KEY `destination_branch_id` (`destination_branch_id`);

--
-- Indexes for table `rims_transaction_transfer_request_approval`
--
ALTER TABLE `rims_transaction_transfer_request_approval`
 ADD PRIMARY KEY (`id`), ADD KEY `purchase_order_detail_id` (`transfer_request_detail_id`);

--
-- Indexes for table `rims_transaction_transfer_request_detail`
--
ALTER TABLE `rims_transaction_transfer_request_detail`
 ADD PRIMARY KEY (`id`), ADD KEY `product_id` (`product_id`), ADD KEY `product_id_2` (`product_id`), ADD KEY `unit_id` (`unit_id`), ADD KEY `transfer_request_id` (`transfer_request_id`);
...
--
-- Indexes for table `rims_unit_conversion`
--
ALTER TABLE `rims_unit_conversion`
 ADD PRIMARY KEY (`id`), ADD KEY `unit_from_id` (`unit_from_id`), ADD KEY `unit_to_id` (`unit_to_id`);
...
ALTER TABLE `rims_vehicle`
 ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `plate_number` (`plate_number`), ADD KEY `customer_id` (`customer_id`), ADD KEY `customer_pic_id` (`customer_pic_id`), ADD KEY `car_make_id` (`car_make_id`), ADD KEY `car_model_id` (`car_model_id`), ADD KEY `car_sub_model_id` (`car_sub_model_id`), ADD KEY `color_id` (`color_id`), ADD KEY `car_sub_model_detail_id` (`car_sub_model_detail_id`);
...
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT for table `rims_equipment_details`
--
ALTER TABLE `rims_equipment_details`
...
--
-- AUTO_INCREMENT for table `rims_equipment_maintenances`
--
ALTER TABLE `rims_equipment_maintenances`
...
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `rims_service_material`
--
ALTER TABLE `rims_service_material`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=11;
--
...
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT for table `rims_transaction_delivery_order`
--
ALTER TABLE `rims_transaction_delivery_order`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=15;
--
-- AUTO_INCREMENT for table `rims_transaction_delivery_order_detail`
--
ALTER TABLE `rims_transaction_delivery_order_detail`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=8;
--
-- AUTO_INCREMENT for table `rims_transaction_detail_order`
--
ALTER TABLE `rims_transaction_detail_order`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT for table `rims_transaction_detail_receive`
--
ALTER TABLE `rims_transaction_detail_receive`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `rims_transaction_purchase_order_approval`
--
ALTER TABLE `rims_transaction_purchase_order_approval`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `rims_transaction_purchase_order_detail_request`
--
ALTER TABLE `rims_transaction_purchase_order_detail_request`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT for table `rims_transaction_receive_item`
--
ALTER TABLE `rims_transaction_receive_item`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=15;
--
-- AUTO_INCREMENT for table `rims_transaction_receive_item_detail`
--
ALTER TABLE `rims_transaction_receive_item_detail`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=9;
--
...
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `rims_transaction_request_order_approval`
--
ALTER TABLE `rims_transaction_request_order_approval`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
...
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `rims_transaction_return_order`
--
ALTER TABLE `rims_transaction_return_order`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `rims_transaction_return_order_detail`
--
ALTER TABLE `rims_transaction_return_order_detail`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `rims_transaction_sales_order`
--
ALTER TABLE `rims_transaction_sales_order`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `rims_transaction_sales_order_detail`
--
ALTER TABLE `rims_transaction_sales_order_detail`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `rims_transaction_sales_order_detail_approval`
--
ALTER TABLE `rims_transaction_sales_order_detail_approval`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `rims_transaction_sent_request`
--
ALTER TABLE `rims_transaction_sent_request`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `rims_transaction_sent_request_approval`
--
ALTER TABLE `rims_transaction_sent_request_approval`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `rims_transaction_sent_request_detail`
--
ALTER TABLE `rims_transaction_sent_request_detail`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `rims_transaction_transfer_request`
--
ALTER TABLE `rims_transaction_transfer_request`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `rims_transaction_transfer_request_approval`
--
ALTER TABLE `rims_transaction_transfer_request_approval`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `rims_transaction_transfer_request_detail`
--
ALTER TABLE `rims_transaction_transfer_request_detail`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
...
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=10;
--
-- AUTO_INCREMENT for table `rims_unit_conversion`
--
ALTER TABLE `rims_unit_conversion`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
...
ADD CONSTRAINT `rims_company_ibfk_3` FOREIGN KEY (`branch_id`) REFERENCES `rims_branch` (`id`);
...
--
ALTER TABLE `rims_customer_pic`
ADD CONSTRAINT `rims_customer_pic_ibfk_1` FOREIGN KEY (`customer_id`) REFERENCES `rims_customer` (`id`),
ADD CONSTRAINT `rims_customer_pic_ibfk_2` FOREIGN KEY (`province_id`) REFERENCES `rims_province` (`id`),
ADD CONSTRAINT `rims_customer_pic_ibfk_3` FOREIGN KEY (`city_id`) REFERENCES `rims_city` (`id`);
...
ADD CONSTRAINT `rims_customer_service_rate_ibfk_2` FOREIGN KEY (`service_type_id`) REFERENCES `rims_service_type` (`id`),
ADD CONSTRAINT `rims_customer_service_rate_ibfk_3` FOREIGN KEY (`service_category_id`) REFERENCES `rims_service_category` (`id`),
ADD CONSTRAINT `rims_customer_service_rate_ibfk_4` FOREIGN KEY (`service_id`) REFERENCES `rims_service` (`id`),
ADD CONSTRAINT `rims_customer_service_rate_ibfk_5` FOREIGN KEY (`car_make_id`) REFERENCES `rims_vehicle_car_make` (`id`),
ADD CONSTRAINT `rims_customer_service_rate_ibfk_6` FOREIGN KEY (`car_model_id`) REFERENCES `rims_vehicle_car_model` (`id`),
ADD CONSTRAINT `rims_customer_service_rate_ibfk_7` FOREIGN KEY (`car_sub_model_id`) REFERENCES `rims_vehicle_car_sub_model` (`id`);
...
ADD CONSTRAINT `rims_employee_branch_division_position_level_ibfk_2` FOREIGN KEY (`branch_id`) REFERENCES `rims_branch` (`id`),
ADD CONSTRAINT `rims_employee_branch_division_position_level_ibfk_3` FOREIGN KEY (`division_id`) REFERENCES `rims_division` (`id`),
ADD CONSTRAINT `rims_employee_branch_division_position_level_ibfk_4` FOREIGN KEY (`position_id`) REFERENCES `rims_position` (`id`),
ADD CONSTRAINT `rims_employee_branch_division_position_level_ibfk_5` FOREIGN KEY (`level_id`) REFERENCES `rims_level` (`id`);
...
--
ALTER TABLE `rims_equipments`
ADD CONSTRAINT `rims_equipments_ibfk_1` FOREIGN KEY (`branch_id`) REFERENCES `rims_branch` (`id`),
ADD CONSTRAINT `rims_equipments_ibfk_2` FOREIGN KEY (`equipment_type_id`) REFERENCES `rims_equipment_type` (`id`),
ADD CONSTRAINT `rims_equipments_ibfk_3` FOREIGN KEY (`equipment_sub_type_id`) REFERENCES `rims_equipment_sub_type` (`id`);
...
--
-- Constraints for table `rims_equipment_details`
--
ALTER TABLE `rims_equipment_details`
ADD CONSTRAINT `rims_equipment_details_ibfk_1` FOREIGN KEY (`equipment_id`) REFERENCES `rims_equipments` (`id`);
...
ADD CONSTRAINT `rims_equipment_maintenance_ibfk_3` FOREIGN KEY (`equipment_id`) REFERENCES `rims_equipments` (`id`),
ADD CONSTRAINT `rims_equipment_maintenance_ibfk_4` FOREIGN KEY (`employee_id`) REFERENCES `rims_employee` (`id`);

--
-- Constraints for table `rims_equipment_maintenances`
--
ALTER TABLE `rims_equipment_maintenances`
ADD CONSTRAINT `rims_equipment_maintenances_ibfk_1` FOREIGN KEY (`equipment_id`) REFERENCES `rims_equipments` (`id`),
ADD CONSTRAINT `rims_equipment_maintenances_ibfk_2` FOREIGN KEY (`equipment_task_id`) REFERENCES `rims_equipment_task` (`id`),
ADD CONSTRAINT `rims_equipment_maintenances_ibfk_3` FOREIGN KEY (`equipment_detail_id`) REFERENCES `rims_equipment_details` (`id`);
...
--
ALTER TABLE `rims_inventory`
ADD CONSTRAINT `rims_inventory_ibfk_1` FOREIGN KEY (`product_id`) REFERENCES `rims_product` (`id`),
ADD CONSTRAINT `rims_inventory_ibfk_2` FOREIGN KEY (`warehouse_id`) REFERENCES `rims_warehouse` (`id`);

--
-- Constraints for table `rims_inventory_detail`
--
ALTER TABLE `rims_inventory_detail`
ADD CONSTRAINT `rims_inventory_detail_ibfk_1` FOREIGN KEY (`inventory_id`) REFERENCES `rims_inventory` (`id`);
...
--
ALTER TABLE `rims_product`
ADD CONSTRAINT `rims_product_ibfk_1` FOREIGN KEY (`brand_id`) REFERENCES `rims_brand` (`id`),
ADD CONSTRAINT `rims_product_ibfk_2` FOREIGN KEY (`product_master_category_id`) REFERENCES `rims_product_master_category` (`id`),
ADD CONSTRAINT `rims_product_ibfk_3` FOREIGN KEY (`product_sub_master_category_id`) REFERENCES `rims_product_sub_master_category` (`id`),
ADD CONSTRAINT `rims_product_ibfk_4` FOREIGN KEY (`product_sub_category_id`) REFERENCES `rims_product_sub_category` (`id`),
...
ADD CONSTRAINT `rims_product_specification_tire_ibfk_2` FOREIGN KEY (`sub_brand_id`) REFERENCES `rims_brand` (`id`),
...
--
ALTER TABLE `rims_product_sub_category`
ADD CONSTRAINT `rims_product_sub_category_ibfk_1` FOREIGN KEY (`product_master_category_id`) REFERENCES `rims_product_master_category` (`id`),
ADD CONSTRAINT `rims_product_sub_category_ibfk_2` FOREIGN KEY (`product_sub_master_category_id`) REFERENCES `rims_product_sub_master_category` (`id`);
...
--
ALTER TABLE `rims_product_vehicle`
ADD CONSTRAINT `rims_product_vehicle_ibfk_1` FOREIGN KEY (`product_id`) REFERENCES `rims_product` (`id`),
...
ADD CONSTRAINT `rims_service_equipment_ibfk_2` FOREIGN KEY (`equipment_id`) REFERENCES `rims_equipments` (`id`);

--
-- Constraints for table `rims_service_material`
--
ALTER TABLE `rims_service_material`
ADD CONSTRAINT `rims_service_material_ibfk_1` FOREIGN KEY (`service_id`) REFERENCES `rims_service` (`id`),
ADD CONSTRAINT `rims_service_material_ibfk_2` FOREIGN KEY (`product_id`) REFERENCES `rims_product` (`id`);
...
--
-- Constraints for table `rims_transaction_delivery_order`
--
ALTER TABLE `rims_transaction_delivery_order`
ADD CONSTRAINT `rims_transaction_delivery_order_ibfk_1` FOREIGN KEY (`sender_branch_id`) REFERENCES `rims_branch` (`id`),
ADD CONSTRAINT `rims_transaction_delivery_order_ibfk_2` FOREIGN KEY (`sent_request_id`) REFERENCES `rims_transaction_sent_request` (`id`),
ADD CONSTRAINT `rims_transaction_delivery_order_ibfk_3` FOREIGN KEY (`customer_id`) REFERENCES `rims_customer` (`id`),
ADD CONSTRAINT `rims_transaction_delivery_order_ibfk_4` FOREIGN KEY (`sales_order_id`) REFERENCES `rims_transaction_sales_order` (`id`),
ADD CONSTRAINT `rims_transaction_delivery_order_ibfk_5` FOREIGN KEY (`destination_branch`) REFERENCES `rims_branch` (`id`);

--
-- Constraints for table `rims_transaction_delivery_order_detail`
--
ALTER TABLE `rims_transaction_delivery_order_detail`
ADD CONSTRAINT `rims_transaction_delivery_order_detail_ibfk_1` FOREIGN KEY (`delivery_order_id`) REFERENCES `rims_transaction_delivery_order` (`id`),
ADD CONSTRAINT `rims_transaction_delivery_order_detail_ibfk_2` FOREIGN KEY (`product_id`) REFERENCES `rims_product` (`id`),
ADD CONSTRAINT `rims_transaction_delivery_order_detail_ibfk_3` FOREIGN KEY (`sales_order_detail_id`) REFERENCES `rims_transaction_sales_order_detail` (`id`),
ADD CONSTRAINT `rims_transaction_delivery_order_detail_ibfk_4` FOREIGN KEY (`sent_request_detail_id`) REFERENCES `rims_transaction_sent_request_detail` (`id`);

--
-- Constraints for table `rims_transaction_detail_order`
--
ALTER TABLE `rims_transaction_detail_order`
ADD CONSTRAINT `rims_transaction_detail_order_ibfk_1` FOREIGN KEY (`purchase_order_id`) REFERENCES `rims_transaction_purchase_order` (`id`),
ADD CONSTRAINT `rims_transaction_detail_order_ibfk_2` FOREIGN KEY (`purchase_request_id`) REFERENCES `rims_transaction_request_order` (`id`),
ADD CONSTRAINT `rims_transaction_detail_order_ibfk_3` FOREIGN KEY (`purchase_request_detail_id`) REFERENCES `rims_transaction_request_order_detail` (`id`),
ADD CONSTRAINT `rims_transaction_detail_order_ibfk_4` FOREIGN KEY (`supplier_id`) REFERENCES `rims_supplier` (`id`),
ADD CONSTRAINT `rims_transaction_detail_order_ibfk_5` FOREIGN KEY (`product_id`) REFERENCES `rims_product` (`id`);
...
ADD CONSTRAINT `rims_transaction_purchase_order_detail_ibfk_2` FOREIGN KEY (`product_id`) REFERENCES `rims_product` (`id`);

--
-- Constraints for table `rims_transaction_purchase_order_detail_request`
--
ALTER TABLE `rims_transaction_purchase_order_detail_request`
ADD CONSTRAINT `rims_transaction_purchase_order_detail_request_ibfk_1` FOREIGN KEY (`purchase_order_detail_id`) REFERENCES `rims_transaction_purchase_order_detail` (`id`),
ADD CONSTRAINT `rims_transaction_purchase_order_detail_request_ibfk_2` FOREIGN KEY (`purchase_request_id`) REFERENCES `rims_transaction_request_order` (`id`),
ADD CONSTRAINT `rims_transaction_purchase_order_detail_request_ibfk_3` FOREIGN KEY (`purchase_request_detail_id`) REFERENCES `rims_transaction_request_order_detail` (`id`),
ADD CONSTRAINT `rims_transaction_purchase_order_detail_request_ibfk_4` FOREIGN KEY (`purchase_request_branch_id`) REFERENCES `rims_branch` (`id`);

--
-- Constraints for table `rims_transaction_receive_item`
--
ALTER TABLE `rims_transaction_receive_item`
ADD CONSTRAINT `rims_transaction_receive_item_ibfk_1` FOREIGN KEY (`recipient_branch_id`) REFERENCES `rims_branch` (`id`),
ADD CONSTRAINT `rims_transaction_receive_item_ibfk_2` FOREIGN KEY (`destination_branch`) REFERENCES `rims_branch` (`id`),
ADD CONSTRAINT `rims_transaction_receive_item_ibfk_3` FOREIGN KEY (`supplier_id`) REFERENCES `rims_supplier` (`id`),
ADD CONSTRAINT `rims_transaction_receive_item_ibfk_4` FOREIGN KEY (`purchase_order_id`) REFERENCES `rims_transaction_purchase_order` (`id`),
ADD CONSTRAINT `rims_transaction_receive_item_ibfk_5` FOREIGN KEY (`transfer_request_id`) REFERENCES `rims_transaction_transfer_request` (`id`);

--
-- Constraints for table `rims_transaction_receive_item_detail`
--
ALTER TABLE `rims_transaction_receive_item_detail`
ADD CONSTRAINT `rims_transaction_receive_item_detail_ibfk_2` FOREIGN KEY (`product_id`) REFERENCES `rims_product` (`id`),
ADD CONSTRAINT `rims_transaction_receive_item_detail_ibfk_4` FOREIGN KEY (`receive_item_id`) REFERENCES `rims_transaction_receive_item` (`id`),
ADD CONSTRAINT `rims_transaction_receive_item_detail_ibfk_5` FOREIGN KEY (`purchase_order_detail_id`) REFERENCES `rims_transaction_purchase_order_detail` (`id`),
ADD CONSTRAINT `rims_transaction_receive_item_detail_ibfk_6` FOREIGN KEY (`transfer_request_detail_id`) REFERENCES `rims_transaction_transfer_request_detail` (`id`);

--
-- Constraints for table `rims_transaction_request_order`
--
ALTER TABLE `rims_transaction_request_order`
ADD CONSTRAINT `rims_transaction_request_order_ibfk_1` FOREIGN KEY (`requester_branch_id`) REFERENCES `rims_branch` (`id`);

--
-- Constraints for table `rims_transaction_request_order_approval`
--
ALTER TABLE `rims_transaction_request_order_approval`
ADD CONSTRAINT `rims_transaction_request_order_approval_ibfk_1` FOREIGN KEY (`request_order_detail_id`) REFERENCES `rims_transaction_request_order_detail` (`id`);
...
--
ALTER TABLE `rims_transaction_return_item`
ADD CONSTRAINT `rims_transaction_return_item_ibfk_1` FOREIGN KEY (`recipient_branch_id`) REFERENCES `rims_branch` (`id`),
ADD CONSTRAINT `rims_transaction_return_item_ibfk_2` FOREIGN KEY (`sent_request_id`) REFERENCES `rims_transaction_sent_request` (`id`),
ADD CONSTRAINT `rims_transaction_return_item_ibfk_3` FOREIGN KEY (`destination_branch`) REFERENCES `rims_branch` (`id`),
ADD CONSTRAINT `rims_transaction_return_item_ibfk_4` FOREIGN KEY (`customer_id`) REFERENCES `rims_customer` (`id`),
ADD CONSTRAINT `rims_transaction_return_item_ibfk_5` FOREIGN KEY (`sales_order_id`) REFERENCES `rims_transaction_sales_order` (`id`);
...
ADD CONSTRAINT `rims_transaction_return_item_detail_ibfk_2` FOREIGN KEY (`product_id`) REFERENCES `rims_product` (`id`);

--
-- Constraints for table `rims_transaction_return_order`
--
ALTER TABLE `rims_transaction_return_order`
ADD CONSTRAINT `rims_transaction_return_order_ibfk_1` FOREIGN KEY (`receive_item_id`) REFERENCES `rims_transaction_receive_item` (`id`),
ADD CONSTRAINT `rims_transaction_return_order_ibfk_2` FOREIGN KEY (`recipient_branch_id`) REFERENCES `rims_branch` (`id`);

--
-- Constraints for table `rims_transaction_return_order_detail`
--
ALTER TABLE `rims_transaction_return_order_detail`
ADD CONSTRAINT `rims_transaction_return_order_detail_ibfk_1` FOREIGN KEY (`return_order_id`) REFERENCES `rims_transaction_return_order` (`id`);

--
-- Constraints for table `rims_transaction_sales_order`
--
ALTER TABLE `rims_transaction_sales_order`
ADD CONSTRAINT `rims_transaction_sales_order_ibfk_1` FOREIGN KEY (`requester_branch_id`) REFERENCES `rims_branch` (`id`),
ADD CONSTRAINT `rims_transaction_sales_order_ibfk_2` FOREIGN KEY (`approved_branch_id`) REFERENCES `rims_branch` (`id`),
ADD CONSTRAINT `rims_transaction_sales_order_ibfk_3` FOREIGN KEY (`customer_id`) REFERENCES `rims_customer` (`id`);

--
-- Constraints for table `rims_transaction_sales_order_detail`
--
ALTER TABLE `rims_transaction_sales_order_detail`
ADD CONSTRAINT `rims_transaction_sales_order_detail_ibfk_1` FOREIGN KEY (`sales_order_id`) REFERENCES `rims_transaction_sales_order` (`id`),
ADD CONSTRAINT `rims_transaction_sales_order_detail_ibfk_2` FOREIGN KEY (`product_id`) REFERENCES `rims_product` (`id`);

--
-- Constraints for table `rims_transaction_sales_order_detail_approval`
--
ALTER TABLE `rims_transaction_sales_order_detail_approval`
ADD CONSTRAINT `rims_transaction_sales_order_detail_approval_ibfk_1` FOREIGN KEY (`sales_order_detail_id`) REFERENCES `rims_transaction_sales_order_detail` (`id`);

--
-- Constraints for table `rims_transaction_sent_request`
--
ALTER TABLE `rims_transaction_sent_request`
ADD CONSTRAINT `rims_transaction_sent_request_ibfk_1` FOREIGN KEY (`requester_branch_id`) REFERENCES `rims_branch` (`id`),
ADD CONSTRAINT `rims_transaction_sent_request_ibfk_2` FOREIGN KEY (`destination_branch_id`) REFERENCES `rims_branch` (`id`);

--
-- Constraints for table `rims_transaction_sent_request_detail`
--
ALTER TABLE `rims_transaction_sent_request_detail`
ADD CONSTRAINT `rims_transaction_sent_request_detail_ibfk_1` FOREIGN KEY (`sent_request_id`) REFERENCES `rims_transaction_sent_request` (`id`),
ADD CONSTRAINT `rims_transaction_sent_request_detail_ibfk_2` FOREIGN KEY (`product_id`) REFERENCES `rims_product` (`id`);

--
-- Constraints for table `rims_transaction_transfer_request`
--
ALTER TABLE `rims_transaction_transfer_request`
ADD CONSTRAINT `rims_transaction_transfer_request_ibfk_1` FOREIGN KEY (`requester_branch_id`) REFERENCES `rims_branch` (`id`),
ADD CONSTRAINT `rims_transaction_transfer_request_ibfk_2` FOREIGN KEY (`destination_branch_id`) REFERENCES `rims_branch` (`id`);

--
-- Constraints for table `rims_transaction_transfer_request_approval`
--
ALTER TABLE `rims_transaction_transfer_request_approval`
ADD CONSTRAINT `rims_transaction_transfer_request_approval_ibfk_1` FOREIGN KEY (`transfer_request_detail_id`) REFERENCES `rims_transaction_transfer_request_detail` (`id`);

--
-- Constraints for table `rims_transaction_transfer_request_detail`
--
ALTER TABLE `rims_transaction_transfer_request_detail`
ADD CONSTRAINT `rims_transaction_transfer_request_detail_ibfk_1` FOREIGN KEY (`transfer_request_id`) REFERENCES `rims_transaction_transfer_request` (`id`),
ADD CONSTRAINT `rims_transaction_transfer_request_detail_ibfk_2` FOREIGN KEY (`product_id`) REFERENCES `rims_product` (`id`);

--
-- Constraints for table `rims_unit_conversion`
--
ALTER TABLE `rims_unit_conversion`
ADD CONSTRAINT `rims_unit_conversion_ibfk_1` FOREIGN KEY (`unit_from_id`) REFERENCES `rims_unit` (`id`),
ADD CONSTRAINT `rims_unit_conversion_ibfk_2` FOREIGN KEY (`unit_to_id`) REFERENCES `rims_unit` (`id`);
...
ADD CONSTRAINT `rims_vehicle_ibfk_4` FOREIGN KEY (`car_sub_model_detail_id`) REFERENCES `rims_vehicle_car_sub_model_detail` (`id`),
ADD CONSTRAINT `rims_vehicle_ibfk_5` FOREIGN KEY (`color_id`) REFERENCES `rims_colors` (`id`),
ADD CONSTRAINT `rims_vehicle_ibfk_6` FOREIGN KEY (`customer_id`) REFERENCES `rims_customer` (`id`),
ADD CONSTRAINT `rims_vehicle_ibfk_7` FOREIGN KEY (`customer_pic_id`) REFERENCES `rims_customer_pic` (`id`);
...
--
ALTER TABLE `rims_vehicle_car_sub_model_detail`
ADD CONSTRAINT `rims_vehicle_car_sub_model_detail_ibfk_1` FOREIGN KEY (`car_sub_model_id`) REFERENCES `rims_vehicle_car_sub_model` (`id`);
...
ADD CONSTRAINT `rims_warehouse_section_ibfk_2` FOREIGN KEY (`product_id`) REFERENCES `rims_product` (`id`);
