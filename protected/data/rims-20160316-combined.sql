...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 15, 2016 at 07:21 PM
...
`id` int(11) NOT NULL,
  ...
  `discount1_type` int(11) NOT NULL,
  `discount1_nominal` decimal(10,2) NOT NULL,
