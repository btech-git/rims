...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 27, 2015 at 12:48 PM
...
INSERT INTO `rims_division_branch` (`id`, `division_id`, `branch_id`) VALUES
(1, 5, 4),
(2, 5, 1),
(3, 3, 11);
...
(26, 'Test', 'Jl perdana', 'jl perdana', 12, 38, 'Male', 'test@test.com', '12314124123231', '79879776870334', 'Active', 'Monthly', '2000000.00', 'Transfer', 'E01');
...
INSERT INTO `rims_product` (`id`, `code`, `name`, `description`, `production_year`, `product_master_category_id`, `product_sub_master_category_id`, `product_sub_category_id`, `product_specification_type_id`, `vehicle_car_make_id`, `vehicle_car_model_id`, `purchase_price`, `minimum_selling_price`, `hpp`, `retail_price`, `minimum_stock`, `margin_type`, `margin_amount`) VALUES
(3, 123, 'Test', 'Test', 1993, 1, 1, 1, 1, 1, 1, '1111.00', '1111.00', '111.00', '111.00', 11, 1, NULL);
...
--
-- Dumping data for table `rims_product_specification_info`
--

INSERT INTO `rims_product_specification_info` (`id`, `product_specification_type_id`, `name`) VALUES
(1, 1, '123');
...
--
-- Dumping data for table `rims_product_specification_type`
--

INSERT INTO `rims_product_specification_type` (`id`, `name`, `description`, `status`) VALUES
(1, 'Test', 'Testing testing', 'Active');
...
INSERT INTO `rims_product_sub_category` (`id`, `product_sub_master_category_id`, `code`, `name`, `status`) VALUES
(1, 1, 'Testttt', 'Testingggg', 'Active');
...
(1, 1, '2015-10-16', 'pic 1', 'pic 1234', 'PT. Astra International', 'Purchasing', 'Testing', 12, 39, '11340', '02198321212', 'pic@gmail.com', 'pic@astra.com', '323138912313', 'Testing', 'Active');
...
ALTER TABLE `rims_product_sub_category`
 ADD PRIMARY KEY (`id`), ADD KEY `product_sub_master_category_id` (`product_sub_master_category_id`);
