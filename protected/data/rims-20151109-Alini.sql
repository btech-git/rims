...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 09, 2015 at 11:43 AM
...
(1, 'B1238ER', '123-456-PPT-51', '234-567-623-FN', 1, 1, 1, 3, '2014', 1, NULL, 'E01', 500);
...
INSERT INTO `rims_vehicle_car_sub_detail` (`id`, `style_name`, `assembly_year`, `assembly_year_end`, `transmission`, `fuel_type`, `car_make_id`, `car_model_id`, `status`, `power_id`, `drivetrain`, `chasis_code`, `description`, `luxury_value`) VALUES
(1, 'S01', '2007', '2016', 'Manual', 'Electric', 1, 1, 'Active', 8500, '4WD', 'E012', '', '1.40');
