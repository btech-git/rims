...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 19, 2015 at 10:25 AM
...
--
-- Dumping data for table `rims_powercc`
--

INSERT INTO `rims_powercc` (`id`, `code`, `name`, `status`) VALUES
(1, 'P01', 'powe1', 'Active');
...
(1, 'B1231ERT', '123-456-PPT-32', '234-567-123-FN', 1, 1, 1, 1, '2012', 1, 1, 'E01', 500, '1.00');
...
(1, 'S01', '2013', '2015', 0, 'Gasoline', 1, 1, 'Active', 1, '2000', 0, '');
...
ALTER TABLE `rims_vehicle`
 ADD PRIMARY KEY (`id`), ADD KEY `customer_id` (`customer_id`), ADD KEY `customer_pic_id` (`customer_pic_id`);
