...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 04, 2016 at 06:44 AM
...
INSERT INTO `rims_equipments` (`id`, `equipment_type_id`, `equipment_sub_type_id`, `name`, `status`) VALUES
(1, 1, 1, 'Eq1', 'Active'),
(2, 1, 1, 'workshop lubrication & tools', 'Active');
...
INSERT INTO `rims_equipment_branch` (`id`, `branch_id`, `equipment_id`, `brand`, `quantity`, `purchase_date`, `age`, `status`) VALUES
(1, 1, 1, 'Hitechi', 100, '2015-11-02', 64, 'Active'),
(2, 3, 1, '', 0, '2015-12-03', 33, 'Active'),
(3, 4, 2, 'Hitachi', 100, '2016-03-01', 29, 'Active');
...
INSERT INTO `rims_equipment_maintenance` (`id`, `equipment_task_id`, `equipment_branch_id`, `employee_id`, `maintenance_date`, `next_maintenance_date`, `check_date`, `checked`, `notes`, `condition`, `status`) VALUES
(1, 1, 1, 27, '2016-03-01', '2016-03-08', '2016-03-02', 'not-checked', 'N1', 'Good', 'Active'),
(2, 1, 1, 26, '2016-03-08', '2016-03-15', '2016-03-08', 'not-checked', 'N2', 'Good', 'Active'),
(3, 1, 1, 28, '2016-03-15', '2016-03-22', '2016-03-15', 'not-checked', 'N3', '', 'Active'),
(4, 1, 1, 29, '2016-03-22', '2016-03-29', '2016-03-22', 'not-checked', 'N4', '', 'Active');
...
(2, 2, 'Air pressure', 'Yearly', 'Active');
...
`id` int(11) NOT NULL,
  ...
  `request_order_quantity` int(11) DEFAULT NULL,
  `notes` text,
...
ALTER TABLE `rims_equipments`
 ADD PRIMARY KEY (`id`), ADD KEY `equipment_type_id` (`equipment_type_id`), ADD KEY `equipment_sub_type_id` (`equipment_sub_type_id`), ADD KEY `equipment_sub_type_id_2` (`equipment_sub_type_id`), ADD KEY `equipment_type_id_2` (`equipment_type_id`);
