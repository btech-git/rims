...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 08, 2016 at 11:06 AM
...
INSERT INTO `rims_customer_service_rate` (`id`, `customer_id`, `service_id`, `car_make_id`, `car_model_id`, `car_sub_model_id`, `rate`) VALUES
(1, 1, 492, 6, 83, 578, '120000.00');
...
INSERT INTO `rims_equipment_maintenance` (`id`, `equipment_task_id`, `equipment_branch_id`, `employee_id`, `maintenance_date`, `next_maintenance_date`, `status`) VALUES
(1, 1, 1, 27, '2016-01-04', '2016-01-06', 'Active');
...
(14, 'W012', 'Warehouse12', 'Testing2', 'Active');
...
ALTER TABLE `rims_customer_service_rate`
 ADD PRIMARY KEY (`id`), ADD KEY `customer_id` (`customer_id`), ADD KEY `service_id` (`service_id`), ADD KEY `car_make_id` (`car_make_id`), ADD KEY `car_model_id` (`car_model_id`), ADD KEY `car_sub_model_id` (`car_sub_model_id`);
