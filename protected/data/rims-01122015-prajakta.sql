...
--
-- Host: localhost
-- Generation Time: Dec 03, 2015 at 12:27 PM
...
-- Database: `rims4`
--
CREATE DATABASE IF NOT EXISTS `rims4` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `rims4`;
...
CREATE TABLE IF NOT EXISTS `rims_customer_pic_mobile` (
  ...
  PRIMARY KEY (`id`),
  KEY `customer_pic_id` (`customer_pic_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `rims_employee` (
  ...
  KEY `province_id` (`province_id`),
  KEY `city_id` (`city_id`),
  KEY `home_city` (`home_city`),
  KEY `home_province` (`home_province`)
...
CREATE TABLE IF NOT EXISTS `rims_employee_bank` (
  ...
  PRIMARY KEY (`id`),
  KEY `bank_id` (`bank_id`,`employee_id`),
...
CREATE TABLE IF NOT EXISTS `rims_product` (
  ...
  `status` varchar(10) NOT NULL DEFAULT 'Active',
  PRIMARY KEY (`id`),
  KEY `product_master_category_id` (`product_master_category_id`),
  KEY `product_sub_master_category_id` (`product_sub_master_category_id`),
  KEY `product_sub_category_id` (`product_sub_category_id`),
  KEY `product_specification_type_id` (`product_specification_type_id`),
  KEY `vehicle_car_make_id` (`vehicle_car_make_id`),
  KEY `vehicle_car_model_id` (`vehicle_car_model_id`),
...
CREATE TABLE IF NOT EXISTS `rims_product_specification_battery` (
  ...
  KEY `sub_brand_id` (`sub_brand_id`),
  KEY `sub_brand_series_id` (`sub_brand_series_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `rims_product_specification_oil` (
  ...
  PRIMARY KEY (`id`),
  KEY `product_id` (`product_id`),
  KEY `oil_sub_brand_id` (`sub_brand_id`),
  KEY `oil_sub_brand_series_id` (`sub_brand_series_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `rims_product_sub_category` (
  ...
  PRIMARY KEY (`id`),
  KEY `product_sub_master_category_id` (`product_sub_master_category_id`),
  KEY `product_master_category` (`product_master_category_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `rims_product_sub_master_category` (
  ...
  `status` varchar(10) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `product_category_id` (`product_master_category_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `rims_supplier_bank` (
  ...
  `status` varchar(10) DEFAULT 'Active',
  PRIMARY KEY (`id`),
  KEY `bank_id` (`bank_id`,`supplier_id`),
...
CREATE TABLE IF NOT EXISTS `rims_supplier_pic_mobile` (
  ...
  `status` varchar(10) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `supplier_pic_id` (`supplier_pic_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `rims_vehicle` (
  ...
  KEY `car_make_id` (`car_make_id`),
  KEY `car_model_id` (`car_model_id`),
  KEY `car_sub_model_id` (`car_sub_model_id`),
...
CREATE TABLE IF NOT EXISTS `rims_warehouse_division` (
  ...
  PRIMARY KEY (`id`),
  KEY `warehouse_id` (`warehouse_id`,`division_id`),
  KEY `division_id` (`division_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=6 ;
