...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 26, 2015 at 11:29 AM
...
INSERT INTO `rims_product` (`id`, `code`, `manufacturer_code`, `name`, `description`, `production_year`, `brand_id`, `extension`, `product_master_category_id`, `product_sub_master_category_id`, `product_sub_category_id`, `product_specification_type_id`, `vehicle_car_make_id`, `vehicle_car_model_id`, `purchase_price`, `recommended_selling_price`, `hpp`, `retail_price`, `stock`, `minimum_stock`, `margin_type`, `margin_amount`, `is_usable`, `status`) VALUES
(1, 'AA01', 123, '123', '123', 1950, 2, '123', 1, 1, 1, NULL, NULL, NULL, '0.00', '0.00', NULL, '123.00', 0, 123, 1, 123, 'No', 'Active');
...
--
-- Dumping data for table `rims_product_specification_battery`
--

INSERT INTO `rims_product_specification_battery` (`id`, `product_id`, `category`, `type`, `parts_serial_number`, `sub_brand_id`, `sub_brand_series_id`, `voltage`, `amp`, `capacity`, `description`, `car_type`, `size`) VALUES
(1, 1, '123', '123', '123', 1, 1, 0, 0, 0, '123', '123', 123);
