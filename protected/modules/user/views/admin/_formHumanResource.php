<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>&nbsp;</td>
            <td style="text-align: center">
                <?php echo CHtml::checkBox("User[roles][absencyReport]", CHtml::resolveValue($model, "roles[absencyReport]"), array(
                    'id' => 'User_roles_' . $counter++, 
                    'value' => 'absencyReport'
                )); ?>
            </td>
        ...
        <tr>
            <td>Absensi Karyawan Tahunan</td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td style="text-align: center">
                <?php echo CHtml::checkBox("User[roles][absencyReport]", CHtml::resolveValue($model, "roles[absencyReport]"), array(
