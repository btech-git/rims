<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td style="text-align: center">
                <?php echo CHtml::checkBox("User[roles][requestOrderView]", CHtml::resolveValue($model, "roles[requestOrderView]"), array('id' => 'User_roles_' . $counter++, 'value' => 'requestOrderView')); ?>
            </td>
            <td style="text-align: center">
        ...
        <tr>
            ...
            <td style="text-align: center">
                <?php echo CHtml::checkBox("User[roles][purchaseOrderView]", CHtml::resolveValue($model, "roles[purchaseOrderView]"), array('id' => 'User_roles_' . $counter++, 'value' => 'purchaseOrderView')); ?>
            </td>
            <td style="text-align: center">
        ...
        <tr>
            ...
            <td style="text-align: center">
                <?php echo CHtml::checkBox("User[roles][saleOrderView]", CHtml::resolveValue($model, "roles[saleOrderView]"), array('id' => 'User_roles_' . $counter++, 'value' => 'saleOrderView')); ?>
            </td>
            <td style="text-align: center">
        ...
        <tr>
            ...
            <td style="text-align: center">
                <?php echo CHtml::checkBox("User[roles][saleInvoiceView]", CHtml::resolveValue($model, "roles[saleInvoiceView]"), array('id' => 'User_roles_' . $counter++, 'value' => 'saleInvoiceView')); ?>
            </td>
            <td>&nbsp;</td>
            <td style="text-align: center">
        ...
        <tr>
            ...
            <td style="text-align: center">
                <?php echo CHtml::checkBox("User[roles][workOrderExpenseView]", CHtml::resolveValue($model, "roles[workOrderExpenseView]"), array('id' => 'User_roles_' . $counter++, 'value' => 'workOrderExpenseView')); ?>
            </td>
            <td style="text-align: center">
        ...
        <tr>
            ...
            <td style="text-align: center">
                <?php echo CHtml::checkBox("User[roles][paymentInView]", CHtml::resolveValue($model, "roles[paymentInView]"), array('id' => 'User_roles_' . $counter++, 'value' => 'paymentInView')); ?>
            </td>
            <td style="text-align: center">
        ...
        <tr>
            ...
            <td style="text-align: center">
                <?php echo CHtml::checkBox("User[roles][paymentOutView]", CHtml::resolveValue($model, "roles[paymentOutView]"), array('id' => 'User_roles_' . $counter++, 'value' => 'paymentOutView')); ?>
            </td>
            <td style="text-align: center">
        ...
        <tr>
            ...
            <td style="text-align: center">
                <?php echo CHtml::checkBox("User[roles][cashTransactionView]", CHtml::resolveValue($model, "roles[cashTransactionView]"), array('id' => 'User_roles_' . $counter++, 'value' => 'cashTransactionView')); ?>
            </td>
            <td style="text-align: center">
        ...
        <tr>
            ...
            <td style="text-align: center">
                <?php echo CHtml::checkBox("User[roles][adjustmentJournalView]", CHtml::resolveValue($model, "roles[adjustmentJournalView]"), array('id' => 'User_roles_' . $counter++, 'value' => 'adjustmentJournalView')); ?>
            </td>
            <td style="text-align: center">
