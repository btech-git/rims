		...
		<div class="field">
				<div class="row collapse">
					<div class="small-4 columns">
					  <label class="prefix">Consignment In No</label>
				  </div>
					<div class="small-8 columns">
					<?php echo $form->textField($consignment, 'consignment_in_number', array('value'=>$consignment->consignment_in_number,'readonly'=>true)); ?>
		 ...
		 <hr />
			...
			<div class="field">
				<div class="row collapse">
					...
					<div class="small-8 columns">
					<?php echo $form->hiddenField($model, 'consignment_in_id',array('value'=>$consignment->id)); ?>		
			...
			<div class="field">
				<div class="row collapse">
					...
					<div class="small-8 columns">
						<?php $revisions = ConsignmentInApproval::model()->findAllByAttributes(array('consignment_in_id'=>$consignment->id)); ?>
