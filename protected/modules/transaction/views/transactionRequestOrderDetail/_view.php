...
/* @var $data TransactionRequestOrderDetail */
?>
...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('purchase_order_quantity')); ?>:</b>
	<?php echo CHtml::encode($data->purchase_order_quantity); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('request_order_quantity')); ?>:</b>
	<?php echo CHtml::encode($data->request_order_quantity); ?>
	<br />
