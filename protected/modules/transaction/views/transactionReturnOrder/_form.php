...
//                                'value' => date('Y-m-d'),
                    ...
                    <div class="small-8 columns">
                        ...
                        <?php $this->widget('zii.widgets.grid.CGridView', array(
                            ...
                            'columns' => array(
                                ...
                                array(
                                    'name' => 'supplier_name', 
                                    'value' => '$data->supplier != null ? $data->supplier->name : " " '
                                ),
                            ),
                        )); ?>
            ...
            <div class="field">
                <div class="row collapse">
                    ...
                    <div class="small-8 columns">
                        <?php echo CHtml::encode(CHtml::value($returnOrder->header, 'recipientBranch.name')); ?>
                ...
                <div class="field">
                    <div class="row collapse">
                        ...
                        <div class="small-8 columns">
                            ...
                            <?php echo $form->textField($returnOrder->header, 'purchase_order_no', array(
                                'readonly' => 'true',
                ...
                <div class="field">
                    <div class="row collapse">
                        ...
                        <div class="small-8 columns">
                            ...
                            <?php echo $form->textField($returnOrder->header, 'consignment_in_number', array(
                                'readonly' => 'true',
                ...
                <div class="field">
                    <div class="row collapse">
                        ...
                        <div class="small-8 columns">
                            ...
                            <?php echo $form->textField($returnOrder->header, 'supplier_name', array(
                                'readonly' => 'true',
                ...
                <div class="field">
                    <div class="row collapse">
                        ...
                        <div class="small-8 columns">
                            ...
                            <?php echo $form->textField($returnOrder->header, 'delivery_order_no', array(
                                'readonly' => 'true',
                ...
                <div class="field">
                    <div class="row collapse">
                        ...
                        <div class="small-8 columns">
                            ...
                            <?php echo $form->textField($returnOrder->header, 'branch_destination_name', array(
                                'readonly' => 'true',
