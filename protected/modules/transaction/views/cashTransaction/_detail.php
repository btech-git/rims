	...
	<table>
		...
		<tbody>
			<?php foreach ($cashTransaction->details as $i => $detail): ?>
				<tr>
					<td><?php echo CHtml::activeHiddenField($detail, "[$i]coa_id", array('size'=>20,'maxlength'=>20)); ?>
							
							<?php echo CHtml::activeTextField($detail,"[$i]coa_name",
								array(
									'size'=>15,
									'maxlength'=>10,
									'readonly'=>true,
					...
					<td>
						<?php echo CHtml::activeTextField($detail,"[$i]coa_normal_balance",
								array(
									'size'=>15,
									'maxlength'=>10,
									'readonly'=>true,
					...
					<td><?php echo CHtml::activeTextField($detail,"[$i]coa_debit",
								array(
									'size'=>15,
									'maxlength'=>10,
									'readonly'=>true,
					...
					<td><?php echo CHtml::activeTextField($detail,"[$i]coa_credit",
								array(
									'size'=>15,
									'maxlength'=>10,
									'readonly'=>true,
