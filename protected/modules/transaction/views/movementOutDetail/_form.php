...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="field">
		<div class="row collapse">
			<div class="small-4 columns">
				<?php echo $form->labelEx($model,'movement_out_header_id'); ?>
			</div>
			<div class="small-8 columns">
				<?php echo $form->textField($model,'movement_out_header_id'); ?>
				<?php echo $form->error($model,'movement_out_header_id'); ?>
			</div>
		</div>
	</div>		
	...
	<div class="field">
		<div class="row collapse">
			<div class="small-4 columns">
				<?php echo $form->labelEx($model,'delivery_order_detail_id'); ?>
			</div>
			<div class="small-8 columns">
				<?php echo $form->textField($model,'delivery_order_detail_id'); ?>
				<?php echo $form->error($model,'delivery_order_detail_id'); ?>
			</div>
		</div>
	</div>		
