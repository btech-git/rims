...
<?php $form=$this->beginWidget('CActiveForm', array(
	'id'=>'transaction-sent-request-detail-form',
	...
	<div class="row">
		<?php echo $form->labelEx($model,'sent_request_id'); ?>
		<?php echo $form->textField($model,'sent_request_id'); ?>
		<?php echo $form->error($model,'sent_request_id'); ?>
	</div>
