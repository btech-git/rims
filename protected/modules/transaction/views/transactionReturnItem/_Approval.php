        ...
        <div class="large-12 columns">
            ...
            <div class="field">
                <div class="row collapse">
                    <div class="small-4 columns">
                        <label class="prefix">Return Item No</label>
                    </div>
                    
                    <div class="small-8 columns">
                        <?php echo $form->textField($returnItem, 'return_order_no', array('value' => $returnItem->return_item_no, 'readonly' => true)); ?>
                    </div>
                </div>
            </div>
            ...
            <div class="field">
                <div class="row collapse">
                    ...
                    <div class="small-8 columns">
                        <?php echo $form->textField($returnItem, 'return_order_date', array('value' => $returnItem->return_item_date, 'readonly' => true)); ?>
                    </div>
                </div>
            </div>
            ...
            <div class="field">
                <div class="row collapse">
                    ...
                    <div class="small-8 columns">
                        <?php echo $form->textField($returnItem, 'status', array('value' => $returnItem->status, 'readonly' => true)); ?>
                    </div>
                </div>
            </div>
            ...
            <div class="field">
                <table>
                    ...
                    <tr>
                        <td>
                            <?php echo $form->hiddenField($model, 'return_item_id', array('value' => $returnItem->id)); ?>		
                        ...
                        <td>
                            <?php $revisions = TransactionReturnItemApproval::model()->findAllByAttributes(array('return_item_id' => $returnItem->id)); ?>
