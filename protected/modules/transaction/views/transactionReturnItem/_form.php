...
<div class="clearfix page-action">
    ...
    <h1><?php if($returnItem->header->id==""){ echo "New Transaction Return Item"; }else{ echo "Update Transaction Return Item";}?></h1>
    <!-- begin FORM -->
    <div class="form">
                ...
                <div class="field">
                    <div class="row collapse">
                        ...
                        <div class="small-8 columns">
                            ...
                            <?php echo $form->textField($returnItem->header,'customer_name',array('readonly'=>'true')); ?>
                ...
                <div class="field">
                    <div class="row collapse">
                        ...
                        <div class="small-8 columns">
                            ...
                            <?php echo $form->textField($returnItem->header,'destination_branch_name',array('readonly'=>'true')); ?>
