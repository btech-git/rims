...
/* @var $data TransactionReturnItem */
?>
...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('return_item_no')); ?>:</b>
	<?php echo CHtml::encode($data->return_item_no); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('return_item_date')); ?>:</b>
	<?php echo CHtml::encode($data->return_item_date); ?>
	<br />
