...
/* @var $data TransactionSentRequest */
?>
...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('sent_request_no')); ?>:</b>
	<?php echo CHtml::encode($data->sent_request_no); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('sent_request_date')); ?>:</b>
	<?php echo CHtml::encode($data->sent_request_date); ?>
	<br />
