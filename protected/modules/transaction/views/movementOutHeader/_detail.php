<?php if (count($movementOut->details)): ?>
	<table>
		...
		<tbody>
		<?php //print_r($movementOut->details); ?>
			<?php foreach ($movementOut->details as $i => $detail): ?>
				...
				<tr>
					<td>
                        <?php echo CHtml::activeHiddenField($detail, "[$i]delivery_order_detail_id", array('size'=>20,'maxlength'=>20)); ?>
                        <?php echo CHtml::activeHiddenField($detail, "[$i]return_order_detail_id", array('size'=>20,'maxlength'=>20)); ?>
                        <?php echo CHtml::activeHiddenField($detail, "[$i]registration_product_id", array('size'=>20,'maxlength'=>20)); ?>
					...
					<?php //print_r($warehouses) ?>
						...
						<?php foreach ($warehouses as $key => $warehouse) :
						 ...
						 ?>
						 	<td><?php echo $warehouse->name.'- ( '. $stock .' )'; ?>
