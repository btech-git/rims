    ...
    <div <?php if ($i > 0): ?>style=" page-break-before: always"<?php endif; ?>>
        <div class="container">
            ...
            <div style="text-align: center">
                <h4>PENERIMAAN BARANG<?php if ($i > 0): ?><span style="color: red"> - COPY</span><?php endif; ?></h4>
            </div>
                ...
                <table style="font-size: 10px">
                    <tr>
                        <?php if (empty($receiveItem->purchase_order_id)): ?>
                            <td>Penerimaan #</td>
                            <td style="width: 5%">:</td>
                            <td><?php echo CHtml::encode(CHtml::value($receiveItem, 'receive_item_no')); ?></td>
                        <?php endif; ?>
                        <?php if (!empty($receiveItem->purchase_order_id)): ?>
                            <td>SJ #</td>
                            <td style="width: 5%">:</td>
                        ...
                        <?php elseif (!empty($receiveItem->transfer_request_id)): ?>
                            <td>Transfer Request #</td>
                            <td style="width: 5%">:</td>
                            <td><?php echo CHtml::encode(CHtml::value($receiveItem, 'transferRequest.transfer_request_no')); ?></td>
                        <?php elseif (!empty($receiveItem->delivery_order_id)): ?>
                            <td>Pengiriman #</td>
                            <td style="width: 5%">:</td>
                            <td><?php echo CHtml::encode(CHtml::value($receiveItem, 'deliveryOrder.delivery_order_no')); ?></td>
                        <?php endif; ?>
                    </tr>
                    <tr>
                        <?php if (!empty($receiveItem->purchase_order_id)): ?>
                    ...
                    <tr>
                        <td>Type</td>
                        <td style="width: 5%">:</td>
                        <td><?php echo CHtml::encode(CHtml::value($receiveItem, 'request_type')); ?></td>
                        <td>ETA</td>
                        <td style="width: 5%">:</td>
                        <td><?php echo tanggal(CHtml::encode(CHtml::value($receiveItem, 'estimate_arrival_date'))); ?></td>
                    </tr>
                </table>
            </div>
