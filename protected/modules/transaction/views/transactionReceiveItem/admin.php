                    ...
                    array(
                        ...
                        'buttons'=>array(
                            'edit' => array(
                                ...
                                'visible'=>'count(MovementInHeader::model()->findAllByAttributes(array("receive_item_id"=>$data->id))) == 0 && Yii::app()->user->checkAccess("transaction.transactionReceiveItem.update") && ($data->request_type != "Retail Sales")'
                            ),
                        ),
                    ),
                ),
