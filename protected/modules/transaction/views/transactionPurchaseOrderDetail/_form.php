...
<?php $form=$this->beginWidget('CActiveForm', array(
	'id'=>'transaction-purchase-order-detail-form',
	...
	<div class="row">
		<?php echo $form->labelEx($model,'branch_addressed_to'); ?>
		<?php echo $form->textField($model,'branch_addressed_to'); ?>
		<?php echo $form->error($model,'branch_addressed_to'); ?>
	</div>
	...
	<div class="row">
		<?php echo $form->labelEx($model,'request_order_quantity_rest'); ?>
		<?php echo $form->textField($model,'request_order_quantity_rest'); ?>
		<?php echo $form->error($model,'request_order_quantity_rest'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'receive_order_quantity'); ?>
		<?php echo $form->textField($model,'receive_order_quantity'); ?>
		<?php echo $form->error($model,'receive_order_quantity'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'purchase_order_quantity_rest'); ?>
		<?php echo $form->textField($model,'purchase_order_quantity_rest'); ?>
		<?php echo $form->error($model,'purchase_order_quantity_rest'); ?>
	</div>
