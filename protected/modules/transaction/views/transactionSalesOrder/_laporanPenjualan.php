		...
		<tr>
			...
			<?php foreach ($transactions as $key => $transaction): ?>
				<tr style="background:#fff;border:0px;">
					<td><?php echo $transaction->sale_order_date; ?></td>
					<td><?php echo $transaction->sale_order_no; ?></td>
					<td><?php echo $transaction->customer->name; ?></td>
					<td><?php echo $transaction->payment_type; ?></td>
					<td></td>
					<td></td>
				</tr>
				<?php foreach ($transaction->transactionSalesOrderDetails as $key => $transactionDetail): ?>
					<tr style="background:#efefef;border:0px;">
						...
						<td><?php echo number_format($transactionDetail->subtotal,2); ?></td>
				...
				<?php $grandPbd += $transaction->price_before_discount;
			...
			<tr>
					...
					<td><b><?php echo number_format($grandSubtotal,2); ?></b></td></td>
					<td></td>
