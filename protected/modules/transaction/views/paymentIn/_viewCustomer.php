                ...
                <tr>
                    ...
                    <td>
                        ...
                        <?php if ($model->customer_id != ""): ?>
                            ...
                            <?php endif ?>
                        <?php endif ?>
                        <textarea name="" id="Customer_phones" cols="30" rows="3" readonly="true"><?php echo $getPhone; ?></textarea>
                    </td>
                    <td>
                        <?php $getMobile = "" ?>
                        <?php if ($model->customer_id != ""): ?>
                            ...
                            <?php endif ?>
                        <?php endif ?>
                        <textarea name="" id="Customer_mobiles" cols="30" rows="3" readonly="true"><?php echo $getMobile ?></textarea>
                    </td>
                </tr>
            </tbody>
        </table>
