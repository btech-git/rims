                        ...
                        <table>
                                ...
                                <?php foreach ($receiveHeader->transactionReceiveItemDetails as $key => $receiveDetail): ?>
                                    <tr>
                                        ...
                                        <td style="text-align: right">
                                            <?php echo CHtml::encode(Yii::app()->numberFormatter->format('#,##0.00', CHtml::value($receiveDetail, 'purchaseOrderDetail.price_before_tax'))); ?>
                                        </td>
                                        <td style="text-align: right">
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <td style="text-align: right">
                                        <?php echo CHtml::encode(Yii::app()->numberFormatter->format('#,##0.00', CHtml::value($receiveHeader, 'invoice_sub_total'))); ?>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="9" style="text-align: right">PPn <?php echo CHtml::encode(CHtml::value($receiveHeader, 'purchaseOrder.tax_percentage'));?>%</td>
                                    <td style="text-align: right">
