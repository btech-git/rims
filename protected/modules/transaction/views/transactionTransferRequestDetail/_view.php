...
/* @var $data TransactionTransferRequestDetail */
?>
...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('transfer_request_id')); ?>:</b>
	<?php echo CHtml::encode($data->transfer_request_id); ?>
	<br />
