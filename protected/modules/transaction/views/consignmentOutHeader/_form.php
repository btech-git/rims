	...
	<div class="row">
				...
				<div class="large-6 columns">
			      <div class="row collapse prefix-radius">
			        ...
			        <div class="small-8 columns">
                            <?php echo $form->hiddenField($consignmentOut->header, 'total_price',
                                array('size' => 18, 'maxlength' => 18, 'readonly' => true)); ?>
                            <?php echo $form->textField($consignmentOut->header, 'total_price',
                                array('id' => 'consignment_out_total_price_view', 'name' => 'view', 'readonly' => true, 'value' => $this->format_money($consignmentOut->header->total_price))); ?>
                            ...
                            <?php echo CHtml::button('Add Details', array(
                                ...
                                jQuery.ajax({
                                    ...
                                    url: "' . CController::createUrl('ajaxHtmlAddDetail',
                                        array('id' => $consignmentOut->header->id)) . '",
            ...
            <?php $this->widget('zii.widgets.grid.CGridView', array(
                ...
                'selectionChanged' => 'js:function(id){
                    ...
                    $.ajax({
                        ...
                        dataType: "html",
                        url: "' . CController::createUrl('ajaxHtmlAddDetail',
                                array('id' => $consignmentOut->header->id, 'productId' => '')) . '" + $.fn.yiiGridView.getSelection(id),
                        data: $("form").serialize(),
                        success: function(data) {
                            $("#product").html(data);
                        },
