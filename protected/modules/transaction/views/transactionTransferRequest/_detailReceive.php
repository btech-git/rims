...
<?php $receive = TransactionReceiveItem::model()->findByAttributes(array('request_type'=>'Transfer Request','destination_branch'=>$transferRequest->header->destination_branch_id,'transfer_request_id'=>$transferRequest->header->id)); ?>
