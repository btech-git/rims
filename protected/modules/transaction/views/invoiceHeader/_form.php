...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<div class="small-12 medium-6 columns">
			<?php $invoiceAll = InvoiceHeader::model()->findAll();
			...
			<div class="field">
				<div class="row collapse">
					...
					<div class="small-8 columns">
						...
						<?php //echo $form->dropDownList($invoice->header, 'reference_type', array('1'=>'Sales Order','2' => 'Retail Sales'),array('prompt'=>'[--Select Reference Type--]')); ?>
			...
			<div class="field">
				<div class="row collapse">
					...
					<div class="small-8 columns">
						<?php echo $form->textField($invoice->header,'branch_id',array('readonly'=>true)); ?>
			...
			<div class="field">
				<div class="row collapse">
					...
					<div class="small-8 columns">
						<?php echo $form->textField($invoice->header,'user_id', array('value'=>Yii::app()->user->getId(),'readonly'=>true)); ?>
			...
			<!-- <div class="field">
				<div class="row collapse">
					<div class="small-4 columns">
						<?php //echo $form->labelEx($invoice->header,'supervisor_id',array('class'=>'prefix')); ?>
					</div>
					<div class="small-8 columns">
						<?php //echo $form->textField($invoice->header,'supervisor_id'); ?>
						<?php //echo $form->error($invoice->header,'supervisor_id'); ?>
					</div>
				</div>
			</div>	 -->	
	...
	<div class="row">
		<div class="small-12 medium-6 columns">
			...
			<div class="field">
				<div class="row collapse">
					<div class="small-4 columns">
						<label for="" class="prefix">PPN (10%)</label>
						<?php //echo $form->labelEx($invoice->header,'ppn_total',array('class'=>'prefix')); ?>
					</div>
					<div class="small-1 columns">
						<?php echo CHtml::activeCheckBox($invoice->header,'ppn',array(1=>1,'rel'=>0,'onchange'=>
							'
			...
			<div class="field">
				<div class="row collapse">
					...
					<div class="small-1 columns">
						<?php echo CHtml::activeCheckBox($invoice->header,'pph',array(1=>1,'onchange'=>
							'
							var service = +$("#InvoiceHeader_service_price").val();
							var product = +$("#InvoiceHeader_product_price").val();
							var quickService = +$("#InvoiceHeader_quick_service_price").val();
