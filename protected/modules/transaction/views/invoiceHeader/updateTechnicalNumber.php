            ...
            <div class="row">
                    ...
                    <div class="field">
                        <div class="row collapse">
                            <div class="small-4 columns">
                                <?php echo $form->labelEx($invoice, 'invoice_number', array('class' => 'prefix')); ?>
                            </div>
                ...
                <div class="small-12 medium-6 columns">
                    <div class="field">
                        <div class="row collapse">
                            <div class="small-4 columns">
                                <?php echo $form->labelEx($invoice, 'Asuransi', array('class' => 'prefix')); ?>
                            </div>
                            <div class="small-8 columns">
                                <?php echo CHtml::encode(CHtml::value($invoice, 'insuranceCompany.name')); ?>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="field">
                        <div class="row collapse">
                            <div class="medium-4 columns">
                                <?php echo $form->labelEx($invoice, 'Resi Pengiriman #', array('class' => 'prefix')); ?>
                            </div>
                            <div class="medium-8 columns">
                                <?php echo $form->textField($invoice, 'delivery_receipt_number'); ?>
                                <?php echo $form->error($invoice, 'delivery_receipt_number'); ?>
                            </div>
                        </div>
                    </div>
