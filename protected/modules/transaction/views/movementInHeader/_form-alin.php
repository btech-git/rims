...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="field">
		<div class="row collapse">
			<div class="small-4 columns">
				<?php echo $form->labelEx($movementIn->header,'movement_in_number'); ?>
			</div>
			<div class="small-8 columns">
				<?php echo $form->textField($movementIn->header,'movement_in_number'); ?>
	...
	<div class="field">
		<div class="row collapse">
			<div class="small-4 columns">
				<?php echo $form->labelEx($movementIn->header,'date_posting'); ?>
			</div>
			<div class="small-8 columns">
				<?php //echo $form->textField($movementIn->header,'date_posting'); ?>
	...
	<div class="field">
		<div class="row collapse">
			<div class="small-4 columns">
				<?php echo $form->labelEx($movementIn->header,'movement_type'); ?>
			</div>
			<div class="small-8 columns">
				<?php echo $form->dropDownList($movementIn->header, 'movement_type', array('1'=>'Receive Item','2' => 'Return Item'),array('prompt'=>'[--Select Movement Type--]'));?>
	...
	<div class="field">
		<div class="row collapse">
			<div class="small-4 columns">
				<?php echo $form->labelEx($movementIn->header,'branch_id'); ?>
			</div>
			<div class="small-8 columns">
				<?php echo $form->dropDownlist($movementIn->header,'branch_id',CHtml::listData(Branch::model()->findAll(),'id','name'),array('prompt'=>'[--Select Branch--]','onchange'=>'
					...
					$("#MovementInHeader_registration_transaction_id").val("");
					$("#MovementInHeader_transaction_number").val("");
					')); ?>
	...
	<div id="receiveItem">
		<div class="field">
			<div class="row collapse">
				<div class="small-4 columns">
					<?php echo $form->labelEx($movementIn->header,'receive_item_id'); ?>
				</div>
				<div class="small-8 columns">
		...
		if(count($receive) != 0) {
			if($receive->request_type == "Transfer Request"){
				$type = "Transfer Request";
				$requestNumber = $receive->transferRequest->transfer_request_no;
			}
	...
	<div id="returnItem">
		<div class="field">
			<div class="row collapse">
				<div class="small-4 columns">
					<?php echo $form->labelEx($movementIn->header,'return_item_id'); ?>
				</div>
				<div class="small-8 columns">
	...
	<div class="field">
		<div class="row collapse">
			<div class="small-4 columns">
				<?php echo $form->labelEx($movementIn->header,'user_id'); ?>
			</div>
			<div class="small-8 columns">
				<?php echo $form->textField($movementIn->header,'user_id',array('readonly'=>true,'value'=>$movementIn->header->isNewRecord ? Yii::app()->user->getId() : $movementIn->header->user_id)); ?>
	...
	<div class="field">
		<div class="row collapse">
			<div class="small-4 columns">
				<?php echo $form->labelEx($movementIn->header,'status'); ?>
			</div>
			<div class="small-8 columns">
							...
							<?php 
						        ...
						        <?php $this->widget('zii.widgets.grid.CGridView', array(
						            ...
						            'columns'=>array(
						                ...
						                array(
						                	'header'=>'Quantity',
						                	'value'=>'$data->qty_received.CHTML::hiddenField("qtysum_".$data->product_id,\'0\',array(\'width\'=>20,\'maxlength\'=>3)).CHTML::hiddenField("qtyleft_".$data->product_id,$data->qty_received,array(\'width\'=>20,\'maxlength\'=>3))',
						                	'type'=>'raw',
						                	'filter'=>false
						                ),
						                //'nama',
						        ...
						        <?php $this->widget('zii.widgets.grid.CGridView', array(
						            ...
						            'columns'=>array(
						                ...
						                array(
						                	'header'=>'Quantity',
						                	'value'=>'$data->quantity_delivery.CHTML::hiddenField("qtysum_".$data->product_id,\'0\',array(\'width\'=>20,\'maxlength\'=>3)).CHTML::hiddenField("qtyleft_".$data->product_id,$data->quantity_delivery,array(\'width\'=>20,\'maxlength\'=>3))',
						                	'type'=>'raw',
						                	'filter'=>false
						                ),
						                //'nama',
		...
		<div class="field buttons text-center">
			<?php echo CHtml::submitButton($movementIn->header->isNewRecord ? 'Create' : 'Save', array('class'=>'button cbutton')); ?>
		</div>
...
<script type="text/javascript">
	$(document).on("change", ".qtyleft_input", function() {
	    ...
	    $("#qtysum_"+thisted).val(sum);
	    var nilaiawal = $("#qtyleft_"+thisted).val();
	     console.log(sum);
	    if (sum > nilaiawal) {
