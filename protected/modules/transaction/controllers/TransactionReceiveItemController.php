    ...
    public function accessRules() {
        return array(
            ...
            array('allow', // allow admin user to perform 'admin' and 'delete' actions
                'actions' => array('admin', 'delete', 'ajaxHtmlAddDetail', 'ajaxHtmlRemoveDetail', 'ajaxPurchase', 'ajaxSupplier', 'ajaxTransfer', 'ajaxGetTotal', 'ajaxHtmlRemoveDetailRequest', 'ajaxConsignment', 'ajaxDelivery'),
                'users' => array('Admin'),
            ),
