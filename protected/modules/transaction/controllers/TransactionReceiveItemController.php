...
//        );
        ...
        $branchIdsString = implode(',', Yii::app()->user->branch_ids);
        $deliveryDataProvider->criteria->addCondition("sender_branch_id IN ({$branchIdsString}) OR destination_branch IN ({$branchIdsString})");
