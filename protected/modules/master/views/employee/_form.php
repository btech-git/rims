...
<div class="clearfix page-action">
    ...
    <h1>
        <?php if ($employee->header->isNewRecord) {
            echo "New Employee";
        } else {
            ...
            <div class="small-12 medium-6 columns">
                ...
                <div class="field">
                    <div class="row collapse">
                        ...
                        <div class="small-8 columns">
                            <?php echo $form->dropDownList($employee->header, 'salary_type', array(
                                'Hourly' => 'Hourly',
                                'Daily' => 'Daily', 
                                'Weekly' => 'Weekly', 
                                'Monthly' => 'Monthly', 
                ...
                <div class="field">
                    <div class="row collapse">
                        ...
                        <div class="small-8 columns">
                            <?php echo $form->dropDownList($employee->header, 'payment_type', array(
                                'Cash' => 'Cash',
                                'Transfer' => 'Transfer'
                            )); ?>
            ...
            <div class="small-12 medium-6 columns">
                <div class="row">
                    ...
                    <div class="field" id="phone">
                        <div class="row collapse">
                                <?php
                                $this->renderPartial('_detailPhone', array(
                                    'employee' => $employee
                                        )
                                );
                                ?>
                    ...
                    <div class="field" id="mobile">
                        <div class="row collapse">
                                <?php
                                $this->renderPartial('_detailMobile', array(
                                    'employee' => $employee
                                        )
                                );
                                ?>
                    ...
                    <?php
                    echo CHtml::button('Add Detail', array(
                        'id' => 'detail-button',
                        'name' => 'Detail',
