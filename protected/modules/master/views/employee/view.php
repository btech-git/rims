...
<div id="maincontent">
    <div class="clearfix page-action">
        ...
        <?php if (Yii::app()->user->checkAccess("masterEmployeeEdit")) { ?>
            ...
            <a class="button cbutton danger right" style="margin-right:10px;" href="<?php echo Yii::app()->createUrl('/master/' . $ccontroller . '/delete', array('id' => $model->id)); ?>"><span class="fa fa-ban"></span>Resign</a>
        <?php } ?>
