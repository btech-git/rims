...
<a class="button cbutton right" href="<?php echo Yii::app()->baseUrl.'/master/employeePhone/admin';?>"><span class="fa fa-th-list"></span>Manage Employee Phones</a>
<h1><?php if($model->isNewRecord){ echo "New Employee Phone"; }else{ echo "Update Employee Phone";}?></h1>
<!-- begin FORM -->
<div class="form">


<?php $form=$this->beginWidget('CActiveForm', array(
	'id'=>'employee-phone-form',
	...
	<div class="row">
		<div class="small-12 medium-6 columns">			 
			 <div class="field">
				<div class="row collapse">
					<div class="small-4 columns">
					  <label class="prefix"><?php echo $form->labelEx($model,'phone_no'); ?></label>
					</div>
					<div class="small-8 columns">
						<?php echo $form->textField($model,'phone_no', array('size'=>20, 'maxLenth'=>20)); ?>
