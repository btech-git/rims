...
<div class="clearfix page-action">
	...
	<h1><?php if($warehouse->header->isNewRecord){ echo "New Warehouse"; }else{ echo "Update Warehouse";}?></h1>
	<!-- begin FORM -->
	<?php $form=$this->beginWidget('CActiveForm', array(
		...
		<?php //echo $form->errorSummary($warehouse->header); ?>
			...
			<div class="small-12 medium-6 columns"> 
				...
				<div class="field">
					<div class="row collapse">
						...
						<div class="small-8 columns">
							...
							<?php ///echo $form->textField($warehouse->header,'description',array('size'=>60,'maxlength'=>100)); ?>
				...
				<div class="field">
					<div class="row collapse">
						...
						<div class="small-8 columns">
							<?php echo  $form->dropDownList($warehouse->header, 'status', array('Active' => 'Active',
										'Inactive' => 'Inactive', )); ?>
				...
				<div class="field">
					<div class="row collapse">
						...
						<div class="small-8 columns">
							<?php echo $form->textField($warehouse->header,'column', array(
								'onchange'=> ''
								)); ?>
					...
					<div class="field">
						<div class="row collapse">
							...
							<div class="small-8 columns">
								<?php echo $form->textField($warehouse->header,'row', array(
									'onchange'=> ''
									)); ?>
						...
						<div class="field buttons text-center">
							...
							<div class="grid-view" id="section" >
								<?php $this->renderPartial('_detailSection', array('warehouse'=>$warehouse,'product'=>$product,'productDataProvider'=>$productDataProvider)); ?>
						...
						// 'summaryText'=>'',
															...
															'onclick' => 'js: if($(this).is(":checked")==true){
																...
																if(jQuery.inArray(selected_branch, myArray)!= -1) {
																	...
																	$.ajax({
																		type: "POST",
																					//dataType: "JSON",
																		url: "' . CController::createUrl('ajaxHtmlAddBranchDetail', array()) . '/id/'.$warehouse->header->id.'/branchId/"+$(this).val(),
																		data: $("form").serialize(),
																...
																if(jQuery.inArray(unselected_branch, myArray)!= -1) {
																	...
																	$.ajax({
																		type: "POST",
																					//dataType: "JSON",
																		url: "' . CController::createUrl('ajaxHtmlRemoveBranchDetail', array()) . '/id/'.$warehouse->header->id.'/branch_name/"+unselected_branch+"/index/"+index_id,
																		data: $("form").serialize(),
																		success: function(html) {
																			$("#branch").html(html);																							
																		},
							...
							//'code',
													...
													<div class="grid-view" id="branch" >
														<?php $this->renderPartial('_detailBranch', array('warehouse'=>$warehouse)); ?>
														<div class="clearfix"></div><div style="display:none" class="keys"></div>
													</div>
												</div>
											</div>
