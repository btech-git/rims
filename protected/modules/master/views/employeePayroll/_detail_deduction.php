    ...
    <div class="small-12 columns">
        <table class="detail">
            <?php foreach ($employee->deductionDetails as $i => $deductionDetail): ?>
                <tr>
                    <td>
                        <?php echo CHtml::activeHiddenField($deductionDetail, "[$i]deduction_id"); ?>
                        <?php echo CHtml::activeTextField($deductionDetail, "[$i]deduction_name", array(
                            'size' => 50,
                    ...
                    <td>
                        <?php echo CHtml::activeTextField($deductionDetail, "[$i]amount", array(
                            'placeholder' => 'Amount',
                        )); ?>
                    </td>
                    <td>
