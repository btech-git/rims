...
?>
			...
			<div id="maincontent">
				...
				<?php if (Yii::app()->user->checkAccess("master.division.update")) { ?>
					...
					if ($positionlevels) { ?>
						<table>
							...
							<?php
										...
										foreach($positionlevels as $i =>$positionlevel):
							 ?>
							<tr>
						...
						<?php }else{ ?><table><tr><td> <?php echo "No Level for this position";?></td>
							</tr>
						</table><?php } ?>
