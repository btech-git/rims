    ...
    'selectionChanged' => 'js:function(id){
        ...
        $.ajax({
            ...
            success: function(data) {
                $("#ServiceCategory_coa_id").val(data.id);
                $("#ServiceCategory_coa_code").val(data.code);
                $("#ServiceCategory_coa_name").val(data.name);
            },
        });
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
    ...
    'selectionChanged' => 'js:function(id){
        ...
        $.ajax({
            ...
            data: $("form").serialize(),
            success: function(data) {
                $("#ServiceCategory_coa_diskon_service").val(data.id);
                $("#ServiceCategory_coa_diskon_service_code").val(data.code);
                $("#ServiceCategory_coa_diskon_service_name").val(data.name);
            },
        });
    ...
    'columns' => array(
        ...
        array(
            'header' => 'Category',
            'filter' => CHtml::activeDropDownList($coaDiskon, 'coa_category_id', CHtml::listData(CoaCategory::model()->findAll(array('order' => 'name')), 'id', 'name'), array('empty' => '-- All --')),
            'value' => '$data->coaCategory!="" ?$data->coaCategory->name:""',
        ),
        array(
            'header' => 'Sub Category',
