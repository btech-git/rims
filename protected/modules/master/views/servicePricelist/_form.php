...
<h1><?php if($model->isNewRecord){ echo "New Service Pricelist"; }else{ echo "Update Service Pricelist";}?></h1>
<!-- begin FORM -->
<div class="form">
		...
		<div class="small-12 medium-6 columns">         
			...
			<div class="field">
				<div class="row collapse">
					...
					<div class="small-8 columns">
					<?php echo $form->dropDownList($model,'car_make_id', CHtml::listData(VehicleCarMake::model()->findAll(array('order'=>'name')),'id','name'),array(
	    			...
	    			'onchange'=> 'jQuery.ajax({
						...
						success: function(data){
                        	console.log(data);
                        	jQuery("#ServicePricelist_car_model_id").html(data);
			 ...
			 <div class="field">
				<div class="row collapse">
					...
					<div class="small-8 columns">
					<?php  echo $form->dropDownList($model,'car_model_id',$model->car_make_id != '' ? CHtml::listData(VehicleCarModel::model()->findAllByAttributes(array('car_make_id'=>$model->car_make_id,)),'id','name') : array(),array(
	    			...
	    			'onchange'=> 'jQuery.ajax({
						...
						success: function(data){
                        	//console.log(data);
                        	// jQuery("#ServicePricelist_car_sub_model_id").html(data);
                        	jQuery("#ServicePricelist_car_sub_detail_id").html(data);
                    	},
					});'));  ?>
			...
			<div class="field">
				<div class="row collapse">
					<div class="small-4 columns">
					  <label class="prefix"><?php echo $form->labelEx($model,'car_sub_detail_id'); ?></label>
					</div>
					<div class="small-8 columns">
					<?php  echo $form->dropDownList($model,'car_sub_detail_id', $model->car_model_id != '' ? CHtml::listData(VehicleCarSubModel::model()->findAllByAttributes(array('car_model_id'=>$model->car_model_id)), 'id', 'name'): array(),array('prompt'=>'[--Select Car Sub Model--]'));  ?>
					<?php echo $form->error($model,'car_sub_detail_id'); ?>
					</div>
				</div>
			</div>		
			...
			<div class="field">
				<div class="row collapse">
					...
					<div class="small-8 columns">
						<?php echo $form->textField($model,'difficulty',array('size'=>10,'maxlength'=>10,'value'=>$model->isNewRecord ? $servicePrice->difficulty : $model->difficulty)); ?>
			...
			<div class="field">
				<div class="row collapse">
					...
					<div class="small-8 columns">
						...
						<?php echo $form->textField($model,'difficulty_value',array('size'=>10,'maxlength'=>10,'value'=>$model->isNewRecord ? $servicePrice->difficulty_value : $model->difficulty_value)); ?>
			...
			<div class="field">
				<div class="row collapse">
					...
					<div class="small-8 columns">
						...
						<?php echo $form->textField($model,'regular',array('size'=>10,'maxlength'=>10,'value'=>$model->isNewRecord ? $servicePrice->regular : $model->regular)); ?>
			...
			<div class="field">
				<div class="row collapse">
					...
					<div class="small-8 columns">
						...
						<?php echo $form->textField($model,'luxury',array('size'=>10,'maxlength'=>10,'value'=>$model->isNewRecord ? $servicePrice->luxury : $model->luxury)); ?>
			...
			<div class="field">
				<div class="row collapse">
					...
					<div class="small-8 columns">
						...
						<?php echo $form->textField($model,'luxury_value',array('size'=>10,'maxlength'=>10,'value'=>$model->isNewRecord ? $servicePrice->luxury_value : $model->luxury_value)); ?>
			...
			<div class="field">
				<div class="row collapse">
					...
					<div class="small-8 columns">
						...
						<?php echo $form->textField($model,'luxury_calc',array('size'=>10,'maxlength'=>10,'value'=>$model->isNewRecord ? $servicePrice->luxury_calc : $model->luxury_calc)); ?>
			...
			<div class="field">
				<div class="row collapse">
					...
					<div class="small-8 columns">
						...
						<?php echo $form->textField($model,'standard_flat_rate_per_hour',array('size'=>10,'maxlength'=>10,'value'=>$model->isNewRecord ? $standardRate->flat_rate : $model->standard_flat_rate_per_hour)); ?>
			...
			<div class="field">
				<div class="row collapse">
					...
					<div class="small-8 columns">
						...
						<?php echo $form->textField($model,'flat_rate_hour',array('size'=>10,'maxlength'=>10,'value'=>$model->isNewRecord ? $servicePrice->flat_rate_hour : $model->flat_rate_hour)); ?>
					...
					<div class="small-2 columns">
						<?php
						    echo CHtml::button('Count', array(
						    	'id' => 'count',
						     	'onclick' =>'
													var diff = +$("#ServicePricelist_difficulty_value").val();
																	var lux = +$("#ServicePricelist_luxury_calc").val();
																	var standard = +$("#ServicePricelist_standard_flat_rate_per_hour").val();
																	var fr = +$("#ServicePricelist_flat_rate_hour").val();
																	$.ajax({
                                    type: "POST",
