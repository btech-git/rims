...
?>
		...
		<?php if (Yii::app()->user->checkAccess("master.servicePricelist.create")) { ?>
			...
			<?php }?>
					<h1>Manage Service Pricelists</h1>
				...
				<div class="grid-view">
					...
					<?php $this->widget('zii.widgets.grid.CGridView', array(
						...
						'columns'=>array(
							...
							array('name'=>'car_make_code','value'=>'$data->carMake->name'),
							array('name'=>'car_model_code','value'=>'$data->carModel->name'),
							array('name'=>'car_sub_detail_code','value'=>'$data->carSubDetail->name'),							
							'difficulty',
							'difficulty_value',
							'regular',
							'luxury',
