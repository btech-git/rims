		...
		<div class="row">
			<div class="small-12 medium-6 columns">
				...
				<div class="field">
					<div class="row collapse">
						<div class="small-4 columns">
							<?php echo $form->label($model,'car_sub_detail_id', array('class'=>'prefix'));?>
						</div>
						<div class="small-8 columns">
							<?php echo $form->textField($model,'car_sub_detail_id');?>
						</div>
					</div>
				</div>
			...
			<div class="small-12 medium-6 columns">
				...
				<div class="field">
					<div class="row collapse">
						...
						<div class="small-8 columns">
							<?php echo $form->textField($model,'luxury');?>
						</div>
					</div>
				</div>
				...
				<div class="field">
					<div class="row collapse">
						<div class="small-4 columns">
							<?php echo $form->label($model,'standard_flat_rate_per_hour', array('class'=>'prefix'));?>
						</div>
						<div class="small-8 columns">
				...
				<div class="field">
					<div class="row collapse">
						...
						<div class="small-8 columns">
							<?php echo $form->textField($model,'flat_rate_hour');?>
						</div>
					</div>
				</div>
