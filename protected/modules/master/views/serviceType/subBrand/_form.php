...
<div class="clearfix page-action">
	...
	<h1><?php if($model->isNewRecord){ echo "New Sub-Brand"; }else{ echo "Update Sub-Brand";}?></h1>
	<!-- begin FORM -->
			...
			<div class="field">
				<div class="row collapse">
					<div class="small-4 columns">
						<label class="prefix"><?php echo $form->labelEx($model,'brand_id'); ?></label>
					</div>
					<div class="small-8 columns">
						<?php //echo $form->textField($model,'brand_id');
							  echo $form->dropDownList($model, 'brand_id', CHtml::listData(Brand::model()->findAll(), 'id', 'name'),array(
                  'prompt' => '[--Select Brand--]'));
						?>
