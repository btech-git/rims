...
<div id="maincontent">
    <div class="clearfix page-action">
        <?php if (Yii::app()->user->checkAccess("masterServiceTypeCreate")) { ?>
            ...
            $this->widget('zii.widgets.grid.CGridView', array(
                ...
                'columns' => array(
                    ...
                    array(
                        ...
                        'value' => '$data->status',
                        'type' => 'raw',
                        'filter' => CHtml::dropDownList('ServiceType[status]', $model->status, array(
                            '' => 'All',
                            'Active' => 'Active',
                            'Inactive' => 'Inactive',
                                )
                    ...
                    array(
                        ...
                        'buttons' => array
                            ...
                            'edit' => array(
                                ...
                                'visible' => '(Yii::app()->user->checkAccess("masterServiceTypeEdit"))',
                                'label' => 'edit',
