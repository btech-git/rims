<table class="items saved_branch">
			...
			<tbody >
				...
				<?php foreach ($company->branchDetails as $i => $branchDetail): ?>
					<tr class="added" >
						...
						<td>
						    ...
						    echo CHtml::button('X', array(
						      	'onclick' => CHtml::ajax(array(
							       	'type' => 'POST',
							       	'url' => CController::createUrl('ajaxHtmlRemoveBranchDetail', array('id' => $company->header->id, 'index' => $i,'branch_name'=>$branch->name)),
							       	'update' => '#branch',
