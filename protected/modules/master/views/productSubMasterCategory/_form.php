...
<h1><?php if($model->isNewRecord){ echo "New Product Sub-Master Category"; }else{ echo "Update Product Sub-Master Category";}?></h1>
<hr />
<div class="form">
		...
		'selectionChanged'=>'js:function(id){
			...
			$.ajax({
				...
				success: function(data) {
					...
					$("#ProductSubMasterCategory_coa_persediaan_barang_dagang").val(data.id);
					$("#ProductSubMasterCategory_coa_persediaan_barang_dagang_code").val(data.code);
					$("#ProductSubMasterCategory_coa_persediaan_barang_dagang_name").val(data.name);
		...
		'selectionChanged'=>'js:function(id){
			...
			$.ajax({
				...
				success: function(data) {
					...
					$("#ProductSubMasterCategory_coa_hpp").val(data.id);
					$("#ProductSubMasterCategory_coa_hpp_code").val(data.code);
					$("#ProductSubMasterCategory_coa_hpp_name").val(data.name);
		...
		'selectionChanged'=>'js:function(id){
			...
			$.ajax({
				...
				success: function(data) {
					...
					$("#ProductSubMasterCategory_coa_retur_penjualan").val(data.id);
					$("#ProductSubMasterCategory_coa_retur_penjualan_code").val(data.code);
					$("#ProductSubMasterCategory_coa_retur_penjualan_name").val(data.name);
		...
		'selectionChanged'=>'js:function(id){
			...
			$.ajax({
				...
				success: function(data) {
					...
					$("#ProductSubMasterCategory_coa_diskon_penjualan").val(data.id);
					$("#ProductSubMasterCategory_coa_diskon_penjualan_code").val(data.code);
					$("#ProductSubMasterCategory_coa_diskon_penjualan_name").val(data.name);
		...
		'selectionChanged'=>'js:function(id){
			...
			$.ajax({
				...
				success: function(data) {
					...
					$("#ProductSubMasterCategory_coa_penjualan_barang_dagang").val(data.id);
					$("#ProductSubMasterCategory_coa_penjualan_barang_dagang_code").val(data.code);
					$("#ProductSubMasterCategory_coa_penjualan_barang_dagang_name").val(data.name);
		...
		'selectionChanged'=>'js:function(id){
			...
			$.ajax({
				...
				success: function(data) {
					...
					$("#ProductSubMasterCategory_coa_retur_pembelian").val(data.id);
					$("#ProductSubMasterCategory_coa_retur_pembelian_code").val(data.code);
					$("#ProductSubMasterCategory_coa_retur_pembelian_name").val(data.name);
		...
		'selectionChanged'=>'js:function(id){
			...
			$.ajax({
				...
				success: function(data) {
					...
					$("#ProductSubMasterCategory_coa_diskon_pembelian").val(data.id);
					$("#ProductSubMasterCategory_coa_diskon_pembelian_code").val(data.code);
					$("#ProductSubMasterCategory_coa_diskon_pembelian_name").val(data.name);
		...
		'selectionChanged'=>'js:function(id){
			...
			$.ajax({
				...
				success: function(data) {
					...
					$("#ProductSubMasterCategory_coa_inventory_in_transit").val(data.id);
					$("#ProductSubMasterCategory_coa_inventory_in_transit_code").val(data.code);
					$("#ProductSubMasterCategory_coa_inventory_in_transit_name").val(data.name);
		...
		'selectionChanged'=>'js:function(id){
			...
			$.ajax({
				...
				success: function(data) {
					...
					$("#ProductSubMasterCategory_coa_consignment_inventory").val(data.id);
					$("#ProductSubMasterCategory_coa_consignment_inventory_code").val(data.code);
					$("#ProductSubMasterCategory_coa_consignment_inventory_name").val(data.name);
