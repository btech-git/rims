...
<div id="maincontent">
	<div class="clearfix page-action">
		<?php if (Yii::app()->user->checkAccess("master.productSubMasterCategory.create")) { ?>
			...
			<?php $this->widget('zii.widgets.grid.CGridView', array(
				...
				'columns'=>array(
					...
					array(
							...
							'value'=>'$data->status',
							'type'=>'raw',
							'filter'=>CHtml::dropDownList('ProductSubMasterCategory[status]', $model->status, 
								array(
									''=>'All',
									'Active' => 'Active',
									'Inactive' => 'Inactive',
					...
					array(
						...
						(
							...
							(
								'label'=>'edit',
									'visible'=>'(Yii::app()->user->checkAccess("master.productSubMasterCategory.update"))',
