...
<div id="maincontent">
    <div class="row">
        <div class="small-12 medium-12 columns">
            <h1 class="report-title">Salary</h1>
        </div>
        <div class="small-12 medium-12 columns">
                    ...
                    <div id="detail_div">
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <?php $this->renderPartial('_salary', array('year' => $year, 'month' => $month, 'type' => $type, 'branch' => $branch, 'division' => $division, 'position' => $position, 'level' => $level)); ?>
                            </div>
                            <div class="clear"></div>
                        </div>
                    </div>
