		...
		<div class="row">
			<div class="small-12 medium-6 columns">
				...
				<div class="field">
					<div class="row collapse">
						<div class="small-4 columns">
							<?php echo $form->label($model,'rack_number', array('class'=>'prefix')); ?>
						</div>
						<div class="small-8 columns">						
			...
			<div class="small-12 medium-6 columns">
				...
				<div class="field">
					<div class="row collapse">
						<div class="small-4 columns">
							<?php echo $form->label($model,'column', array('class'=>'prefix')); ?>
						</div>
						<div class="small-8 columns">						
				...
				<div class="field">
					<div class="row collapse">
						<div class="small-4 columns">
							<?php echo $form->label($model,'row', array('class'=>'prefix')); ?>
						</div>
						<div class="small-8 columns">						
