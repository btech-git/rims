...
<h1><?php if($model->isNewRecord){ echo "New Bank"; }else{ echo "Update Bank";}?></h1>
<!-- begin FORM -->
<hr />
		...
		<div class="small-12 medium-6 columns">
			...
			<div class="field">
				<div class="row collapse">
					...
					<div class="small-8 columns">
                        <?php echo CHtml::activeDropDownList($model, 'coa_id', CHtml::listData(Coa::model()->findAll(array('condition' => 't.coa_sub_category_id = 2', 'order' => 't.name')), 'id', 'name'), array(
                            'empty' => '-Pilih COA-'
                        )); ?>
