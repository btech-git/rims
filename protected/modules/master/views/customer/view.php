...
<div id="maincontent">
    <div class="clearfix page-action">
        ...
        <a class="button success right" href="<?php echo Yii::app()->baseUrl . '/master/customer/admin'; ?>"><span
                    class="fa fa-th-list"></span>Manage Customer</a>
        <?php if (Yii::app()->user->checkAccess("master.customer.update")) { ?>
            <a class="button warning right" style="margin-right:10px;"
               href="<?php echo Yii::app()->createUrl('/master/' . $ccontroller . '/update',
                   array('id' => $model->id)); ?>"><span class="fa fa-pencil"></span>edit</a>
        <?php } ?>
        <a class="button cbutton right" style="margin-right:10px;"
               href="<?php echo Yii::app()->createUrl('/master/' . $ccontroller . '/addVehicle',
                   array('id' => $model->id)); ?>"><span class="fa fa-plus"></span>Add Vehicle</a>
<!--        <a class="button cbutton right" style="margin-right:10px;"
        ...
        <a class="button cbutton right" style="margin-right:10px;"
           href="<?php echo Yii::app()->createUrl('/transaction/consignmentOutHeader/create'); ?>"><span
                    class="fa fa-plus"></span>Consignment Out</a>
        <a class="button cbutton right" style="margin-right:10px;"
           href="<?php echo Yii::app()->createUrl('/transaction/transactionSalesOrder/create'); ?>"><span
                    class="fa fa-plus"></span>Sales</a>
        ...
        <table class="detail">
            ...
            <?php foreach ($picDetails as $key => $picDetail): ?>
                <tr>
                    ...
                    <td><a class="button cbutton right" style="margin-right:10px;"
                           href="<?php echo Yii::app()->createUrl('/master/' . $ccontroller . '/updatePic',
                               array('custId' => $model->id, 'picId' => $picDetail->id)); ?>"><span
    ...
    <table class="detail">
        ...
        <?php foreach ($rateDetails as $key => $rateDetail): ?>
            <tr>
                ...
                <td>
                    <a class="button cbutton right" style="margin-right:10px;" 
                       href="<?php echo Yii::app()->createUrl('/master/' . $ccontroller . '/updatePrice', array('custId' => $model->id, 'priceId' => $rateDetail->id)); ?>">
                        <span class="fa fa-pencil"></span>edit
                    </a>
                </td>
            </tr>
