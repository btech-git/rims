        ...
        <div class="small-12 medium-6 columns">
            <div class="field">
                <div class="row collapse">
                    ...
                    <div class="small-8 columns">
                        ...
                        <?php
                        echo CHtml::activeDropDownList($model, 'year', array_combine($range, $range), array(
                            'prompt' => '[--Select Year--]',
            ...
            <div class="field">
                <div class="row collapse">
                    ...
                    <div class="small-8 columns">
                        <?php
                        echo CHtml::activeDropDownList($model, 'car_make_id', CHtml::listData(VehicleCarMake::model()->findAll(array('order' => 'name')), 'id', 'name'), array(
            ...
            <div class="field">
                <div class="row collapse">
                    ...
                    <div class="small-8 columns">
                        <?php
                        echo CHtml::activeDropDownList($model, 'car_model_id', $model->car_make_id != '' ? CHtml::listData(VehicleCarModel::model()->findAllByAttributes(array('car_make_id' => $model->car_make_id,)), 'id', 'name') : array(), array(
            ...
            <div class="field">
                <div class="row collapse">
                    ...
                    <div class="small-8 columns">
                        <?php
                        echo CHtml::activeDropDownList($model, 'car_sub_model_id', $model->car_model_id != '' ? CHtml::listData(VehicleCarSubModel::model()->findAllByAttributes(array('car_make_id' => $model->car_make_id, 'car_model_id' => $model->car_model_id)), 'id', 'name') : array(), array(
            ...
            <div class="field">
                <div class="row collapse">
                    ...
                    <div class="small-8 columns">
                        ...
                        <?php
                        echo CHtml::activeDropDownList($model, 'transmission', array($model->transmission => $model->transmission), array('prompt' => '[--Select Transmission--]',
                            'onchange' => 'jQuery.ajax({
                                type: "POST",
                                dataType: "JSON",
            ...
            <div class="field">
                <div class="row collapse">
                    ...
                    <div class="small-8 columns">
                        ...
                        <?php
                        echo CHtml::activeDropDownList($model, 'fuel_type', array($model->fuel_type => $model->fuel_type), array('prompt' => '[--Select Fuel Type--]',
                            'onchange' => 'jQuery.ajax({
                                type: "POST",
                                dataType: "JSON",
            ...
            <div class="field">
                <div class="row collapse">
                    ...
                    <div class="small-8 columns">
                        ...
                        <?php
                        echo CHtml::activeDropDownList($model, 'power', array($model->power => $model->power), array('prompt' => '[--Select Power--]',
                            'onchange' => 'jQuery.ajax({
                                type: "POST",
                                dataType: "JSON",
