    ...
    <div class="field">
        <div class="row collapse">
            ...
            <div class="small-8 columns">
                ...
                <?php
                echo CHtml::activeDropDownList($vehicleDetail, "[$i]fuel_type", array($vehicleDetail->fuel_type => $vehicleDetail->fuel_type), array('prompt' => '[--Select Fuel Type--]',
                    'onchange' => 'jQuery.ajax({
						type: "POST",
						dataType: "JSON",
    ...
    <div class="field">
        <div class="row collapse">
            ...
            <div class="small-8 columns">
                ...
                <?php
                echo CHtml::activeDropDownList($vehicleDetail, "[$i]power", array($vehicleDetail->power => $vehicleDetail->power), array('prompt' => '[--Select Power--]',
                    'onchange' => 'jQuery.ajax({
						type: "POST",
						dataType: "JSON",
