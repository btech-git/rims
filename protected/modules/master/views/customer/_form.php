        ...
        <div class="row">
            <div class="small-12 medium-6 columns">
                ...
                <div class="field">
                    <div class="row collapse">
                        <div class="small-4 columns">
                            <label class="prefix"><?php echo $form->labelEx($customer->header, 'NPWP #'); ?></label>
                        </div>
                        
                        <div class="small-8 columns">
                            <?php echo $form->textField($customer->header, 'tax_registration_number', array('size' => 10, 'maxlength' => 60)); ?>
                            <?php echo $form->error($customer->header, 'tax_registration_number'); ?>
                        </div>
                    </div>			
                </div>
