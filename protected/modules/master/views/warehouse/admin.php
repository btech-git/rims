...
?>
			<div id="maincontent">
				<div class="clearfix page-action">
					<?php if (Yii::app()->user->checkAccess("master.warehouse.create")) { ?>
				...
				<?php $this->widget('zii.widgets.grid.CGridView', array(
					...
					'columns'=>array(
						...
						array(
								...
								'value'=>'$data->status',
								'type'=>'raw',
								'filter'=>CHtml::dropDownList('Warehouse[status]', 'warehouse_status', 
									array(
										''=>'Select',
										'Active' => 'Active',
										'Inactive' => 'Inactive',
						...
						array(
							...
							(
								...
								(
									...
									'visible'=>'(Yii::app()->user->checkAccess("master.warehouse.update"))'
								),
							),
						),
					),
