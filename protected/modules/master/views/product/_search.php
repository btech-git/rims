        ...
        <div class="small-12 medium-6 columns">
            ...
            <div class="field">
                <div class="row collapse">
                    ...
                    <div class="small-8 columns">
                        <?php
                        echo $form->dropDownList($model, 'product_sub_category_id', $model->product_sub_master_category_id != '' ? CHtml::listData(ProductSubCategory::model()->findAllByAttributes(array('product_sub_master_category_id' => $model->product_sub_master_category_id)), 'id', 'name') : array(), array(
