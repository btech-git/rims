...
<h1><?php if($product->header->isNewRecord){ echo "New Product"; }else{ echo "Update Product";}?></h1>
<hr />
<div class="form">
...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<?php //echo $form->errorSummary($productSpecificationBattery); ?>
	<?php //echo $form->errorSummary($productSpecificationOil); ?>
	...
	<div class="row">
    	<div class="small-12 medium-6 columns">
    		<div class="field">
	            <div class="row collapse">
	                ...
	                <div class="small-8 columns">
					    <?php echo $form->dropDownList($product->header, 'product_master_category_id', CHtml::listData(ProductMasterCategory::model()->findAll(), 'id', 'nameAndCode'),array(
    		...
    		<div class="field">
	            <div class="row collapse">
	                ...
	                <div class="small-8 columns">
					    <?php echo $form->dropDownList($product->header, 'unit_id', CHtml::listData(Unit::model()->findAll(), 'id', 'name'),array(
                            'prompt' => '[--Select Unit--]'
                        )); ?>
	        ...
	        <div class="field">
	            <div class="row collapse">
	               ...
	               <div class="small-8 columns">
					    <?php echo $form->dropDownList($product->header, 'brand_id', CHtml::listData(Brand::model()->findAll(), 'id', 'name'),array(
                            'prompt' => '[--Select Brand--]',
                            'onchange'=> 'jQuery.ajax({
                                type: "POST",
                                //dataType: "JSON",
	        ...
	        <div class="field">
	            <div class="row collapse">
	                <div class="small-4 columns">
	                  <?php //echo $form->labelEx($product->header,'product_specification_type_id', array('class'=>'prefix')); ?>
	                </div>
	                <div class="small-8 columns">
					    <?php //echo $form->dropDownList($product->header, 'product_specification_type_id', CHtml::listData(ProductSpecificationType::model()->findAll(), 'id', 'name'),array(
				            	//'prompt' => '[--Select Product Specification Type--]',
				      	//)); ?>
						<?php //echo $form->error($product->header,'product_specification_type_id'); ?>
					</div>
	            </div>
	        </div>
			-->
			...
			<div class="field">
	            <div class="row collapse">
	                <div class="small-4 columns">
	                  <?php //echo $form->labelEx($product->header,'vehicle_car_make_id', array('class'=>'prefix')); ?>
	                </div>
	                <div class="small-8 columns">
				      	<?php //echo $form->dropDownList($product->header, 'vehicle_car_make_id', CHtml::listData(VehicleCarMake::model()->findAll(), 'id', 'name'),array(
			          		...
			          		//)
			          	//); ?>
						<?php //echo $form->error($product->header,'vehicle_car_make_id'); ?>
					</div>
	            </div>
	        </div>
			-->
	        ...
	        <div class="field">
	            <div class="row collapse">
	                <div class="small-4 columns">
	                  <?php //echo $form->labelEx($product->header,'vehicle_car_model_id', array('class'=>'prefix')); ?>
	                </div>
	                <div class="small-8 columns">
					    <?php //echo $form->dropDownList($product->header, 'vehicle_car_model_id', CHtml::listData(VehicleCarModel::model()->findAll(), 'id', 'name'),array(
				            	//'prompt' => '[--Select Vehicle Car Model--]',
				      	//)); ?>
						<?php //echo $form->error($product->header,'vehicle_car_model_id'); ?>
					</div>
	            </div>
	        </div>
			-->
	        ...
	        <div class="field">
	            <div class="row collapse">
	                <div class="small-4 columns">
	                  <?php //echo $form->labelEx($product->header,'purchase_price', array('class'=>'prefix')); ?>
	                </div>
	                <div class="small-8 columns">
					    <?php //echo $form->textField($product->header,'purchase_price',array('size'=>10,'maxlength'=>10)); ?>
						<?php //echo $form->error($product->header,'purchase_price'); ?>
					</div>
	            </div>
	        </div>
			-->
	        ...
	        <div class="field">
	            <div class="row collapse">
	                ...
	                <div class="small-8 columns">
					    <?php echo  $form->dropDownList($product->header, 'is_usable', array('No' => 'No',
											'Yes' => 'Yes')); ?>
        ...
        <div class="small-12 medium-5b columns">
        	...
        	<?php $this->renderPartial('_tire', array('form'=>$form, 'product'=>$product, 'productSpecificationTire'=>$productSpecificationTire)); ?>
		   	...
		   	<?php /*echo CHtml::button('Add Price', array(
				...
				'onclick' => '
					jQuery.ajax({
						type: "POST",
						url: "' . CController::createUrl('ajaxHtmlAddPriceDetail', array('id' => $product->header->id)) . '",
						data: jQuery("form").serialize(),
			...
			<!-- <h2>Price</h2>
			<div id="price">
				<?php //$this->renderPartial('_detailPrice', array('product'=>$product,'supplier'=>$supplier,'supplierDataProvider'=>$supplierDataProvider
					//)); ?>
			</div> -->
			<div class="clearfix"></div>

			<?php /*echo CHtml::button('Add Unit', array(
				'id' => 'detail-unit-button',
				'name' => 'Detail Unit',
				'class'=>'button extra right',
				'onclick' => '
					jQuery.ajax({
						type: "POST",
						url: "' . CController::createUrl('ajaxHtmlAddUnitDetail', array('id' => $product->header->id)) . '",
						data: jQuery("form").serialize(),
						success: function(html) {
							jQuery("#unit").html(html);
						},
					});',
...
<!--			<h2>Unit</h2>
			<div id="unit">
				<?php //$this->renderPartial('_detailUnit', array('product'=>$product, 'unit'=>$unit, 'unitDataProvider'=>$unitDataProvider)); ?>
			</div>
			<div class="clearfix"></div>-->
	        ...
	        <?php echo CHtml::button('Add Product Complement', array(
				...
				'class'=>'button extra right',
				'onclick' => '
					jQuery("#product-complement-dialog").dialog("open"); return false;',
