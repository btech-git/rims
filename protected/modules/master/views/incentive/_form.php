...
<a class="button cbutton right" href="<?php echo Yii::app()->baseUrl.'/master/incentive/admin';?>"><span class="fa fa-th-list"></span>Manage Incentive</a>
<h1><?php if($model->isNewRecord){ echo "New Incentive"; }else{ echo "Update Incentive";}?></h1>
<hr />
<!-- begin FORM -->
