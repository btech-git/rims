...
<h1><?php if($model->isNewRecord){ echo "New Standard Service Pricelist"; }else{ echo "Update Standard Service Pricelist";}?></h1>
<!-- begin FORM -->
<div class="form">
			 ...
			 <div class="field">
				<div class="row collapse">
					...
					<div class="small-8 columns">
						<?php echo $form->dropDownList($model,'service_id', CHtml::listData(Service::model()->findAll(), 'id', 'name'),array('prompt'=>'[--Select Service--]','onchange'=> 'jQuery.ajax({
									type: "POST",
									//dataType: "JSON",
			...
			<div class="field">
				<div class="row collapse">
					...
					<div class="small-8 columns">
						...
						<?php echo $form->textField($model,'standard_rate_per_hour',array('size'=>10,'maxlength'=>10,'value'=>$model->isNewRecord ? $standardRate->flat_rate : $model->standard_rate_per_hour)); ?>
