...
<div id="maincontent">
    <div class="clearfix page-action">
        ...
        <a class="button cbutton right" style="margin-right:10px;" href="<?php echo Yii::app()->baseUrl . '/master/coaCategory/admin'; ?>"><span class="fa fa-th-list"></span>Manage</a>
        <?php if (Yii::app()->user->checkAccess("masterCoaCategoryEdit")) { ?>
        ...
        <?php } ?>
        <h1>View Coa Category #<?php echo $model->id; ?></h1>
