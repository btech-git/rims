...
<a class="button cbutton right" href="<?php echo Yii::app()->baseUrl.'/master/powercc/admin';?>"><span class="fa fa-th-list"></span>Manage Power CCs</a>
<h1><?php if($model->isNewRecord){ echo "New Power CC"; }else{ echo "Update Power CC";}?></h1>
<!-- begin FORM -->
<div class="form">
