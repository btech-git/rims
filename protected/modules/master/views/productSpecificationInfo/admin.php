...
$this->breadcrumbs=array(
	...
	'Manage Product Specification Infos',
);
...
$('.search-form form').submit(function(){
	$('#product-specification-info-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
...
<h1>Manage Product Specification Infos</h1>
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	'id'=>'product-specification-info-grid',
