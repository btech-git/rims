							...
							<?php $this->widget('zii.widgets.grid.CGridView', array(
    							...
    							'columns'=>array(
									...
									/*array(
										...
										'value'=>'$data->status',
										'type'=>'raw',
										'filter'=>CHtml::dropDownList('Branch[status]', 'branch_status', 
											array(
												''=>'Select',
												'Active' => 'Active',
												'Inactive' => 'Inactive',
									...
									array(
										...
										'value'=>'$data->status',
										'type'=>'raw',
										'filter'=>CHtml::dropDownList('Branch[status]', $model->status, 
											array(
												''=>'All',
												'Active' => 'Active',
												'Inactive' => 'Inactive',
									...
									array(
										...
										(
											'edit'=> array (
												...
												'visible'=>'(Yii::app()->user->checkAccess("master.branch.update"))'
											),
										),
									),
								),
