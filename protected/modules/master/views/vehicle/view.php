				...
				<div class="small-12 columns">
					<?php $this->widget('zii.widgets.CDetailView', array(
						...
						'attributes'=>array(
							...
							'machine_number',
							'frame_number',
							array('name'=>'car_make','value'=>$model->carMake->name),
							array('name'=>'car_model','value'=>$model->carModel->name),
							array('name'=>'car_sub_model','value'=>$model->carSubModel->name),
					...
					<?php foreach ($registrationTransactions as $i => $regDetail): ?>
						<div class="row">
							<div class="large-6 columns">
								<div class="row">
									<div class="small-4 columns"><b>Transaction #</b></div>
									<div class="small-8 columns"><b><?php echo $regDetail->transaction_number; ?></b></div>
								</div>
								<div class="row">
									<div class="small-4 columns"><b>Transaction Date</b></div>
									<div class="small-8 columns"><b><?php echo $regDetail->transaction_date; ?></b></div>
								</div>
								<div class="row">
									<div class="small-4 columns">Customer Name</div>
									<div class="small-8 columns"><?php echo $regDetail->customer->name; ?></div>
								</div>
								<div class="row">
									<div class="small-4 columns">Details</b></div>
									<div class="small-8 columns"><?php echo CHtml::tag('button', array(
							        // 'name'=>'btnSubmit',
							        'type'=>'button',
							        'class' => 'hello button expand',
							        'onclick'=>'$("#transaction-detail-'.$i.'").toggle();'
							      ), '<span class="fa fa-caret-down"></span> Detail');?></div>
								</div>
							</div>
							<div class="large-6 columns">
								<div class="row">
									<div class="small-4 columns">Total Payment</b></div>
									<div class="small-8 columns"><?php echo 'Rp '.$regDetail->grand_total; ?></div>
								</div>
								<div class="row">
									<div class="small-4 columns">Branch</b></div>
									<div class="small-8 columns"><?php echo $regDetail->branch_id!=""? $regDetail->branch->name:''; ?></div>
								</div>
							</div>
