...
<h1><?php if($model->isNewRecord){ echo "New Vehicle"; }else{ echo "Update Vehicle";}?></h1>
...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="field">
		<div class="row collapse">
			...
			<div class="small-8 columns">
				<?php //echo CHtml::activeDropDownList($model,'car_sub_model_detail_id', $model->car_sub_model_id != '' ? CHtml::listData(VehicleCarSubModelDetail::model()->findAllByAttributes(array('car_sub_model_id'=>$model->car_sub_model_id)),'id','name') : array() ,array('prompt' => '[--Select Car Sub Model Detail--]',
					/*'onchange'=> 'jQuery.ajax({
						type: "POST",
						dataType: "JSON",
						url: "' . CController::createUrl('ajaxGetChasisCode') . '",
						data: jQuery("form").serialize(),
						success: function(data){
                        	console.log(data);
                        	jQuery("#Vehicle_chasis_code").val(data.chasis_code);
