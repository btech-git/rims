        ...
        <div class="small-12 medium-6 columns">
            ...
            <div class="field">
                <div class="row collapse">
                    ...
                    <div class="small-8 columns">
                        <?php echo $form->dropDownList($model, 'car_make_id', CHtml::listData(VehicleCarMake::model()->findAll(array('order' => 't.name ASC')), 'id', 'name'), array('prompt' => 'Select',)); ?>
                    </div>
                </div>
            </div>	
            ...
            <div class="field">
                <div class="row collapse">
                    ...
                    <div class="small-8 columns">
                        <?php echo $form->dropDownList($model, 'car_model_id', CHtml::listData(VehicleCarModel::model()->findAll(array('order' => 't.name ASC')), 'id', 'name'), array('prompt' => 'Select',)); ?>
                    </div>
                </div>
            </div>	
            ...
            <div class="field">
                <div class="row collapse">
                    ...
                    <div class="small-8 columns">
                        <?php echo $form->dropDownList($model, 'car_sub_model_id', CHtml::listData(VehicleCarSubModel::model()->findAll(array('order' => 't.name ASC')), 'id', 'name'), array('prompt' => 'Select',)); ?>
                    </div>
                </div>
            </div>	
            ...
            <div class="field">
                <div class="row collapse">
                    ...
                    <div class="small-8 columns">
                        <?php echo $form->dropDownList($model, 'color_id', CHtml::listData(Colors::model()->findAll(array('order' => 't.name ASC')), 'id', 'name'), array('prompt' => 'Select',)); ?>
                    </div>
                </div>
            </div>
