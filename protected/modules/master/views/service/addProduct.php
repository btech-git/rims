        ...
        <div id="maincontent">
            ...
            <div id="service">
                <table>
                    ...
                    <tbody>
                        <tr>
                            <td><?php echo CHtml::encode(CHtml::value($service->header, 'code')); ?></td>
                            <td><?php echo CHtml::encode(CHtml::value($service->header, 'name')); ?></td>
                            <td><?php echo CHtml::encode(CHtml::value($service->header, 'serviceCategory.name')); ?></td>
                            <td><?php echo CHtml::encode(CHtml::value($service->header, 'serviceType.name')); ?></td>
                        </tr>
                    </tbody>
                </table>
            </div>
...
<?php echo CHtml::ajaxSubmitButton('Add Product', CController::createUrl('ajaxHtmlAddProducts', array('id' => $service->header->id)), array(
    'type' => 'POST',
