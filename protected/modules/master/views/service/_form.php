...
<div class="clearfix page-action">
    ...
    <h1>
        <?php if ($service->header->isNewRecord) {
            echo "New Service";
        } else {
            echo "Update Service";
        } ?>
            ...
            <div class="field">
                <div class="row collapse">
                    ...
                    <div class="small-8 columns">
                        <?php echo $form->dropDownList($service->header, 'service_type_id', CHtml::listData(ServiceType::model()->findAll(), 'id', 'name'), array(
            ...
            <div class="field">
                <div class="row collapse">
                    <div class="small-12 columns">
                        <?php /*echo CHtml::button('Set Default Value', array(
                            'id' => 'setValue',
                            'onclick' => '
                                $.ajax({
                                    type: "POST",
                ...
                <div class="field">
                    <div class="row collapse">
                        ...
                        <div class="small-3 columns">
                            <?php echo CHtml::button('Recount Hr', array(
                                'id' => 're_count',
                                'onclick' => '
...
<!--            <div class="field">
            ...
            <div class="field">
                <div class="row collapse">
                    <div class="small-4 columns">
                        <?php echo $form->labelEx($service->header, 'price_easy', array('class' => 'prefix')); ?>
                    </div>

                    <div class="small-8 columns">
                        <?php echo $form->textField($service->header, 'price_easy', array('size' => 10, 'maxlength' => 10)); ?>
                        <?php echo $form->error($service->header, 'price_easy'); ?>
                    </div>
                </div>
            </div>		
            ...
            <div class="field">
                <div class="row collapse">
                    <div class="small-4 columns">
                        <?php echo $form->labelEx($service->header, 'price_medium', array('class' => 'prefix')); ?>
                    </div>

                    <div class="small-8 columns">
                        <?php echo $form->textField($service->header, 'price_medium', array('size' => 10, 'maxlength' => 10)); ?>
                        <?php echo $form->error($service->header, 'price_medium'); ?>
                    </div>
                </div>
            </div>		
            ...
            <div class="field">
                <div class="row collapse">
                    <div class="small-4 columns">
                        <?php echo $form->labelEx($service->header, 'price_hard', array('class' => 'prefix')); ?>
                    </div>

                    <div class="small-8 columns">
                        <?php echo $form->textField($service->header, 'price_hard', array('size' => 10, 'maxlength' => 10)); ?>
                        <?php echo $form->error($service->header, 'price_hard'); ?>
                    </div>
                </div>
            </div>		
            ...
            <div class="field">
                <div class="row collapse">
                    <div class="small-4 columns">
                        <?php echo $form->labelEx($service->header, 'price_luxury', array('class' => 'prefix')); ?>
                    </div>

                    <div class="small-8 columns">
                        <?php echo $form->textField($service->header, 'price_luxury', array('size' => 10, 'maxlength' => 10)); ?>
                        <?php echo $form->error($service->header, 'price_luxury'); ?>
                    </div>
                </div>
            </div>		
            ...
            <div class="field">
                <div class="row collapse">
                    ...
                    <div class="small-8 columns">
                        <?php echo $form->dropDownList($service->header, 'status', array(
                            'Active' => 'Active',
                            'Inactive' => 'Inactive',
                        )); ?>
        ...
        <div class="small-12 medium-6 columns">
            <?php echo CHtml::button('Add Equipment', array(
                ...
                'onclick' => 'jQuery("#equipment-dialog").dialog("open"); return false;',
            )); ?>
    ...
    <div class="row">
        ...
        <div class="small-12 columns">
            <?php echo CHtml::button('Add Material', array(
                ...
                'name' => 'Material',
                'class' => 'button extra right',
                'onclick' => 'jQuery("#material-dialog").dialog("open"); return false;',
            )); ?>
            <?php $this->beginWidget('zii.widgets.jui.CJuiDialog', array(
                'id' => 'material-dialog',
                // additional javascript options for the dialog plugin
        ...
        <div class="small-12 columns">
            <?php echo CHtml::button('Add Complement', array(
                ...
                'name' => 'complement',
                'class' => 'button extra right',
                'onclick' => 'jQuery("#complement-dialog").dialog("open"); return false;',
            )); ?>
