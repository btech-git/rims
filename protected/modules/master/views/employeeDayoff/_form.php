            ...
            <div class="field">
                <div class="row collapse">
                    ...
                    <div class="small-8 columns">
                        ...
                        <?php
                        echo $form->textField($model, 'employee_name', array(
...
<?php
echo $form->dropDownList($model, 'off_type', array('Paid' => 'Paid', 'Unpaid' => 'Unpaid'), array(
                ...
                <div class="field">
                    <div class="row collapse">
                        ...
                        <div class="small-8 columns">
                            <?php $range = range(1, 20); ?>
                            <?php
                            echo $form->dropDownList($model, 'day', array_combine($range, $range), array(
                                'prompt' => '[--Select Days--]',
                                'onchange' =>
                                '
