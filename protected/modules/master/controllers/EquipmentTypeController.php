...
class EquipmentTypeController extends Controller {
    ...
    public function filterAccess($filterChain) {
        if ($filterChain->action->id === 'create') {
            if (!(Yii::app()->user->checkAccess('masterEquipmentTypeCreate')))
        ...
        if (
            ...
            if (!(Yii::app()->user->checkAccess('masterEquipmentTypeEdit')))
                $this->redirect(array('/site/login'));
        }
        ...
        if (
            ...
            if (!(Yii::app()->user->checkAccess('masterEquipmentTypeCreate')) || !(Yii::app()->user->checkAccess('masterEquipmentTypeEdit')))
                $this->redirect(array('/site/login'));
        }
