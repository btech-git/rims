	...
	public function accessRules()
	{
		return array(
			...
			array('allow', // allow admin user to perform 'admin' and 'delete' actions
				'actions'=>array('admin','delete','ajaxHtmlAddPositionDetail','ajaxHtmlRemovePositionDetail','ajaxHtmlAddBranchDetail','ajaxHtmlRemoveBranchDetail','ajaxHtmlAddWarehouseDetail','ajaxHtmlRemoveWarehouseDetail'),
				'users'=>array('Admin'),
			),
