...
class CoaCategoryController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('CoaCategory');
	...
	{
		$model=CoaCategory::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param CoaCategory $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='coa-category-form')
		{
