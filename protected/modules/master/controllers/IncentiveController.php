...
class IncentiveController extends Controller {
    ...
    public function actionCreate() {
        ...
        if (isset($_POST['Incentive'])) {
            $model->attributes = $_POST['Incentive'];
            $model->description = $_POST['Incentive']['description'];
            if ($model->save())
    ...
    public function actionIndex() {
        $dataProvider = new CActiveDataProvider('Incentive');
    ...
    public function actionAdmin() {
        $model = new Incentive('search');
        $model->unsetAttributes();  // clear any default values
        if (isset($_GET['Incentive']))
            $model->attributes = $_GET['Incentive'];
    ...
    public function loadModel($id) {
        $model = Incentive::model()->findByPk($id);
        if ($model === null)
     ...
     * @param Incentive $model the model to be validated
     */
    protected function performAjaxValidation($model) {
        if (isset($_POST['ajax']) && $_POST['ajax'] === 'incentive-form') {
