	...
	public function accessRules()
	{
		return array(
			...
			array('allow', // allow admin user to perform 'admin' and 'delete' actions
				'actions'=>array('admin','delete','ajaxGetCity','ajaxHtmlAddPhoneDetail','ajaxHtmlRemoveDetail','ajaxHtmlAddMobileDetail','ajaxHtmlRemoveMobileDetail','ajaxHtmlAddBankDetail','ajaxHtmlRemoveBankDetail','ajaxBank','AjaxHtmlAddIncentiveDetail','ajaxHtmlRemoveIncentiveDetail','ajaxHtmlRemoveDeductionDetail','AjaxHtmlAddDeductionDetail',
				'ajaxUpdate','ajaxHtmlRemoveDivisionDetail','ajaxHtmlAddDivisionDetail','ajaxGetLevel','updateBank','updateIncentive','updateDeduction','ajaxBank','ajaxIncentive','ajaxDeduction','ajaxGetCityHome','ajaxGetPosition', 'restore'),
				'users'=>array('Admin'),
			),
