...
class SubBrandSeriesController extends Controller {
    ...
    public function actionIndex() {
        $dataProvider = new CActiveDataProvider('SubBrandSeries');
     ...
     * @return SubBrandSeries the loaded model
     ...
     * @param SubBrandSeries $model the model to be validated
     */
    protected function performAjaxValidation($model) {
        if (isset($_POST['ajax']) && $_POST['ajax'] === 'sub-brand-series-form') {
