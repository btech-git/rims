...
//            'access',
    ...
    public function actionIndex() {
        $dataProvider = new CActiveDataProvider('AssetCategory');
    ...
    public function actionAdmin() {
        $model = new AssetCategory('search');
        $model->unsetAttributes();  // clear any default values
        if (isset($_GET['AssetCategory']))
            $model->attributes = $_GET['AssetCategory'];
    ...
    public function loadModel($id) {
        $model = AssetCategory::model()->findByPk($id);
        if ($model === null)
     ...
     * @param AssetCategory $model the model to be validated
     */
    protected function performAjaxValidation($model) {
        if (isset($_POST['ajax']) && $_POST['ajax'] === 'asset-category-form') {
