...
class VehicleBrandController extends Controller {
    ...
    public function actionCreate() {
        ...
        if (isset($_POST['VehicleBrand'])) {
            $model->attributes = $_POST['VehicleBrand'];
            if ($model->save()) {
    ...
    public function actionIndex() {
        $dataProvider = new CActiveDataProvider('VehicleBrand');
    ...
    public function actionAdmin() {
        $model = new VehicleBrand('search');
        $model->unsetAttributes();  // clear any default values
        if (isset($_GET['VehicleBrand']))
            $model->attributes = $_GET['VehicleBrand'];
    ...
    public function loadModel($id) {
        $model = VehicleBrand::model()->findByPk($id);
        if ($model === null)
     ...
     * @param VehicleBrand $model the model to be validated
     */
    protected function performAjaxValidation($model) {
        if (isset($_POST['ajax']) && $_POST['ajax'] === 'vehicle-brand-form') {
