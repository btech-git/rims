	...
	public function accessRules()
	{
		return array(
			array('allow',  // allow all users to perform 'index' and 'view' actions
				'actions'=>array('index','view','viewDetail'),
				'users'=>array('*'),
			),
			...
			array('allow', // allow admin user to perform 'admin' and 'delete' actions
				'actions'=>array('admin','delete','updateDetails','ajaxGetAge','ajaxHtmlAddBranchDetail','ajaxHtmlRemoveBranchDetail','ajaxHtmlAddTaskDetail','ajaxHtmlRemoveTaskDetail','ajaxGetNext','createMaintenance','getEvents'),
				'users'=>array('Admin'),
			),
