...
class OutstandingSaleInvoiceSummary extends CComponent {
    ...
    public function setupFilter($filters) {
        ...
        $this->dataProvider->criteria->addCondition("substr(t.invoice_date, 1, 10) BETWEEN :start_date AND :end_date AND t.status NOT IN ('PAID') AND user_id_cancelled IS NULL" . 
