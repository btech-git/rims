...
class StockCardTransactionProductSummary extends CComponent {
...
//        $this->dataProvider->sort->attributes = array('t.name');
    ...
    public function setupFilter($filters) {
        ...
        $this->dataProvider->criteria->addCondition("EXISTS (
            ...
            WHERE i.product_id = t.id AND i.transaction_date BETWEEN :start_date AND :end_date AND w.status = 'Active' AND 
                i.notes IN ('Purchase Order', 'Sale Retail')" . $branchConditionSql . "
        )");
