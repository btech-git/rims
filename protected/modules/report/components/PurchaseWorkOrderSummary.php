...
class PurchaseWorkOrderSummary extends CComponent {
    ...
    public function setupFilter($filters) {
        ...
        $this->dataProvider->criteria->addCondition("substr(t.purchase_order_date, 1, 10) BETWEEN :start_date AND :end_date AND t.registration_transaction_id IS NOT NULL" . $statusConditionSql);
