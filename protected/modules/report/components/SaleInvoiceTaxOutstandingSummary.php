...
class SaleInvoiceTaxOutstandingSummary extends CComponent {
    ...
    public function setupFilter($filters) {
        ...
        $this->dataProvider->criteria->addCondition('t.status NOT LIKE "%CANCELLED%" AND t.tax_percentage > 0 AND t.transaction_tax_number IS NULL');
