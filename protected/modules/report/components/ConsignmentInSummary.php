...
class ConsignmentInSummary extends CComponent {
    ...
    public function setupSorting() {
        $this->dataProvider->sort->attributes = array('t.date_posting', 't.receive_branch');
    ...
    public function setupFilter($startDate, $endDate, $branch) {
        ...
        $this->dataProvider->criteria->compare('t.receive_branch', $branch);
    }
