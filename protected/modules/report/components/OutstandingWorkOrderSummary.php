...
class OutstandingWorkOrderSummary extends CComponent {
    ...
    public function setupFilter($filters) {
        ...
        ) AND substr(t.transaction_date, 1, 10) BETWEEN :start_date AND :end_date AND t.work_order_number IS NOT NULL AND user_id_cancelled IS NULL" . 
