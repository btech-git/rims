...
class ReceivableSummary extends CComponent {
    ...
    public function setupFilter($filters) {
        ...
        if (!empty($coaId)) {
            $coaConditionSql = ' AND i.coa_id = :coa_id';
...
//                COALESCE(p.bank_administration_fee, 0) - COALESCE(p.merimen_fee, 0) - COALESCE(p.downpayment_amount, 0) > 100 " . $branchConditionSql . " 
//        )");
