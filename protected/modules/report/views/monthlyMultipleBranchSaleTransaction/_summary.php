...
<div style="font-weight: bold; text-align: center">
    <div style="font-size: larger">Penjualan Semua Cabang Bulanan</div>
...
<table class="report">
    ...
    <tbody>
        ...
        <?php foreach ($monthlyMultipleBranchSaleReport as $i => $dataItem): ?>
            <?php $detailItem = $monthlyMultipleBranchSaleProductReportData[$dataItem['branch_id']]; ?>
