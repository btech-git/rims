                        ...
                        <div class="medium-6 columns">
                            <div class="field">
                                <div class="row collapse">
                                    ...
                                    <div class="small-8 columns">
                                        <?php echo CHtml::dropDownList('CoaSubCategoryId', $coaSubCategoryId, CHtml::listData(CoaSubCategory::model()->findAll(array('order' => 'name ASC')), 'id', 'name'), array('empty' => '-- Pilih Sub Kategori --')); ?>
                                    </div>
                                </div>
                            </div>
                        </div>
