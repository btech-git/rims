...
<div style="font-weight: bold; text-align: center">
    ...
    <div>Transaction Detail <?php echo CHtml::encode(CHtml::value($coa, 'code')); ?> - <?php echo CHtml::encode(CHtml::value($coa, 'name')); ?></div>
...
<div class="row buttons">
    ...
    <?php echo CHtml::hiddenField('DebetKredit', $debetKredit); ?>
...
<table class="report">
    ...
    <?php foreach ($jurnalUmums as $i => $header): ?>
