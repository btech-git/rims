...
<div style="font-weight: bold; text-align: center">
    ...
    <div style="font-size: larger">Laporan Penjualan Retail Product</div>
...
<table class="report">
    <tr id="header1">
        ...
        <th class="width1-5">Product</th>
        <th class="width1-6">Qty</th>
        <th class="width1-7">Price</th>
        <th class="width1-8">Disc (%)</th>
    ...
    <?php foreach ($saleRetailSummary->dataProvider->data as $header): ?>
        ...
        <tr class="items1">
            ...
            <td class="width1-5"><?php echo CHtml::encode(CHtml::value($header, 'product.name')); ?></td>
            <td class="width1-6"><?php echo CHtml::encode(Yii::app()->numberFormatter->format('#,##0', CHtml::value($header, 'quantity'))); ?></td>
            <td class="width1-7" style="text-align: right"><?php echo CHtml::encode(Yii::app()->numberFormatter->format('#,##0', CHtml::value($header, 'sale_price'))); ?></td>
            <td class="width1-8"><?php echo CHtml::encode(Yii::app()->numberFormatter->format('#,##0', CHtml::value($header, 'discount'))); ?></td>
            <td class="width1-9" style="text-align: right"><?php echo CHtml::encode(Yii::app()->numberFormatter->format('#,##0', $totalAmount)); ?></td>
        </tr>
