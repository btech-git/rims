...
<table style="width: 310%">
    <thead>
        ...
        <tr>
            ...
            <th style="width: 300px">Asuransi</th>
    ...
    <tbody>
        ...
        <?php foreach ($yearlyInsuranceReportData as $insuranceId => $yearlyInsuranceReportDataItem): ?>
            <tr>
                <?php $beginningInvoiceTotal = isset($yearlyInsuranceReportDataItem['beginning_invoice_total']) ? $yearlyInsuranceReportDataItem['beginning_invoice_total'] : ''; ?>
                <?php $beginningPaymentTotal = isset($yearlyInsuranceReportDataItem['beginning_payment_total']) ? $yearlyInsuranceReportDataItem['beginning_payment_total'] : ''; ?>
                <?php $beginningOutstanding = $beginningInvoiceTotal - $beginningPaymentTotal; ?>
                <td style="text-align: center"><?php echo ++$ordinal; ?></td>
                <td><?php echo $yearlyInsuranceReportDataItem['insurance_name']; ?></td>
                ...
                <?php for ($month = 1; $month <= 12; $month++): ?>
                    <?php $invoiceTotal = isset($yearlyInsuranceReportDataItem[$month]['invoice_total']) ? $yearlyInsuranceReportDataItem[$month]['invoice_total'] : ''; ?>
                    <?php $paymentTotal = isset($yearlyInsuranceReportDataItem[$month]['payment_total']) ? $yearlyInsuranceReportDataItem[$month]['payment_total'] : ''; ?>
