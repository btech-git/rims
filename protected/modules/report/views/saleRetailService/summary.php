    ...
    <div class="tabBody">
        <div id="detail_div">
            <div>
                ...
                <div class="right"><?php echo ReportHelper::summaryText($saleRetailServiceSummary->dataProvider); ?></div>
                <br />
                <div class="right"><?php echo ReportHelper::sortText($saleRetailServiceSummary->dataProvider->sort, array('Name')); ?></div>
                <div class="clear"></div>
