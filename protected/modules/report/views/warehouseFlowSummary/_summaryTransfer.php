...
<table class="report">
    ...
    <tbody>
        <?php foreach ($transferRequestFlowSummary->dataProvider->data as $i => $header): ?>
            ...
            <?php $receiveItemDates = array_map(function($receiveItem) { return Yii::app()->dateFormatter->format('d MMM yyyy', strtotime($receiveItem->receive_item_date)); }, $receiveItems); ?>
            <?php $receiveItemTimes = array_map(function($receiveItem) { return substr($receiveItem->created_datetime, -8); }, $receiveItems); ?>
            ...
            <tr class="items1">
                ...
                <td class="width1-3"><?php echo CHtml::encode($header->transfer_request_time); ?></td>
