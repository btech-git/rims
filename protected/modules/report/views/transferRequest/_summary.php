...
<div style="font-weight: bold; text-align: center">
    <div style="font-size: larger">
        ...
        <?php echo 'Raperind Motor ' . CHtml::encode(CHtml::value($branch, 'name')); ?>
    </div>
...
<table class="report">
        ...
        <td colspan="7">
            <table>
                <tr>
                    ...
                    <th class="width2-5">Unit Price</th>
    ...
    <?php foreach ($transferRequestSummary->dataProvider->data as $header): ?>
        <tr class="items1">
            <td class="width1-1">
                <?php echo CHtml::link(CHtml::encode($header->transfer_request_no), array(
                    "/transaction/transactionTransferRequest/view", 
                    "id"=>$header->id
                ), array("target" => "_blank")); ?>
            </td>
