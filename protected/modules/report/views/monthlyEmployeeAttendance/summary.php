                            ...
                            <div class="row collapse">
                                <div class="small-4 columns">
                                 ...
                                 <div class="small-8 columns">
                                      <?php echo CHtml::dropDownlist('EmployeeId', $employeeId, CHtml::listData(Employee::model()->findAllbyAttributes(array('status'=>'Active'), array('order' => 't.name ASC')), 'id','name'), array('empty'=>'-- Pilih --')); ?>
                                </div>
                            </div>
                        </div>
                    </div>
