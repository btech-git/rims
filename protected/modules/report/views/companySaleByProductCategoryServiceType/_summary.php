            ...
            <?php foreach ($branchList as $branchItem): ?>
                <tr>
                    ...
                    <?php foreach ($productMasterCategoryList as $productMasterCategoryItem): ?>
                        ...
                        <?php if (isset($saleReportData[$branchItem->company->id][$branchItem->id]['product'][$productMasterCategoryItem->id])): ?>
                            <?php $productAmount = $saleReportData[$branchItem->company->id][$branchItem->id]['product'][$productMasterCategoryItem->id]; ?>
                        <?php endif; ?>
                    ...
                    <?php foreach ($serviceCategoryList as $serviceCategoryItem): ?>
                        ...
                        <?php if (isset($saleReportData[$branchItem->company->id][$branchItem->id]['service'][$serviceCategoryItem->id])): ?>
                            <?php $serviceAmount = $saleReportData[$branchItem->company->id][$branchItem->id]['service'][$serviceCategoryItem->id]; ?>
                        <?php endif; ?>
                    ...
                    <?php if (isset($saleReportData[$branchItem->company->id][$branchItem->id]['total_discount'])): ?>
                        <?php $totalDiscount = $saleReportData[$branchItem->company->id][$branchItem->id]['total_discount']; ?>
                    <?php endif; ?>
                    ...
                    <?php $ppnTotal = '0.00'; ?>
                    <?php if (isset($saleReportData[$branchItem->company->id][$branchItem->id]['ppn_total'])): ?>
                        <?php $ppnTotal = $saleReportData[$branchItem->company->id][$branchItem->id]['ppn_total']; ?>
                    <?php endif; ?>
                    ...
                    <?php $pphTotal = '0.00'; ?>
                    <?php if (isset($saleReportData[$branchItem->company->id][$branchItem->id]['pph_total'])): ?>
                        <?php $pphTotal = $saleReportData[$branchItem->company->id][$branchItem->id]['pph_total']; ?>
                    <?php endif; ?>
                    ...
                    <?php $totalPrice = '0.00'; ?>
                    <?php if (isset($saleReportData[$branchItem->company->id][$branchItem->id]['total_price'])): ?>
                        <?php $totalPrice = $saleReportData[$branchItem->company->id][$branchItem->id]['total_price']; ?>
                    <?php endif; ?>
                    ...
                    <?php if (isset($saleReportData[$branchItem->company->id][$branchItem->id]['total_product'])): ?>
                        <?php $totalProduct = $saleReportData[$branchItem->company->id][$branchItem->id]['total_product']; ?>
                    <?php endif; ?>
                    ...
                    <?php if (isset($saleReportData[$branchItem->company->id][$branchItem->id]['total_service'])): ?>
                        <?php $totalService = $saleReportData[$branchItem->company->id][$branchItem->id]['total_service']; ?>
                    <?php endif; ?>
