...
<div class="grid-view">
    <table class="report" style="table-layout: fixed; width: 2000px">
        <tr id="header1">
            ...
            <th style="width: 80px">Qty Product</th>
            <th style="width: 80px">Qty Service</th>
        </tr>
        <?php $dppSums = array(); ?>
        ...
        <?php for ($n = 1; $n <= $numberOfDays; $n++): ?>
            ...
            <tr>
                ...
                <?php endforeach; ?>
                <td style="text-align: right"><?php echo CHtml::encode(Yii::app()->numberFormatter->format('#,##0.00', $dppProductSum)); ?></td>
                <td style="text-align: right"><?php echo CHtml::encode(Yii::app()->numberFormatter->format('#,##0.00', $dppServiceSum)); ?></td>
                <td style="text-align: right"><?php echo CHtml::encode(Yii::app()->numberFormatter->format('#,##0.00', $dppSum)); ?></td>
                ...
                <td style="text-align: right; font-weight: bold"><?php echo CHtml::encode(Yii::app()->numberFormatter->format('#,##0.00', $totalPrice)); ?></td>
