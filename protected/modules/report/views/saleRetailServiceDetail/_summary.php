...
<div style="font-weight: bold; text-align: center">
    <div style="font-size: larger">Rincian Penjualan per Jasa</div>
            ...
            <td colspan="4">
                <table>
                    <tr>
                        ...
                        <th class="width2-5">Asuransi</th>
                        <th class="width2-6">Plat #</th>
                        <th class="width2-7">Kendaraan</th>
    ...
    <tbody>
        <?php foreach ($saleRetailServiceSummary->dataProvider->data as $header): ?>
            <tr class="items1">
                ...
                <td class="width1-2"><?php echo CHtml::encode(CHtml::value($header, 'serviceType.name')); ?></td>
            ...
            <tr class="items2">
                <td colspan="4">
                    <table>
                        <?php $saleRetailData = $header->getSaleRetailServiceDetailReport($startDate, $endDate, $branchId, $customerType); ?>
                        <?php $totalSale = '0.00'; ?>
                        <?php foreach ($saleRetailData as $saleRetailRow): ?>
                            ...
                            <tr>
                                ...
                                <td class="width2-3"><?php echo CHtml::encode($saleRetailRow['work_order_number']); ?></td>
                                <td class="width2-4"><?php echo CHtml::encode($saleRetailRow['customer']); ?></td>
                                <td class="width2-5"><?php echo CHtml::encode($saleRetailRow['insurance']); ?></td>
                                <td class="width2-6"><?php echo CHtml::encode($saleRetailRow['plate_number']); ?></td>
                                <td class="width2-7">
