...
<?php while ($currentYear < $currentEndYear || $currentYear === $currentEndYear && $currentMonth <= $currentEndMonth): ?>
    ...
    <?php $yearMonthList[$currentYear . '-' . $month] = date('M', mktime(null, null, null, $currentMonth)) . ' ' . date('y', mktime(null, null, null, $currentMonth, null, $currentYear)); ?>
    <?php $currentMonth++; ?>
...
<?php if (count($yearMonthList) <= 12 && count($yearMonthList) >= 1): ?>
    <table style="width: 100%">
        ...
        <tbody>
            <?php foreach ($profitLossInfo as $categoryInfo): ?>
                <tr>
