                ...
                <?php foreach ($profitLossInfo as $elementNumber => $profitLossElementInfo): ?>
                    <?php if ($elementNumber === '5*'): ?>
                        <tr>
                            ...
                            <?php foreach ($yearMonthList as $yearMonth => $yearMonthFormatted): ?>
                                <?php $profitLossBruto = $elementsTotalSums['4'][$yearMonth] - $elementsTotalSums['5'][$yearMonth]; ?>
                                <td style="color: <?php echo $profitLossBruto < 0 ? 'red': 'black'; ?>; text-align: right; font-weight: bold; font-size: 20px;">
                                    <?php echo CHtml::encode(Yii::app()->numberFormatter->format('#,##0.00', $profitLossBruto)); ?>
                                </td>
                            <?php endforeach; ?>
                        </tr>
                    <?php elseif ($elementNumber === '8*'): ?>
                        <tr>
                            ...
                            <?php foreach ($yearMonthList as $yearMonth => $yearMonthFormatted): ?>
                            <?php $profitLossNet = $elementsTotalSums['4'][$yearMonth] - $elementsTotalSums['5'][$yearMonth] - $elementsTotalSums['6'][$yearMonth] + $elementsTotalSums['7'][$yearMonth] - $elementsTotalSums['8'][$yearMonth]; ?>
                                <td style="color: <?php echo $profitLossNet < 0 ? 'red': 'black'; ?>; text-align: right; font-weight: bold; font-size: 20px;">
                                    <?php echo CHtml::encode(Yii::app()->numberFormatter->format('#,##0.00', $profitLossNet)); ?>
                                </td>
                            <?php endforeach; ?>
                        </tr>
                    <?php else: ?>
                        <?php foreach ($profitLossElementInfo as $categoryInfo): ?>
                            ...
                            <?php foreach ($categoryInfo['sub_categories'] as $subCategoryInfo): ?>
                                            ...
                                            <?php foreach ($yearMonthList as $yearMonth => $yearMonthFormatted): ?>
                                                ...
                                                <td style="text-align: right;">
                                                    <?php echo CHtml::link(CHtml::encode(Yii::app()->numberFormatter->format('#,##0.00', $balance)), Yii::app()->createUrl("report/profitLossMonthly/jurnalTransaction", array(
                                                        ...
                                                        "YearMonth" => $yearMonth, 
                                                        "BranchId" => $branchId
                                                    )), array('target' => '_blank', 'style' => "color: $balance < 0 ? red : blue" )); ?>
                                                </td>
                                ...
                                <tr>
                                    ...
                                    <?php foreach ($yearMonthList as $yearMonth => $yearMonthFormatted): ?>
                                        <?php $totalSubCategory = $subCategoryTotalSums[$yearMonth]; ?>
                                        <td style="color: <?php echo $totalSubCategory < 0 ? 'red': 'black'; ?>; text-align: right; font-weight: bold; font-size: 14px;">
                                            <?php echo CHtml::encode(Yii::app()->numberFormatter->format('#,##0.00', $totalSubCategory)); ?>
                                        </td>
                                    <?php endforeach; ?>
                                </tr>
                                <?php foreach ($yearMonthList as $yearMonth => $yearMonthFormatted): ?>
                                    <?php if ($subCategoryInfo['code'] === '412.00.000' || $subCategoryInfo['code'] === '422.00.000' || $subCategoryInfo['code'] === '423.00.000' || $subCategoryInfo['code'] === '524.00.000'): ?>
                            ...
                            <tr>
                                ...
                                <?php foreach ($yearMonthList as $yearMonth => $yearMonthFormatted): ?>
                                    <?php $totalCategory = $categoryTotalSums[$yearMonth]; ?>
                                    <td style="color: <?php echo $totalCategory < 0 ? 'red': 'black'; ?>; text-align: right; font-weight: bold; font-size: 16px;">
                                        <?php echo CHtml::encode(Yii::app()->numberFormatter->format('#,##0.00', $totalCategory)); ?>
                                    </td>
                                <?php endforeach; ?>
                            </tr>
                            <?php foreach ($yearMonthList as $yearMonth => $yearMonthFormatted): ?>
