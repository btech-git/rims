...
Yii::app()->clientScript->registerScript('report', '
    ...
    $("#EndDate").val("' . $endDate . '");
    $("#PageSize").val("' . $outstandingRegistrationTransactionSummary->dataProvider->pagination->pageSize . '");
    $("#CurrentPage").val("' . ($outstandingRegistrationTransactionSummary->dataProvider->pagination->getCurrentPage(false) + 1) . '");
        ...
        <div id="detail_div">
            ...
            <div class="relative">
                <div class="reportDisplay">
                    <?php echo ReportHelper::summaryText($outstandingRegistrationTransactionSummary->dataProvider); ?>
            ...
            <div class="right">
                <?php $this->widget('system.web.widgets.pagers.CLinkPager', array(
                    'itemCount' => $outstandingRegistrationTransactionSummary->dataProvider->pagination->itemCount,
                    'pageSize' => $outstandingRegistrationTransactionSummary->dataProvider->pagination->pageSize,
                    'currentPage' => $outstandingRegistrationTransactionSummary->dataProvider->pagination->getCurrentPage(false),
                )); ?>
            </div>
            <div class="clear"></div>
        </div>
