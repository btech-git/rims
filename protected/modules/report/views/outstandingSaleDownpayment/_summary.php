...
<div style="font-weight: bold; text-align: center">
    ...
    <div style="font-size: larger">Laporan Outstanding Downpayment</div>
    ...
    <table class="responsive">
        <thead style="position: sticky; top: 0">
            <tr id="header1">
                ...
                <th class="width1-10">Downpayment (Rp)</th>
            </tr>
        </thead>
        <tbody>
            <?php foreach ($outstandingRegistrationTransactionSummary->dataProvider->data as $i => $header): ?>
                ...
                <tr class="items1">
                    ...
                    <td style="text-align: right">
                        <?php echo CHtml::encode(Yii::app()->numberFormatter->format('#,##0.00', CHtml::value($header, 'downpayment_amount'))); ?>
                    </td>
                </tr>
            <?php endforeach; ?>
        </tbody>
