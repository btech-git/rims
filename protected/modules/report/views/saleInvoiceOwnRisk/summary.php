...
Yii::app()->clientScript->registerScript('report', '
	...
	$("#PageSize").val("' . $saleInvoiceOwnRiskSummary->dataProvider->pagination->pageSize . '");
	$("#CurrentPage").val("' . ($saleInvoiceOwnRiskSummary->dataProvider->pagination->getCurrentPage(false) + 1) . '");
        ...
        <div id="detail_div">
                    ...
                    <div class="medium-6 columns">
                        ...
                        <div class="field">
                            <div class="row collapse">
                                ...
                                <div class="small-8 columns">
                                    <?php echo CHtml::activeTextField($saleInvoiceInsuranceOwnRisk, 'customer_id', array(
                                        'readonly' => true,
                                    ...
                                    <?php $this->widget('zii.widgets.grid.CGridView', array(
                                        ...
                                        'selectionChanged' => 'js:function(id) {
                                            $("#' . CHtml::activeId($saleInvoiceInsuranceOwnRisk, 'customer_id') . '").val($.fn.yiiGridView.getSelection(id));
                                            ...
                                            if ($.fn.yiiGridView.getSelection(id) == "") {
                                                ...
                                                $.ajax({
                                                    type: "POST",
                                                    dataType: "JSON",
                                                    url: "' . CController::createUrl('ajaxJsonCustomer', array('id' => $saleInvoiceInsuranceOwnRisk->id)) . '",
                                                    data: $("form").serialize(),
                                    ...
                                    <?php echo CHtml::encode(CHtml::value($saleInvoiceInsuranceOwnRisk, 'customer.name')); ?>
            ...
            <div class="relative">
                <div class="reportDisplay">
                    <?php echo ReportHelper::summaryText($saleInvoiceOwnRiskSummary->dataProvider); ?>
            ...
            <div class="right">
                <?php $this->widget('system.web.widgets.pagers.CLinkPager', array(
                    'itemCount' => $saleInvoiceOwnRiskSummary->dataProvider->pagination->itemCount,
                    'pageSize' => $saleInvoiceOwnRiskSummary->dataProvider->pagination->pageSize,
                    'currentPage' => $saleInvoiceOwnRiskSummary->dataProvider->pagination->getCurrentPage(false),
                )); ?>
            </div>
            <div class="clear"></div>
        </div>
