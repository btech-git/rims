...
Yii::app()->clientScript->registerScript('report', '
    ...
    $("#EndDate").val("' . $endDate . '");
    $("#PageSize").val("' . $outstandingSaleInvoiceSummary->dataProvider->pagination->pageSize . '");
    $("#CurrentPage").val("' . ($outstandingSaleInvoiceSummary->dataProvider->pagination->getCurrentPage(false) + 1) . '");
        ...
        <div id="detail_div">
            ...
            <div class="relative">
                <div class="reportDisplay">
                    <?php echo ReportHelper::summaryText($outstandingSaleInvoiceSummary->dataProvider); ?>
            ...
            <div class="right">
                <?php $this->widget('system.web.widgets.pagers.CLinkPager', array(
                    'itemCount' => $outstandingSaleInvoiceSummary->dataProvider->pagination->itemCount,
                    'pageSize' => $outstandingSaleInvoiceSummary->dataProvider->pagination->pageSize,
                    'currentPage' => $outstandingSaleInvoiceSummary->dataProvider->pagination->getCurrentPage(false),
                )); ?>
            </div>
            <div class="clear"></div>
        </div>
