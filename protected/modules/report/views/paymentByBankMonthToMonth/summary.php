        ...
        <div id="detail_div">
            <div>
                ...
                <div style="font-weight: bold; text-align: center">
                    ...
                    <div style="font-size: larger">Laporan Bank Multi Bulan</div>
                    <div>
                        <?php echo CHtml::encode(strftime("%B",mktime(0,0,0,$monthStart))); ?> <?php echo CHtml::encode($yearStart); ?> - 
                        <?php echo CHtml::encode(strftime("%B",mktime(0,0,0,$monthEnd))); ?> <?php echo CHtml::encode($yearEnd); ?>
                    </div>
                </div>
