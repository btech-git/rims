...
<div class="tab reportTab">
    <div class="tabHead">
        <div style="font-size: larger; font-weight: bold; text-align: center">
            Laporan Transaksi Piutang Customer Retail
        </div>
        <div style="font-size: larger; font-weight: bold; text-align: center">
    ...
    <?php echo CHtml::beginForm('', 'get'); ?>
        <div class="row buttons">
            <?php echo CHtml::submitButton('Simpan ke Excel', array('name' => 'SaveExcelRetail')); ?>
        </div>
                    ...
                    <tbody>
                        ...
                        <?php foreach ($dataProvider->data as $header): ?>
                            ...
                            <tr class="items1">
                                ...
                                <td style="text-align: right">
                                    <?php echo CHtml::encode(Yii::app()->numberFormatter->format('#,##0', $paymentTotal)); ?>
                                </td>
                                <td style="text-align: right">
