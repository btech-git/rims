...
<div class="row buttons">
    <div class="reportDisplay">
        <?php echo ReportHelper::summaryText($workingSheetSummary->dataProvider); ?>
    </div>
...
<table class="report">
    ...
    <?php foreach ($workingSheetSummary->dataProvider->data as $i => $header): ?>
        <tr>
            <td class="width2-1" style="text-align: center"><?php echo $i+1; ?></td>
            <td class="width2-2">
            ...
            <td class="width2-4"><?php echo CHtml::encode(CHtml::value($header, 'transaction_subject')); ?></td>
            <td class="width2-5"><?php echo CHtml::encode(CHtml::value($header, 'transaction_type')); ?></td>
