...
<table class="report">
    ...
    <tbody>
        ...
        <?php foreach ($saleVehicleProductSummary->dataProvider->data as $header): ?>
            <tr class="items1">
                <td colspan="2" style="text-align: center"><?php echo CHtml::encode(CHtml::value($header, 'id')); ?> - <?php echo CHtml::encode(CHtml::value($header, 'name')); ?></td>
            </tr>
            <tr class="items2">
                <td colspan="2">
                    <table>
                        ...
                        <?php foreach ($saleRetailData as $saleRetailRow): ?>
                            ...
                            <tr>
                                ...
                                <td class="width2-6" style="text-align: right"><?php echo CHtml::encode(Yii::app()->numberFormatter->format('#,##0', $saleRetailRow['sale_price'])); ?></td>
