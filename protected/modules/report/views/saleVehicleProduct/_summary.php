...
<div style="font-weight: bold; text-align: center">
    ...
    <div style="font-size: larger">Rincian Penjualan per Brand Kendaraan</div>
                ...
                <td>
                    <table>
                        ...
                        <?php foreach ($saleInvoiceVehicleReportData[$carSubModel->id] as $saleInvoiceVehicleReportItem): ?>
                            ...
                            <tr>
                                <td class="width2-1">
                                    <?php echo CHtml::link(CHtml::encode($saleInvoiceVehicleReportItem['invoice_number']), array(
                                        "/transaction/invoiceHeader/view", 
                                        "id" => $saleInvoiceVehicleReportItem['id'],
                                    ), array("target" => "_blank")); ?>
                                </td>
                                <td class="width2-2">
                                ...
                                <td class="width2-4"><?php echo CHtml::encode($saleInvoiceVehicleReportItem['insurance_company']); ?></td>
                                <td class="width2-5"><?php echo CHtml::encode($saleInvoiceVehicleReportItem['plate_number']); ?></td>
