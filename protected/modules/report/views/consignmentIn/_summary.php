...
<table class="report">
    ...
    <?php foreach ($consignmentInSummary->dataProvider->data as $header): ?>
        <tr class="items1">
            <td class="width1-1"><?php echo CHtml::link(CHtml::encode($header->consignment_in_number), array("/transaction/consignmentIn/view", "id"=>$header->id), array("target" => "_blank")); ?></td>
