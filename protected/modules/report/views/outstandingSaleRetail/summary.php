...
Yii::app()->clientScript->registerScript('report', '
    ...
    $("#EndDate").val("' . $endDate . '");
    $("#PageSize").val("' . $outstandingSaleRetailSummary->dataProvider->pagination->pageSize . '");
    $("#CurrentPage").val("' . ($outstandingSaleRetailSummary->dataProvider->pagination->getCurrentPage(false) + 1) . '");
        ...
        <div id="detail_div">
            ...
            <div class="relative">
                <div class="reportDisplay">
                    <?php echo ReportHelper::summaryText($outstandingSaleRetailSummary->dataProvider); ?>
            ...
            <div class="right">
                <?php $this->widget('system.web.widgets.pagers.CLinkPager', array(
                    'itemCount' => $outstandingSaleRetailSummary->dataProvider->pagination->itemCount,
                    'pageSize' => $outstandingSaleRetailSummary->dataProvider->pagination->pageSize,
                    'currentPage' => $outstandingSaleRetailSummary->dataProvider->pagination->getCurrentPage(false),
                )); ?>
            </div>
            <div class="clear"></div>
        </div>
