...
<div style="font-weight: bold; text-align: center">
    ...
    <div style="font-size: larger">Laporan Penjualan Bulanan <?php echo CHtml::encode(CHtml::value($branch, 'name')); ?></div>
...
<table class="report">
    ...
    <tbody>
        ...
        <?php for ($i = 1; $i <= 31; $i++): ?>
            <?php if (isset($monthlySingleBranchSaleReportData[$i]) && isset($monthlySingleBranchSaleProductReportData[$i])): ?>
                <?php $yearMonth = $year . '-' . str_pad($month, 2, '0', STR_PAD_LEFT); ?>
                <?php $startDate = $yearMonth . '-' . $i; ?>
                <?php $endDate = $yearMonth . '-' . $i; ?>
        
                <?php $dataItem = $monthlySingleBranchSaleReportData[$i]; ?>
                <?php $detailItem = $monthlySingleBranchSaleProductReportData[$i]; ?>
