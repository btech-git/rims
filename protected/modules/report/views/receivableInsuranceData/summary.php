                            ...
                            <div class="field">
                                <div class="row collapse">
                                    ...
                                    <div class="small-8 columns">
                                        <?php echo CHtml::dropDownlist('InsuranceCompanyId', $insuranceCompanyId, CHtml::listData(InsuranceCompany::model()->findAllbyAttributes(array('is_deleted' => 0)), 'id', 'name'), array('empty' => '-- All --')); ?>
                                    </div>
                                </div>
                            </div>
                        </div>
...
//                                                'placeholder' => 'Sampai',
                ...
                <div class="right"><?php echo ReportHelper::summaryText($receivableInsuranceDataSummary->dataProvider); ?></div>
