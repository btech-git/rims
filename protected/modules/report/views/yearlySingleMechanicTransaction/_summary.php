...
<table class="report">
    ...
    <tbody>
        ...
        <?php for ($i = 1; $i <= 12; $i++): ?>
            <?php if (isset($yearlySingleMechanicTransactionReportData[$i]) && isset($yearlySingleMechanicTransactionServiceReportData[$i])): ?>
                <?php $dataItem = $yearlySingleMechanicTransactionReportData[$i]; ?>
                <?php $detailItem = $yearlySingleMechanicTransactionServiceReportData[$i]; ?>
