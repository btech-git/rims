        ...
        <tbody>
            <?php foreach ($customerCompanyTopSaleReport as $i => $dataItemCompany): ?>
                <tr class="items1">
                    ...
                    <td style="text-align: center"><?php echo CHtml::encode(Yii::app()->numberFormatter->format('#,##0', $dataItemCompany['quantity_invoice'])); ?></td>
                    <td style="text-align: right"><?php echo CHtml::encode(Yii::app()->numberFormatter->format('#,##0.00', $dataItemCompany['total_price'])); ?></td>
                </tr>
            <?php endforeach; ?>
        </tbody>
    </table>
        ...
        <tbody>
            <?php foreach ($customerIndividualTopSaleReport as $i => $dataItemIndividual): ?>
                <tr class="items1">
                    ...
                    <td style="text-align: center"><?php echo CHtml::encode(Yii::app()->numberFormatter->format('#,##0', $dataItemIndividual['quantity_invoice'])); ?></td>
                    <td style="text-align: right"><?php echo CHtml::encode(Yii::app()->numberFormatter->format('#,##0.00', $dataItemIndividual['total_price'])); ?></td>
                </tr>
            <?php endforeach; ?>
        </tbody>
    </table>
