...
Yii::app()->clientScript->registerScript('report', '
    ...
    $("#EndDate").val("' . $endDate . '");
    $("#PageSize").val("' . $outstandingPurchaseOrderSummary->dataProvider->pagination->pageSize . '");
    $("#CurrentPage").val("' . ($outstandingPurchaseOrderSummary->dataProvider->pagination->getCurrentPage(false) + 1) . '");
        ...
        <div id="detail_div">
            ...
            <div class="relative">
                <div class="reportDisplay">
                    <?php echo ReportHelper::summaryText($outstandingPurchaseOrderSummary->dataProvider); ?>
            ...
            <div class="right">
                <?php $this->widget('system.web.widgets.pagers.CLinkPager', array(
                    'itemCount' => $outstandingPurchaseOrderSummary->dataProvider->pagination->itemCount,
                    'pageSize' => $outstandingPurchaseOrderSummary->dataProvider->pagination->pageSize,
                    'currentPage' => $outstandingPurchaseOrderSummary->dataProvider->pagination->getCurrentPage(false),
                )); ?>
            </div>
            <div class="clear"></div>
        </div>
