...
<div style="font-weight: bold; text-align: center">
    ...
    <div style="font-size: larger">Laporan Kinerja Mekanik</div>
    <div><?php echo CHtml::encode(Yii::app()->dateFormatter->format('d MMMM yyyy', strtotime($transactionDate))); ?></div>
</div>
...
<table class="report">
    ...
    <tbody>
        <?php foreach ($registrationTransactionSummary->dataProvider->data as $i => $header): ?>
            <tr class="items1">
                <td><?php echo $i + 1; ?></td>
                <td class="width1-1"><?php echo CHtml::encode(CHtml::value($header, 'employeeIdAssignMechanic.name')); ?></td>
                ...
                <td class="width1-8"><?php echo CHtml::encode(CHtml::value($header, 'services')); ?></td>
                <td class="width1-9" style="text-align: right">
                    <?php echo CHtml::encode(Yii::app()->numberFormatter->format('#,##0.00', ($header->total_service_price))); ?>
                </td>
                <td class="width1-10"><?php echo CHtml::encode(CHtml::value($header, 'products')); ?></td>
                <td class="width1-9" style="text-align: right">
                    <?php echo CHtml::encode(Yii::app()->numberFormatter->format('#,##0.00', ($header->total_product_price))); ?>
                </td>
            </tr>
        <?php endforeach; ?>
    </tbody>
