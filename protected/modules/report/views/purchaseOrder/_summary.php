            ...
            <td colspan="3">
                <table>
                    <tr>
                        ...
                        <th class="width2-5">Parts</th>
                        <th class="width2-6">Status</th>
                        <th class="width2-7">Quantity</th>
                        <th class="width2-8">Total Price</th>
                    </tr>
                </table>
            </td>
        </tr>
                    ...
                    <table>
                        ...
                        <?php if (!empty($purchaseOrderData)): ?>
                            <?php foreach ($purchaseOrderData as $purchaseOrderItem): ?>
                                <?php $quantity = $purchaseOrderItem['total_quantity']; ?>
                        ...
                        <?php if (!empty($workOrderExpenseData)): ?>
                            ...
                            <tr>
                                ...
                                <td style="text-align: right; font-weight: bold">
                                    <?php echo CHtml::encode(Yii::app()->numberFormatter->format('#,##0.00', $totalWorkOrderExpense)); ?>
                                </td>
                            </tr>
                            <?php $grandTotalPurchase += $totalPurchase; ?>
                        <?php endif; ?>
