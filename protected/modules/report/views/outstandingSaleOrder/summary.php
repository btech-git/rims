...
Yii::app()->clientScript->registerScript('report', '
    ...
    $("#EndDate").val("' . $endDate . '");
    $("#PageSize").val("' . $outstandingSaleOrderSummary->dataProvider->pagination->pageSize . '");
    $("#CurrentPage").val("' . ($outstandingSaleOrderSummary->dataProvider->pagination->getCurrentPage(false) + 1) . '");
        ...
        <div id="detail_div">
            ...
            <div class="relative">
                <div class="reportDisplay">
                    <?php echo ReportHelper::summaryText($outstandingSaleOrderSummary->dataProvider); ?>
            ...
            <div class="right">
                <?php $this->widget('system.web.widgets.pagers.CLinkPager', array(
                    'itemCount' => $outstandingSaleOrderSummary->dataProvider->pagination->itemCount,
                    'pageSize' => $outstandingSaleOrderSummary->dataProvider->pagination->pageSize,
                    'currentPage' => $outstandingSaleOrderSummary->dataProvider->pagination->getCurrentPage(false),
                )); ?>
            </div>
            <div class="clear"></div>
        </div>
