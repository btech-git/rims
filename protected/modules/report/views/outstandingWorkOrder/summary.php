...
Yii::app()->clientScript->registerScript('report', '
    ...
    $("#EndDate").val("' . $endDate . '");
    $("#PageSize").val("' . $outstandingWorkOrderSummary->dataProvider->pagination->pageSize . '");
    $("#CurrentPage").val("' . ($outstandingWorkOrderSummary->dataProvider->pagination->getCurrentPage(false) + 1) . '");
        ...
        <div id="detail_div">
            ...
            <div class="relative">
                <div class="reportDisplay">
                    <?php echo ReportHelper::summaryText($outstandingWorkOrderSummary->dataProvider); ?>
            ...
            <div class="right">
                <?php $this->widget('system.web.widgets.pagers.CLinkPager', array(
                    'itemCount' => $outstandingWorkOrderSummary->dataProvider->pagination->itemCount,
                    'pageSize' => $outstandingWorkOrderSummary->dataProvider->pagination->pageSize,
                    'currentPage' => $outstandingWorkOrderSummary->dataProvider->pagination->getCurrentPage(false),
                )); ?>
            </div>
            <div class="clear"></div>
        </div>
