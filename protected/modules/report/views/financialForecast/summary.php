    ...
    <div class="tabBody">
        <div id="detail_div">
            <div class="myForm">
                ...
                <div class="row">
                    ...
                    <div class="medium-6 columns">
                        <div class="field">
                            <div class="row collapse">
                                <?php echo CHtml::link('<span class="fa fa-edit"></span>Hutang/Piutang', Yii::app()->baseUrl . '/report/financialForecast/receivablePayable', array('class' => 'button info', 'target' => 'blank')) ?>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="relative">
                ...
                <?php $forecastApprovalCriteria->addBetweenCondition('date_transaction', $datePrevious, $dateNext); ?>
                        ...
                        <tr class="forecast-body">
                            <td colspan="3">
                                <table>
                                    <tr>
                                        ...
                                        <td style="text-align: right; font-weight: bold">
                                            <?php if (empty($coa)): ?>
                                                <?php echo '0' ;?>
                                            <?php else: ?>
                                                <?php $saldo = $coa->getBalanceTotal($datePrevious, $dateNext, null); ?>
                                    ...
                                    <?php $forecastData = $coa->getFinancialForecastReport($datePrevious, $dateNext); ?>
