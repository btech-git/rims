...
class OutstandingSaleDownpaymentController extends Controller {
    ...
    public function actionSummary() {
        ...
        $outstandingRegistrationTransactionSummary = new OutstandingSaleDownpaymentSummary($registrationTransaction->searchReport());
