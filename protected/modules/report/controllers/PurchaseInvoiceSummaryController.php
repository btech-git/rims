...
//            'access',
    ...
    public function actionSummary() {
        ...
        $branchId = (isset($_GET['TransactionPurchaseOrder']['main_branch_id'])) ? $_GET['TransactionPurchaseOrder']['main_branch_id'] : (Yii::app()->user->checkAccess('director') ? '' : Yii::app()->user->branch_id);
