...
class TransactionLogUserCounterController extends Controller {
...
//            'access',
    ...
    public function actionSummary() {
        ...
        $transactionLogUserCounterData = TransactionLog::getTransactionLogUserCounterData($startDate, $endDate);
        
        $controllerClasses = array();
        $userCounterData = array();
        foreach ($transactionLogUserCounterData as $dataItem) {
            if (!in_array($dataItem['controller_class'], $controllerClasses)) {
                $controllerClasses[] = $dataItem['controller_class'];
            }
            if (!isset($userCounterData[$dataItem['user_id']])) {
                $userCounterData[$dataItem['user_id']] = array();
            }
            $userCounterData[$dataItem['user_id']]['username'] = $dataItem['username'];
            if (!isset($userCounterData[$dataItem['user_id']][$dataItem['controller_class']])) {
                $userCounterData[$dataItem['user_id']][$dataItem['controller_class']] = array();
            }
            $userCounterData[$dataItem['user_id']][$dataItem['controller_class']][$dataItem['action_type']] = $dataItem['counter'];
        }
