...
class InventoryTireController extends Controller {
    ...
    public function actionSummary() {
        ...
        $inventoryTireProductionYearStockReportData = array();
        foreach ($inventoryTireProductionYearStockReport as $inventoryTireProductionYearStockReportItem) {
            $inventoryTireProductionYearStockReportData[$inventoryTireProductionYearStockReportItem['product_id']][$inventoryTireProductionYearStockReportItem['branch_id']][$inventoryTireProductionYearStockReportItem['production_year']] = $inventoryTireProductionYearStockReportItem['total_stock'];
        }
...
//        }
        ...
        $this->render('summary', array(
            'inventoryTireProductionYearStockReportData' => $inventoryTireProductionYearStockReportData,
            'endDate' => $endDate,
            'product' => $product,
            'branches' => $branches,
        ));
