...
class EmployeeYearlyAttendanceController extends Controller {
    ...
    public function actionSummary() {
        ...
        $employeeYearlyAttendance = EmployeeTimesheet::getEmployeeYearlyAttendance($employeeId, $year);
        
        $employeeYearlyAttendanceData = array();
        foreach ($employeeYearlyAttendance as $employeeYearlyAttendanceItem) {
            $monthValue = intval($employeeYearlyAttendanceItem['month']);
            $employeeYearlyAttendanceData[$monthValue][$employeeYearlyAttendanceItem['employee_onleave_category_id']]['days'] = $employeeYearlyAttendanceItem['days'];
...
//        }
    ...
    protected function saveToExcel($employeeYearlyAttendanceData, $yearList, $year) {
        set_time_limit(0);
        ini_set('memory_limit', '1024M');
        ...
        for ($month = 1; $month <= 12; $month++) {
            ...
            $columnCounter = 'B';
            foreach ($branches as $branch) {
                $amount = isset($employeeYearlyAttendanceData[$month][$branch->id]) ? $employeeYearlyAttendanceData[$month][$branch->id] : '0.00';
