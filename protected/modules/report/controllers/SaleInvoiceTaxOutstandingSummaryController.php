...
class SaleInvoiceTaxOutstandingSummaryController extends Controller {
    ...
    public function actionSummary() {
        ...
        $saleInvoiceSummary = new SaleInvoiceTaxOutstandingSummary($invoiceHeader->search());
    ...
    protected function saveToExcel($saleInvoiceSummary, $startDate, $endDate) {
        ...
        $worksheet->setCellValue('A2', 'Faktur Penjualan PPn (Outstanding F. Pajak');
