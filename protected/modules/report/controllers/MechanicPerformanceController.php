...
class MechanicPerformanceController extends Controller {
    ...
    protected function saveToExcel($dataProvider, array $options = array()) {
        ...
        $documentProperties->setTitle('Mechanic Performance');

        $worksheet = $objPHPExcel->setActiveSheetIndex(0);
        $worksheet->setTitle('Mechanic Performance');
        ...
        $worksheet->setCellValue('A2', 'Mechanic Performance');
        ...
        header('Content-Disposition: attachment;filename="mechanic_performance.xls"');
