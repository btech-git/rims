...
class ReceivableInsuranceDetailController extends Controller {
    ...
    public function actionSummary() {
        ...
        $accountDataProvider->criteria->addCondition("t.name LIKE '%Asuransi%'");
        $accountDataProvider->pagination->pageVar = 'page_dialog';

        $receivableDetailSummary = new ReceivableInsuranceDetailSummary($account->search());
