...
class SaleProductSubMasterCategoryController extends Controller {
    ...
    public function actionSummary() {
        ...
        $saleReportByProductCategory = InvoiceHeader::getSaleByProductSubMasterCategoryReport($startDate, $endDate, $branchId);
        $saleReportSummary = InvoiceHeader::getSaleByProductSubMasterCategoryReportSummary($startDate, $endDate, $branchId);
        
        $saleReportData = array();
        foreach ($saleReportByProductCategory as $saleReportItem) {
            $key = $saleReportItem['customer_type'] . '|' . $saleReportItem['transaction_date'] . '|p|' . $saleReportItem['product_sub_master_category_id'];
        ...
        $saleReportByProductCategoryAll = InvoiceHeader::getSaleByProductSubMasterCategoryReportAll($startDate, $endDate, $branchId);
        $saleReportSummaryAll = InvoiceHeader::getSaleByProductSubMasterCategoryReportSummaryAll($startDate, $endDate, $branchId);
        
        $saleReportAllData = array();
        foreach ($saleReportByProductCategoryAll as $saleReportItem) {
            $key = $saleReportItem['transaction_date'] . '|p|' . $saleReportItem['product_sub_master_category_id'];
        ...
        $productSubMasterCategoryList = ProductSubMasterCategory::model()->findAllByAttributes(array('status' => 'Active'));
    ...
    protected function saveToExcel($saleReportData, $saleReportAllData, array $options = array()) {
        ...
        $productSubMasterCategoryList = $options['productMasterCategoryList'];
        ...
        $columnCounter = 'B';
        foreach ($productSubMasterCategoryList as $productMasterCategoryItem) {
