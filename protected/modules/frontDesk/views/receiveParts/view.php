...
<div id="maincontent">
    <div class="clearfix page-action">
        ...
        <?php //if ($receiveParts->status_document != 'Approved' && $receiveParts->status_document != 'Rejected'): ?>
            <?php echo CHtml::link('<span class="fa fa-edit"></span>Edit', Yii::app()->baseUrl . '/frontDesk/receiveParts/update?id=' . $receiveParts->id, array(
...
//                'visible' => Yii::app()->user->checkAccess("materialRequestEdit")
        ...
        <h1>View Penerimaan Parts Supply #<?php echo $receiveParts->id; ?></h1>
