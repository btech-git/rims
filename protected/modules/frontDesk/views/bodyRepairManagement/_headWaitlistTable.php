    ...
    <tbody>
        <?php foreach ($modelDataProvider->data as $model): ?>
            <tr>
                ...
                <td><?php echo CHtml::link('<span class="fa fa-wrench"></span>View', Yii::app()->createUrl("frontDesk/bodyRepairManagement/viewHeadAssignMechanic", array("registrationId"=>$model->id)), array('class' => 'button warning')); ?></td>
            </tr>
        <?php endforeach; ?>
    </tbody>
</table>