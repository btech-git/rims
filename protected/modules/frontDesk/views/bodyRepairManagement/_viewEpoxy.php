...
<div style="text-align: right">
    ...
    <table>
        ...
        <tbody>
            <?php foreach ($assignEpoxyDataProvider->data as $model): ?>
                <tr>
                    <?php $registrationTransaction = $model->registrationTransaction; $vehicle = $registrationTransaction->vehicle; ?>
                    <td><?php echo $vehicle != null ? $vehicle->plate_number : ' '; ?></td>
                    <td><?php echo $vehicle != null ? $vehicle->carMake->name : ' '; ?></td>
                    ...
                    <td><?php echo CHtml::encode(CHtml::value($model, 'mechanicAssigned.name')); ?></td>
                    <td><?php echo $registrationTransaction->note; ?></td>
                    <td><?php echo CHtml::link('<span class="fa fa-wrench"></span>Processing', Yii::app()->createUrl("frontDesk/bodyRepairManagement/startProcessingEpoxy", array("id"=>$model->id)), array('class' => 'button success')); ?></td>
                </tr>
            <?php endforeach; ?>
        </tbody>
    </table>
...
<div style="text-align: right">
    ...
    <table>
        ...
        <tbody>
            <?php foreach ($progressEpoxyDataProvider->data as $model): ?>
                <tr>
                    <?php $registrationTransaction = $model->registrationTransaction; $vehicle = $registrationTransaction->vehicle; ?>
                    <td><?php echo $vehicle != null ? $vehicle->plate_number : ' '; ?></td>
                    <td><?php echo $vehicle != null ? $vehicle->carMake->name : ' '; ?></td>
                    ...
                    <td><?php echo CHtml::encode(CHtml::value($model, 'mechanicAssigned.name')); ?></td>
                    <td><?php echo $registrationTransaction->note; ?></td>
                    <td><?php echo CHtml::link('<span class="fa fa-wrench"></span>QC', Yii::app()->createUrl("frontDesk/bodyRepairManagement/proceedToQualityControlEpoxy", array("id"=>$model->id)), array('class' => 'button success')); ?></td>
                </tr>
            <?php endforeach; ?>
        </tbody>
    </table>
...
<div style="text-align: right">
    ...
    <table>
        ...
        <tbody>
            <?php foreach ($qualityControlEpoxyDataProvider->data as $model): ?>
                <tr>
                    <?php $registrationTransaction = $model->registrationTransaction; $vehicle = $registrationTransaction->vehicle; ?>
                    <td><?php echo $vehicle != null ? $vehicle->plate_number : ' '; ?></td>
                    <td><?php echo $vehicle != null ? $vehicle->carMake->name : ' '; ?></td>
...
<div style="text-align: right">
    ...
    <table>
        ...
        <tbody>
            <?php foreach ($finishedEpoxyDataProvider->data as $model): ?>
                <tr>
                    <?php $registrationTransaction = $model->registrationTransaction; $vehicle = $registrationTransaction->vehicle; ?>
                    <td><?php echo $vehicle != null ? $vehicle->plate_number : ' '; ?></td>
                    <td><?php echo $vehicle != null ? $vehicle->carMake->name : ' '; ?></td>
