    ...
    <tbody>
        <?php foreach ($modelDataProvider->data as $model): ?>
            <tr>
                ...
                <td><?php echo $model->user_id != null ? $model->user->username : '-'; ?></td>
                <td><?php echo CHtml::link('<span class="fa fa-wrench"></span>Detail', Yii::app()->createUrl("frontDesk/bodyRepairManagement/viewDetailWorkOrder", array("registrationId"=>$model->id)), array('class' => 'button warning')); ?></td>
            </tr>
        <?php endforeach; ?>
    </tbody>
</table>