...
<div class="clearfix page-action">
    ...
    <h1><?php if ($vehicleInspection->header->isNewRecord) {
    ...
    <div class="form">
        ...
        <div class="row">
            <div class="small-12 medium-6 columns">
                <?php echo $form->hiddenField($vehicleInspection->header, 'vehicle_id', array('readonly' => true)); ?>
                ...
                <div class="field">
                    <div class="row collapse">
                        ...
                        <div class="small-8 columns">
                            ...
                            <?php echo $form->dropDownList($vehicleInspection->header, 'inspection_id', CHtml::listData(Inspection::model()->findAll(array('order' => 'name')), 'id', 'name'),
                                array(
...
<?php echo $form->error($vehicleInspection->header, 'inspection_date'); ?>
                ...
                <div class="field">
                    <div class="row collapse">
                        ...
                        <div class="small-8 columns">
                            <?php echo $form->textField($vehicleInspection->header, 'work_order_number', array('readonly' => true)); ?>
