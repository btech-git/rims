<?php //if (count($generalRepairRegistration->serviceDetails) > 0):  ?>
<table>
    <thead>
        <tr>
            <th>Service name</th>
    ...
    <tbody>
        <?php foreach ($generalRepairRegistration->serviceDetails as $i => $serviceDetail): ?>
                    ...
                    <td><?php
                        echo CHtml::activeTextField($serviceDetail, "[$i]price", array(
                            'onchange' => CHtml::ajax(array(
                                'type' => 'POST',
                                'dataType' => 'JSON',
                                'url' => CController::createUrl('ajaxJsonTotalService', array('id' => $generalRepairRegistration->header->id, 'index' => $i)),
