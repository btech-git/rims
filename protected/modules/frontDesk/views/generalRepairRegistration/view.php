    ...
    <div id="maincontent">
        <div class="clearfix page-action">
                    ...
                    <div class="large-12 columns">
                        ...
                        <?php if ($model->status !== 'Finished'): ?>
                            ...
                            <?php if (Yii::app()->user->checkAccess("frontOfficeHead") && count($invoices) > 0): ?>
                                ...
                                <?php echo CHtml::link('<span class="fa fa-edit"></span> Revisi Parts & Service', Yii::app()->baseUrl . '/frontDesk/generalRepairRegistration/addProductService?registrationId=' . $model->id, array(
                                    'class' => 'button warning left', 
                                    'style' => 'margin-right:10px'
                                )); ?>
                            <?php endif; ?>
                            ...
                            <?php if (empty($invoices) && !empty($model->insurance_company_id)): ?>
                        ...
                        <?php if (empty($invoices) && $model->is_downpayment_paid == 0): ?>
                            ...
                            <?php echo CHtml::link($downpaymentText, Yii::app()->baseUrl . '/frontDesk/generalRepairRegistration/addDownpayment?id=' . $model->id, array(
                                'class' => 'button success left', 
                                'style' => 'margin-left:10px', 
                                'visible' => Yii::app()->user->checkAccess("generalRepairCreate") || Yii::app()->user->checkAccess("generalRepairEdit")
                            )); ?>
            ...
            <fieldset>
                ...
                <?php if ($model->user_id_cancelled == null): ?>
                    <div class="row">
                        <?php echo CHtml::link('<span class="fa fa-plus"></span> KM Kendaraan', array("/frontDesk/generalRepairRegistration/updateMileage", "id" => $model->id), array(
                            'class' => 'button success left', 
                            'style' => 'margin-right:10px',
                            'visible' => Yii::app()->user->checkAccess("generalRepairCreate") || Yii::app()->user->checkAccess("generalRepairEdit")
                        )); ?>

                        <?php echo CHtml::link('<span class="fa fa-plus"></span> Problem', array("/frontDesk/generalRepairRegistration/updateProblem", "id" => $model->id), array(
                            'class' => 'button success left', 
                            'style' => 'margin-right:10px',
                            'visible' => Yii::app()->user->checkAccess("generalRepairCreate") || Yii::app()->user->checkAccess("generalRepairEdit")
                        )); ?>

                        <?php echo CHtml::link('<span class="fa fa-plus"></span> SPK Customer', array("/frontDesk/generalRepairRegistration/updateCustomerWorkOrder", "id" => $model->id), array(
                            'class' => 'button success left', 
                            'style' => 'margin-right:10px',
                            'visible' => Yii::app()->user->checkAccess("generalRepairCreate") || Yii::app()->user->checkAccess("generalRepairEdit")
                        )); ?>
