    ...
    <div class="body-memo">
        <table>
            ...
            <tr>
                ...
                <td rowspan="2" style="vertical-align: top"><?php echo nl2br($generalRepairRegistration->problem); ?></td>
                <td>ASURANSI</td>
                <td>:</td>
                <td><?php echo CHtml::encode(CHtml::value($generalRepairRegistration, 'insuranceCompany.name')); ?></td>
            </tr>
            <tr>
                <td>SPK Customer #</td>
                <td>:</td>
                <td><?php echo CHtml::encode(CHtml::value($generalRepairRegistration, 'customer_work_order_number')); ?></td>
            </tr>
        </table>
    </div>
