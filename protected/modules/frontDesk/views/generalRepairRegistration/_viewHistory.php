<div class="detail">
    <table>
        ...
        <tbody>
            <?php $historyTransactions = RegistrationTransaction::model()->findAllByAttributes(array('vehicle_id'=>$model->vehicle_id), array(
                'order' => 't.id DESC', 
                'limit' => 10
            )); ?>
            <?php if (count($historyTransactions) > 0 && $model->vehicle_id != ""): ?>
            ...
            <?php else: ?>
                <tr>
                    <td colspan="6"><?php echo "NO HISTORY"; ?></td>
                </tr>
            <?php endif; ?>
        </tbody>
    </table>
