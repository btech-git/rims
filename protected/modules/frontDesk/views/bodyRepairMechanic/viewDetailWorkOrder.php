                        ...
                        <tr>
                            ...
                            <td>
                                <?php echo CHtml::tag('button', array(
                                    ...
                                    'onclick' => '$("#detail-product-' . $key . '").toggle();'
                                ), '<span class="fa fa-caret-down"></span> Detail'); ?>
                            </td>
                        </tr>
                        <tr>
                            <td id="detail-product-<?php echo $key ?>" class="hide" colspan=6>
                                <?php
                                ...
                                <table>
                                    <thead>
                                        ...
                                        <tr>
                                            ...
                                            <!-- <a class="button cbutton left" style="margin-right:10px;" href="<?php //echo Yii::app()->createUrl('/registrationTransaction/receive',array('movementOutDetailId'=>$md->id,'registrationProductId'=>$rp->id)); ?>"><span class="fa fa-pencil"></span>receive</a> -->
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </table>
