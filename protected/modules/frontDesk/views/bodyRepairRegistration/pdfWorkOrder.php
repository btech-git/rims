...
<div class="container">
    ...
    <div style="text-align: right; font-size: 10px;">
        No WO: <?php echo CHtml::encode(CHtml::value($bodyRepairRegistration, 'work_order_number')); ?>
        &nbsp;&nbsp;
        No Nota: <?php echo CHtml::encode(CHtml::value($bodyRepairRegistration, 'sales_order_number')); ?>
    </div>
    ...
    <div class="body-memo">
        <table>
            ...
            <tr>
                <td>JAM MASUK</td>
                <td>:</td>
                <td><?php echo Yii::app()->dateFormatter->formatDateTime($bodyRepairRegistration->transaction_date, '', 'short'); ?></td>
                <td>JAM SELESAI</td>
                <td>:</td>
                <td><?php //echo $customer->name; ?></td>
            </tr>
