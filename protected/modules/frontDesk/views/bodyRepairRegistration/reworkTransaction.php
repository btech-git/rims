...
<div class="small-12 columns">
    <div id="maincontent">
        <div class="clearfix page-action">
            ...
            <h1>Rework Transaction #<?php echo $bodyRepairRegistration->header->transaction_number; ?></h1>
                    ...
                    <div class="large-6 columns">
                        <div class="field">
                            <div class="row collapse">
                                ...
                                <div class="small-8 columns">
                                    <?php echo CHtml::activeTextArea($bodyRepairRegistration->header, 'rework_note'); ?>
                                    <?php echo $form->error($bodyRepairRegistration->header,'rework_note'); ?>
                                </div>
                            </div>
                        </div>
                    </div> <!-- end div large -->
                    ...
                    <div class="large-6 columns">
                        <div class="field">
                            <div class="row collapse">
                                ...
                                <div class="small-8 columns">
                                    <?php echo CHtml::activeDropDownlist($bodyRepairRegistration->header, 'employee_id_rework_mechanic', CHtml::listData(Employee::model()->findAllByAttributes(array(
                                        "position_id" => 1,
                                        'status' => 'Active',
                                    )), "id", "name"), array("empty" => "--Assign Mechanic Rework--")); ?>
                                    <?php echo $form->error($bodyRepairRegistration->header,'employee_id_rework_mechanic'); ?>
                                </div>
                            </div>
                        </div>
                    </div><!-- end div large -->
