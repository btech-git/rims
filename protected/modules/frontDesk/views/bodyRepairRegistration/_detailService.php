            ...
            <?php foreach ($bodyRepairRegistration->serviceDetails as $i => $serviceDetail): ?>
                <?php if ($serviceDetail->is_body_repair == 0): ?>
                    <tr>
                        ...
                        <td><?php echo CHtml::activeTextField($serviceDetail, "[$i]claim", array('readonly' => true)); ?></td>
                        <td>
                        ...
                        <td>
                            <?php echo CHtml::button('X', array(
                                'onclick' => CHtml::ajax(array(
                                    'type' => 'POST',
                                    'url' => CController::createUrl('ajaxHtmlRemoveServiceDetail', array(
                                        'id' => $bodyRepairRegistration->header->id, 
                                        'index' => $i
                                    )),
                                    'update' => '#service',
                                )),
