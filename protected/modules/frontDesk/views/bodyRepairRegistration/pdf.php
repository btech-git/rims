                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td colspan="2" style="font-weight: bold; text-align: right;">
                                &nbsp;  Rp. <?php echo number_format($bodyRepairRegistration->subtotal_product, 2, ',', '.'); ?>
                            </td>
                        </tr>
                    </table>
                </div>
                    ...
                    <table>
                        ...
                        <?php foreach ($bodyRepairRegistration->registrationQuickServices as $quickService): ?>
                            <tr class="isi">
                                ...
                                <td style="text-align: center">&nbsp; <?php echo $bodyRepairRegistration->ppnLiteral; ?></td>
                        ...
                        <tr>
                            ...
                            <td colspan="2" style="font-weight: bold; text-align: right">
                                &nbsp;  Rp. <?php echo number_format($bodyRepairRegistration->subtotal_service, 2, ',', '.'); ?>
                            </td>
                        </tr>
                    </table>
                </div>
