...
<div id="maincontent">
    <?php echo CHtml::link('Registration', array('/frontDesk/registrationTransaction/view', 'id'=>$registration->id), array(
        'target' => '_blank', 
        'class'=>'button primary right'
    )); ?>
    <span style="float: right">&nbsp;&nbsp;&nbsp;</span>
    <?php echo CHtml::link('Inspection', array(
        '/frontDesk/vehicleInspection/create', 
        'vehicleId'=>$registration->vehicle_id, 
        'wonumber' => $registration->work_order_number
    ), array('target' => '_blank', 'class'=>'button success right')); ?>
