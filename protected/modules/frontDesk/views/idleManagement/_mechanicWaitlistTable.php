    ...
    <tbody>
        <?php foreach ($modelDataProvider->data as $model): ?>
            <tr>
                ...
                <td><?php echo CHtml::link('<span class="fa fa-wrench"></span>Detail', Yii::app()->createUrl("frontDesk/idleManagement/viewDetailWorkOrder", array("registrationId"=>$model->id)), array('class' => 'button warning', 'target' => '_blank')); ?></td>
            </tr>
        <?php endforeach; ?>
    </tbody>
</table>