    ...
    <div>
        <table>
            ...
            <tbody>
                <tr>
                    <td>
                        <?php echo CHtml::activeDropDownList($registrationService, 'finish_mechanic_id', CHtml::listData(EmployeeBranchDivisionPositionLevel::model()->findAllByAttributes(array('division_id' => 1), array('order' =>'employee_id')), 'employee_id', 'employee.name'), array(
                            'empty' => '-- All --',
