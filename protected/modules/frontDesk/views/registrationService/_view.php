...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('claim')); ?>:</b>
	<?php echo CHtml::encode($data->claim); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('service_exception_rate')); ?>:</b>
	<?php echo CHtml::encode($data->service_exception_rate); ?>
	<br />
