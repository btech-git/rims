...
<div id="maincontent">
    <div class="clearfix page-action">
        ...
        <?php $branches = Branch::model()->findAllByAttributes(array('status'=>'Active'));
            ...
            foreach ($branches as $branch) {
                ...
                foreach($branch->warehouses as $warehouse) {
                    ...
                    foreach ($details as $key => $detail) {
                        if ($detail->warehouse->branch_id == $warehouse->branch_id){
                    ...
                    $tableContent .= '</table>';
                    if ($datarow !=0) {
                        $tabarray[" " . $warehouse->branch->name]=$tableContent;
                    }
                }
            }
