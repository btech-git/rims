<?php $this->renderPartial('_search_dempul'); ?>

<?php $this->widget('ext.groupgridview.GroupGridView', array(
	'id'=>'dempulDatas-transaction-grid',
	'dataProvider'=>$dempulDatas,
	// 'filter'=>$model,
...
$('form').submit(function(){
	$('#dempulDatas-transaction-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
