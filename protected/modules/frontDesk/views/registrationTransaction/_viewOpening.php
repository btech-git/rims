<?php $this->renderPartial('_search_opening'); ?>

<?php $this->widget('ext.groupgridview.GroupGridView', array(
	'id'=>'openingDatas-transaction-grid',
	'dataProvider'=>$openingDatas,
	// 'filter'=>$model,
...
$('form').submit(function(){
	$('#openingDatas-transaction-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
