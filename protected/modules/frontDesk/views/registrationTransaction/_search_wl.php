...
<div class="wide form" style="border-bottom: 1px solid #CCC">
    ...
    <?php $form = $this->beginWidget('CActiveForm', array(
        ...
        'method' => 'get',
        // 'htmlOptions'=>array('name'=>'RegistrationTransaction'),
    )); ?>
    <div class="row">
        <div class="small-12 medium-6 columns">
            ...
            <div class="field">
                <div class="row collapse">
                    ...
                    <div class="small-8 columns">
                        <input size="18" maxlength="18"
                               value="<?= !empty($_GET['RegistrationTransaction']['customer_name']) ? $_GET['RegistrationTransaction']['customer_name'] : '' ?>"
                               id="RegistrationTransaction_customer_name" name="RegistrationTransaction[customer_name]"
                               type="text" onclick="jQuery('#customer-dialog').dialog('open'); return false;">
                    </div>
                </div>
            </div>
                ...
                <div class="row collapse">
                    ...
                    <div class="small-8 columns">
                        <select name="RegistrationTransaction[customer_type]">
                            ...
                            <option value="Individual" <?= empty($_GET['RegistrationTransaction']['customer_type']) ? '' : ($_GET['RegistrationTransaction']['customer_type'] == 'Individual') ? 'selected' : ''; ?>>
                                Individual
                            </option>
                            <option value="Company" <?= empty($_GET['RegistrationTransaction']['customer_type']) ? '' : ($_GET['RegistrationTransaction']['customer_type'] == 'Company') ? 'selected' : ''; ?>>
                                Company
                            </option>
                        </select>
                    </div>
            ...
            <div class="field">
                <div class="row collapse">
                    ...
                    <div class="small-8 columns">
                        <?php echo CHtml::dropDownList('RegistrationTransaction[branch_id]', '',
                    ...
                    <div class="row collapse">
                        ...
                        <div class="small-8 columns">
                            <select name="RegistrationTransaction[repair_type]">
                                ...
                                <option value="GR" <?= empty($_GET['RegistrationTransaction']['repair_type']) ? '' : ($_GET['RegistrationTransaction']['repair_type'] == 'GR') ? 'selected' : ''; ?>>
                                    General Repair
                                </option>
                                <option value="BR" <?= empty($_GET['RegistrationTransaction']['repair_type']) ? '' : ($_GET['RegistrationTransaction']['repair_type'] == 'BR') ? 'selected' : ''; ?>>
                                    Body Repair
                                </option>
                            </select>
                        </div>
