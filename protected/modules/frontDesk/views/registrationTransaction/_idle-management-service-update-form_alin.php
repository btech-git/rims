	...
	<div class="row">
		<div class="small-12 medium-6 columns">
			...
			<div class="field">
				<div class="row collapse">
					<div class="small-4 columns">
						<label class="prefix"><?php echo $form->labelEx($registrationService->header->service,'name'); ?></label>
					</div>
					<div class="small-8 columns">
			...
			<div class="field">
				<div class="row collapse">
					<div class="small-4 columns">
						<label class="prefix"><?php echo $form->labelEx($registrationService->header->service->serviceCategory,'name'); ?></label>
					</div>
					<div class="small-8 columns">
