	...
	<div class="clearfix page-action">
		...
		<div>
			<?php
				...
				$damage = "";
				/*
        		foreach ($registration->registrationServices as $rs) {
            		$duration += $rs->service->flat_rate_hour;
            	}*/
		...
		<div class="grid-view">
			<?php $this->widget('zii.widgets.grid.CGridView', array(
				...
				'columns'=>array(
                    ...
                    'resume',
                    'pause_time',
                    array('name'=>'total_time', 'value'=>'$data->total_time', 'footer'=>' ' . $registrationService->getTotal($_GET["registrationId"])),
                    array(
                    ...
                    array(
						...
						(
							...
							(
								'label'=>'Pause',
								'url'=>'Yii::app()->createUrl("frontDesk/registrationTransaction/idleManagementPauseService", array("serviceId"=>$data->service_id,"registrationId"=>'.$_GET["registrationId"].'))',
							...
							(
								'label'=>'Resume',
								'url'=>'Yii::app()->createUrl("frontDesk/registrationTransaction/idleManagementResumeService", array("serviceId"=>$data->service_id,"registrationId"=>'.$_GET["registrationId"].'))',
							...
							(
								...
								'visible'=>'($data->start!=NULL and $data->start!="0000-00-00 00:00:00") and $data->resume >= $data->pause'
							),
						),
					),
					array(
						...
						(
							...
							(
								'label'=>'View',
								'url'=>'Yii::app()->createUrl("frontDesk/registrationTransaction/idleManagementServiceView", array("registrationServiceId"=>$data->id,"serviceId"=>$data->service_id,"registrationId"=>'.$_GET["registrationId"].'))',
							),
							'update' => array
							(
								'label'=>'Update',
								'url'=>'Yii::app()->createUrl("frontDesk/registrationTransaction/idleManagementServiceUpdate", array("registrationServiceId"=>$data->id,"serviceId"=>$data->service_id,"registrationId"=>'.$_GET["registrationId"].'))',
							),
						),
					),
				),
