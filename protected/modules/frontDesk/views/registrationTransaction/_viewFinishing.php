<?php $this->renderPartial('_search_finishing'); ?>

<?php $this->widget('ext.groupgridview.GroupGridView', array(
	'id'=>'finishingDatas-transaction-grid',
	'dataProvider'=>$finishingDatas,
	// 'filter'=>$model,
...
$('form').submit(function(){
	$('#finishingDatas-transaction-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
