...
<?php //$model = RegistrationTransaction::model()->findByPk($model->registration_transaction_id); ?>
	...
	<fieldset >
		...
		<div class="row">
			...
			<div class="large-4 columns">
				...
				<div class="small-8 columns">
					<?php echo $form->dropDownlist($payment,'branch_id',CHtml::listData(Branch::model()->findAll(),'id','name'),array('prompt'=>'[--Select Branch--]',
	...
	<div class="row">
		...
		<div class="large-4 columns">
			...
			<div class="small-8 columns">
				<?php echo CHtml::submitButton('PAY', array('class'=>'button cbutton')); ?>
			</div>
		</div>
	</div>
