...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	'method'=>'get',
	'htmlOptions'=>array('id'=>'washingForm'),
)); ?>
<div class="row">
	...
	<div class="field">
		<div class="row collapse">
			...
			<div class="small-8 columns">
				<input size="18" maxlength="18" value="<?= !empty($_GET['RegistrationTransaction']['customer_name'])?$_GET['RegistrationTransaction']['customer_name']:''?>" id="RegistrationTransaction_customer_name_washing" name="RegistrationTransaction[customer_name]" type="text" onclick="jQuery('#customer-dialog').dialog('open'); return false;">
				<input type="hidden" name="RegistrationTransaction[tab_type]" value="4" id="tab_type">
			</div>
		</div>
	</div>	
	...
	<div class="buttons text-right">
		<?php echo CHtml::submitButton('Search', 
			array( 
				...
				'id'=>'washingBtn',
				'onclick'=>'$("#washingDatas-transaction-grid").yiiGridView("update", {
						data: $("#washingForm").serialize()
					});
					return false;'
				)
		); ?>
