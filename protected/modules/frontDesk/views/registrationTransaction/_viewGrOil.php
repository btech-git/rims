<?php $this->renderPartial('_search_grOil'); ?>

<?php $this->widget('ext.groupgridview.GroupGridView', array(
	'id'=>'grOilDatas-transaction-grid',
	'dataProvider'=>$grOilDatas,
	// 'filter'=>$model,
...
$('form').submit(function(){
	$('#grOilDatas-transaction-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
