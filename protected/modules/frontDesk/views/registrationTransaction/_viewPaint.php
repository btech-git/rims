<?php $this->renderPartial('_search_paint'); ?>

<?php $this->widget('ext.groupgridview.GroupGridView', array(
	'id'=>'paintDatas-transaction-grid',
	'dataProvider'=>$paintDatas,
	// 'filter'=>$model,
...
$('form').submit(function(){
	$('#paintDatas-transaction-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
