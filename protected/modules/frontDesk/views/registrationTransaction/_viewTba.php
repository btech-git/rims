<?php $this->renderPartial('_search_tba'); ?>

<?php $this->widget('ext.groupgridview.GroupGridView', array(
	'id'=>'tbaDatas-transaction-grid',
	'dataProvider'=>$tbaDatas,
	// 'filter'=>$model,
...
$('form').submit(function(){
	$('#tbaDatas-transaction-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
