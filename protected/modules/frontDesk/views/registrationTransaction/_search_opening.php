...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	'method'=>'get',
	'htmlOptions'=>array('id'=>'openingForm'),
)); ?>
<div class="row">
	...
	<div class="field">
		<div class="row collapse">
			...
			<div class="small-8 columns">
				<input size="18" maxlength="18" value="<?= !empty($_GET['RegistrationTransaction']['customer_name'])?$_GET['RegistrationTransaction']['customer_name']:''?>" id="RegistrationTransaction_customer_name_opening" name="RegistrationTransaction[customer_name]" type="text" onclick="jQuery('#customer-dialog').dialog('open'); return false;">
				<input type="hidden" name="RegistrationTransaction[tab_type]" value="5" id="tab_type">
			</div>
		</div>
	</div>	
	...
	<div class="buttons text-right">
		<?php echo CHtml::submitButton('Search', 
			array( 
				...
				'id'=>'openingBtn',
				'onclick'=>'$("#openingDatas-transaction-grid").yiiGridView("update", {
