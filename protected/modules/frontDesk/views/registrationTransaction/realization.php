...
<?php if ($head->repair_type == 'GR'): ?>
    <a class="button cbutton right" style="margin-right:10px;" href="<?php echo Yii::app()->createUrl('/frontDesk/generalRepairRegistration/admin');?>"><span class="fa fa-th-list"></span>Manage Registration Transaction</a>
    <a class="button cbutton right" style="margin-right:10px;" href="<?php echo Yii::app()->createUrl('/frontDesk/generalRepairRegistration/view',array('id'=>$head->id));?>">Back</a>
<?php else: ?>
    <a class="button cbutton right" style="margin-right:10px;" href="<?php echo Yii::app()->baseUrl.'/frontDesk/bodyRepairRegistration/admin';?>"><span class="fa fa-th-list"></span>Manage Registration Transaction</a>
    <a class="button cbutton right" style="margin-right:10px;" href="<?php echo Yii::app()->createUrl('/frontDesk/bodyRepairRegistration/view',array('id'=>$head->id));?>">Back</a>
<?php endif; ?>
