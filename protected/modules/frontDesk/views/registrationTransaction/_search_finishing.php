...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	'method'=>'get',
	'htmlOptions'=>array('id'=>'finishingForm'),
)); ?>
<div class="row">
	...
	<div class="field">
		<div class="row collapse">
			...
			<div class="small-8 columns">
				<input size="18" maxlength="18" value="<?= !empty($_GET['RegistrationTransaction']['customer_name'])?$_GET['RegistrationTransaction']['customer_name']:''?>" id="RegistrationTransaction_customer_name_finishing" name="RegistrationTransaction[customer_name]" type="text" onclick="jQuery('#customer-dialog').dialog('open'); return false;">
				<input type="hidden" name="RegistrationTransaction[tab_type]" value="2" id="tab_type">
			</div>
		</div>
	</div>	
				...
				<div class="row">
						<div class="medium-6 columns">
							...
							$this->widget('zii.widgets.jui.CJuiDatePicker',array(
							    ...
							    'htmlOptions'=>array(
							    	'id'=>'finishing_transaction_date_0',
						...
						<div class="medium-6 columns">
							...
							$this->widget('zii.widgets.jui.CJuiDatePicker',array(
							    ...
							    'htmlOptions'=>array(
							    	'id'=>'finishing_transaction_date_1',
	...
	<div class="buttons text-right">
		<?php echo CHtml::submitButton('Search', 
			array( 
				...
				'id'=>'finishingBtn',
				'onclick'=>'$("#finishingDatas-transaction-grid").yiiGridView("update", {
						data: $("#finishingForm").serialize()
					});
					return false;'
				)
		); ?>
