...
<div style="font-weight: bold; text-align: center">
    ...
    <div style="font-size: larger">RG Outstanding (Pending invoice + WO + SL)</div>
...
<table class="report">
    ...
    <tbody>
        <?php foreach ($registrationPendingSummary->dataProvider->data as $header): ?>
            <tr class="items1">
                ...
                <th class="width1-3">
                    <?php echo CHtml::encode(Yii::app()->dateFormatter->format("d MMM yyyy", CHtml::value($header, 'transaction_date'))); ?>
                </th>
                <th class="width1-4">
                ...
                <th class="width1-6">
                    <?php echo CHtml::link($header->work_order_number, array(
                        "/frontDesk/registrationTransaction/view", 
                        "id"=>$header->id
                    ), array('target' => '_blank')); ?>
                </th>
                <th class="width1-7"><?php echo CHtml::encode(CHtml::value($header, 'sales_order_date')); ?></th>
                ...
                <th class="width1-9"><?php echo CHtml::encode($header->getProducts()); ?></th>
