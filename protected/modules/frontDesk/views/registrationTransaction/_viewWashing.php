<?php $this->renderPartial('_search_washing'); ?>

<?php $this->widget('ext.groupgridview.GroupGridView', array(
	'id'=>'washingDatas-transaction-grid',
	'dataProvider'=>$washingDatas,
	// 'filter'=>$model,
...
$('#washingBtn').click(function(){
	alert('S');
	$('#washingDatas-transaction-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
