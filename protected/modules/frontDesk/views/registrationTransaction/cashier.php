                ...
                'columns' => array(
                    ...
                    array(
                        ...
                        'buttons' => array(
                            ...
                            'print' => array(
                                'label' => 'print',
                                'url' => '$data->status == "PAID" ? Yii::app()->createUrl("frontDesk/registrationTransaction/pdfPayment", array("id" => $data->id, "target" => "_blank")) : Yii::app()->createUrl("frontDesk/registrationTransaction/pdf", array("id" => $data->id, "target" => "_blank"))',
