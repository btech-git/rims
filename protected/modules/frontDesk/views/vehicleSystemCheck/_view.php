...
/* @var $data StockAdjustmentHeader */
?>
...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('stock_adjustment_number')); ?>:</b>
	<?php echo CHtml::encode($data->stock_adjustment_number); ?>
	<br />
