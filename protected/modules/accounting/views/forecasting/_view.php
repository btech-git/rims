...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('type_forecasting')); ?>:</b>
	<?php echo CHtml::encode($data->type_forecasting); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('realization_date')); ?>:</b>
	<?php echo CHtml::encode($data->realization_date); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('realization_balance')); ?>:</b>
	<?php echo CHtml::encode($data->realization_balance); ?>
	<br />
