...
<table style="border: 1px solid">
    ...
    <?php if (!empty($workOrderExpense->header->registrationTransaction)): ?>
        <tbody>
            <?php foreach ($workOrderExpense->header->registrationTransaction->registrationServices as $i => $detail): ?>
                <tr>
                    <td><?php echo $i + 1; ?></td>
