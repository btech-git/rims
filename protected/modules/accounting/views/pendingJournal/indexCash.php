...
<div style="text-align: center; text-decoration: underline">
    <h2><?php echo 'Pending Journal Cash Transaction'; ?></h2>
    <br />
</div>
            ...
            <div class="field">
                <div class="row collapse">
                    <div class="small-6 columns">
                        <span class="prefix">Cash Transaction # </span>
                    </div>
                    <div class="small-6 columns">
...
<div>
    ...
    <?php $this->widget('zii.widgets.grid.CGridView', array(
        ...
        'columns' => array(
            ...
            array( 
                ...
                'value' => 'CHtml::link($data->transaction_number, array("/transaction/cashTransaction/view", "id"=>$data->id), array("target" => "blank"))', 
                'type' => 'raw'
            ),
            'transaction_date',
            array(
    ...
    <?php echo CHtml::ajaxSubmitButton('Posting All', CController::createUrl('ajaxHtmlPostingJournalCash'), array(
        'type' => 'POST',
