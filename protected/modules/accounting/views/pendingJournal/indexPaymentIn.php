            ...
            <div class="field">
                <div class="row collapse">
                    <div class="small-6 columns">
                        <span class="prefix">Payment In # </span>
                    </div>
                    <div class="small-6 columns">
...
<div>
    ...
    <?php $this->widget('zii.widgets.grid.CGridView', array(
        ...
        'columns' => array(
            ...
            array( 
                'name' => 'payment_number', 
                'value' => 'CHtml::link($data->payment_number, array("/transaction/paymentIn/view", "id"=>$data->id), array("target" => "blank"))', 
                'type' => 'raw'
            ),
            'payment_date',
            array(
    ...
    <?php echo CHtml::ajaxSubmitButton('Posting All', CController::createUrl('ajaxHtmlPostingJournalPaymentIn'), array(
        'type' => 'POST',
