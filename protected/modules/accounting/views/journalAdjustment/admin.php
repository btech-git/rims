    ...
    <div class="row">
        <div class="small-12 columns">
            <div class="clearfix page-action">
                <?php echo CHtml::link('<span class="fa fa-plus"></span>New Jurnal Penyesuaian', Yii::app()->baseUrl . '/accounting/journalAdjustment/create', array('class' => 'button success right', 'visible' => Yii::app()->user->checkAccess("accounting.cashTransaction.create"))) ?>
