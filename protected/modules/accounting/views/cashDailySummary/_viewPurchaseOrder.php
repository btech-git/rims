<table>
    ...
    <tbody>
        <?php $grandTotal = 0.00; ?>
        <?php foreach ($purchaseOrderDataProvider->data as $header): ?>
            ...
            <tr>
                ...
                <td>
                    <?php echo CHtml::encode(CHtml::value($header, 'mainBranch.name')); ?>
                </td>
                <td style="text-align: right">
                    <?php echo CHtml::encode(CHtml::value($header, 'supplier.name')); ?>
                </td>
                <td style="text-align: right">
