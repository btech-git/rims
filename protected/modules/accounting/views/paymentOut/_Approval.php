	...
	<div class="row">
		...
		<div class="field">
				<div class="row collapse">
					<div class="small-4 columns">
					  <label class="prefix">Payment Out No</label>
				  </div>
					<div class="small-8 columns">
					<?php echo $form->textField($paymentOut, 'payment_number', array('value'=>$paymentOut->payment_number,'readonly'=>true)); ?>
		 ...
		 <div class="field">
				<div class="row collapse">
					...
					<div class="small-8 columns">
						<?php echo $form->textField($paymentOut, 'payment_date', array('value'=>$paymentOut->payment_date,'readonly'=>true)); ?>
		 	...
		 	<div class="field">
				<div class="row collapse">
					...
					<div class="small-8 columns">
						<?php echo $form->textField($paymentOut, 'payment_amount', array('value'=>$paymentOut->payment_amount,'readonly'=>true)); ?>
		 ...
		 <div class="field">
				<div class="row collapse">
					...
					<div class="small-8 columns">
						<?php echo $form->textField($paymentOut, 'status', array('value'=>$paymentOut->status,'readonly'=>true)); ?>
					</div>
				</div>
		 	</div>
		 <hr />
        ...
        <div class="field">
            <table>
                ...
                <tr>
                    <td>
                        <?php echo $form->hiddenField($model, 'payment_out_id',array('value'=>$paymentOut->id)); ?>		
                    ...
                    <td>
                        <?php $revisions = PaymentOutApproval::model()->findAllByAttributes(array('payment_out_id'=>$paymentOut->id)); ?>
