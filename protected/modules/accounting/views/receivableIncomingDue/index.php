        ...
        <div id="detail_div">
                ...
                <div class="row">
                    <div class="medium-6 columns">
                        ...
                        <div class="field">
                            <div class="row collapse">
                                <div class="small-4 columns">
                                    <span class="prefix">TOP (hari)</span>
                                </div>
                                <div class="small-8 columns">
                                    <?php echo CHtml::dropDownList('CustomerPaymentTerm', $customerPaymentTerm, array(
                                        15 => 15,
                                        30 => 30,
                                        45 => 45,
                                        60 => 60,
            ...
            <div class="relative">
                <div class="reportDisplay">
                    <?php echo 'Displaying ' . count($receivableIncomingDueDate) . ' result(s).'; ?>
                </div>
