...
<?php for ($i = 0; $i < $numberOfCopies; $i++): ?>
    <div class="page" style="<?php if ($i > 0 || $j > 0): ?>page-break-before: always;<?php endif; ?><?php if ($i > 0): ?>background-image: url('<?php echo Yii::app()->baseUrl; ?>/images/copy-text.jpg')<?php else: ?>background-image: url('<?php echo Yii::app()->baseUrl; ?>/images/rap-logo.png')<?php endif; ?>">
        <div class="container">
            ...
            <div class="body-memo">
                <table>
                    <tr>
                        <td>INVOICE #</td>
                        <td>:</td>
                        <td><?php echo CHtml::encode(CHtml::value($saleInvoice, 'transaction_number')); ?></td>
                        <td>CUSTOMER</td>
                        <td>:</td>
                    ...
                    <tr>
                        <td>TGL INVOICE</td>
                        <td>:</td>
                        <td><?php echo tanggal(CHtml::encode(CHtml::value($saleInvoice, 'transaction_date'))); ?></td>
                        <td>NO. POLISI</td>
                        <td>:</td>
                    ...
                    <tr>
                        <td>ASURANSI</td>
                        <td>:</td>
                        <td><?php echo CHtml::encode(CHtml::value($saleInvoice, 'insuranceCompany.name')); ?></td>
                        <td>KENDARAAN</td>
                        <td>:</td>
                        <td>
            ...
            <div class="purchase-order">
                <?php if (count($registrationProducts) > 0) : ?>
                    <table>
                        ...
                        <?php foreach ($registrationProducts as $i => $detail): ?>
                            <tr class="isi">
            ...
            <div class="purchase-order">
                <?php if (count($registrationServices) > 1) : ?>
                    <table>
                        <tr>
                        ...
                        <?php foreach ($registrationServices as $i => $detail): ?>
                            <tr class="isi">
                                <td class="noo"><?php echo ++$i; ?></td>
