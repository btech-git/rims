            ...
            <?php $this->widget('zii.widgets.grid.CGridView', array(
                ...
                'columns'=>array(
                    ...
                    array(
                        ...
                        'value' => 'CHtml::link($data->work_order_number, array("/frontEnd/generalRepair/view", "id"=>$data->id), array("target" => "blank"))', 
                        'type' => 'raw'
                    ),
                    'work_order_date',
                    array(
                    ...
                    array(
                        'header' => 'Invoice #', 
                        'value' => 'empty($data->invoiceHeaders) ? "" : CHtml::link($data->invoiceHeaders[0]->invoice_number, array("/frontEnd/cashier/view", "id"=>$data->invoiceHeaders[0]->id), array("target" => "blank"))', 
                        'type' => 'raw'
                    ),
                    array(
                        'header'=>'User',
