    ...
    <div class="clearfix page-action">
        ...
        <?php $this->widget('ext.groupgridview.GroupGridView', array(
            ...
            'columns' => array(
                ...
                array(
                    'header' => 'Registration #',
                    'value' => 'CHtml::link($data->transaction_number, array("/frontEnd/generalRepair/view", "id"=>$data->id))', 
                    'type' => 'raw'
                ),
                array(
                    'name' => 'work_order_number', 
                    'value' => 'CHtml::link($data->work_order_number, array("/frontEnd/generalRepair/view", "id"=>$data->id))', 
                    'type' => 'raw'
                ),
                array(
                    'header' => 'Tanggal',
                ...
                array(
                    ...
                    'value' => function($data) {
                        ...
                        foreach ($inspectionModel as $inspection) {
                            ...
                            $html .= '
                                <tr>
                                    <td>' . CHtml::link($inspection->inspection->name, array("/frontEnd/vehicleInspection/view", "id"=>$inspection->id), array("target" => "_blank")) . '</td>
                ...
                array(
                    ...
                    'buttons' => array(
                        'inspection' => array(
                            'label' => 'inspection',
                            'url' => 'Yii::app()->createUrl("frontEnd/vehicleInspection/create", array("vehicleId" => $data->vehicle_id, "wonumber" => $data->work_order_number))',
