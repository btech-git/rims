                    ...
                    <div class="row">
                        <div class="medium-12 columns">
                            ...
                            <table>
                                ...
                                <tbody>
                                    <tr>
                                        <td><?php echo CHtml::encode(CHtml::value($bodyRepair->header, 'transaction_number')); ?></td>
                                        <td><?php echo CHtml::encode(CHtml::value($bodyRepair->header, 'transaction_date')); ?></td>
                                        <td><?php echo CHtml::encode(CHtml::value($bodyRepair->header, 'repair_type')); ?></td>
                                        <td><?php echo CHtml::encode(CHtml::value($bodyRepair->header, 'vehicle_mileage')); ?></td>
                                        <td><?php echo CHtml::encode(CHtml::value($bodyRepair->header, 'branch.name')); ?></td>
                                        <td><?php echo CHtml::encode(CHtml::value($bodyRepair->header, 'user.username')); ?></td>
                                        <td>
                                            <?php echo $form->dropDownList($bodyRepair->header, 'ppn', array(
                                                '3' => 'Include PPN',
                                                '1' => 'Add PPN', 
                                                '2' => 'Non PPN',
                                            ), array(
                                                ...
                                                'onchange' => CHtml::ajax(array(
                                                    'type' => 'POST',
                                                    'dataType' => 'JSON',
                                                    'url' => CController::createUrl('ajaxJsonGrandTotal', array('id' => $bodyRepair->header->id)),
                                            ...
                                            <?php echo CHtml::activeDropDownList($bodyRepair->header, 'tax_percentage', array(
                                                0 => 0,
                                                10 => 10,
                                                11 => 11,
                                            ), array(
                                        ...
                                        <?php if($bodyRepair->header->work_order_number != ""): ?>
                                            <td><?php echo CHtml::encode(CHtml::value($bodyRepair->header, 'work_order_number')); ?></td>
                                        <?php endif; ?>
                                    </tr>
                                </tbody>
                            </table>
                                ...
                                <div class="medium-12 columns">
                                    ...
                                    <div class="detail">
                                        <div class="field" id="service">
                                            <div class="row collapse">
                                                <div class="small-12 columns">
                                                    <?php $this->renderPartial('_detailService', array('bodyRepair'=>$bodyRepair)); ?>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                <div class="field">
                                    <table>
                                        <tr>
                                            <td><?php echo $form->labelEx($bodyRepair->header,'total_service'); ?></td>
                                            <td style="text-align: right">
                                                <?php echo $form->hiddenField($bodyRepair->header,'total_service', array('readonly'=>true)); ?>
                                                <span id="total_quantity_service">
                                                    <?php echo CHtml::encode(Yii::app()->numberFormatter->format("#,##0.00", CHtml::value($bodyRepair->header,'total_service'))); ?>
                                                </span>
                                                <?php echo $form->error($bodyRepair->header,'total_service'); ?>
                                            </td>
                                            <td><?php echo $form->labelEx($bodyRepair->header,'subtotal_service'); ?></td>
                                            <td style="text-align: right">
                                                <?php echo $form->hiddenField($bodyRepair->header,'subtotal_service',array('size'=>18,'maxlength'=>18,'readonly'=>true,)); ?>
                                                <span id="sub_total_service">
                                                    <?php echo CHtml::encode(Yii::app()->numberFormatter->format("#,##0.00", CHtml::value($bodyRepair->header,'subtotal_service'))); ?>
                                                </span>
                                                <?php echo $form->error($bodyRepair->header,'subtotal_service'); ?>
                                            </td>
                                            <td><?php echo $form->labelEx($bodyRepair->header,'discount_service'); ?></td>
                                            <td style="text-align: right">
                                                <?php echo $form->hiddenField($bodyRepair->header,'discount_service',array('size'=>18,'maxlength'=>18,'readonly'=>true,)); ?>
                                                <span id="total_discount_service">
                                                    <?php echo CHtml::encode(Yii::app()->numberFormatter->format("#,##0.00", CHtml::value($bodyRepair->header,'discount_service'))); ?>
                                                </span>
                                                <?php echo $form->error($bodyRepair->header,'discount_service'); ?>
                                            </td>
                                            <td><?php echo $form->labelEx($bodyRepair->header,'total_service_price'); ?></td>
                                            <td style="text-align: right">
                                                <?php echo $form->hiddenField($bodyRepair->header,'total_service_price',array('size'=>18,'maxlength'=>18,'readonly'=>true,)); ?>
                                                <span id="grand_total_service">
                                                    <?php echo CHtml::encode(Yii::app()->numberFormatter->format("#,##0.00", CHtml::value($bodyRepair->header,'total_service_price'))); ?>
                                                </span>
                                                <?php echo $form->error($bodyRepair->header,'total_service_price'); ?>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><?php echo $form->labelEx($bodyRepair->header,'total_product'); ?></td>
                                            <td style="text-align: right">
                                                <?php echo $form->hiddenField($bodyRepair->header,'total_product',array('size'=>10,'maxlength'=>10,'readonly'=>true)); ?>
                                                <span id="total_quantity_product">
                                                    <?php echo CHtml::encode(Yii::app()->numberFormatter->format("#,##0.00", CHtml::value($bodyRepair->header,'total_product'))); ?>
                                                </span>
                                                <?php echo $form->error($bodyRepair->header,'total_product'); ?>
                                            </td>
                                            <td><?php echo $form->labelEx($bodyRepair->header,'subtotal_product'); ?></td>
                                            <td style="text-align: right">
                                                <?php echo $form->hiddenField($bodyRepair->header,'subtotal_product',array('size'=>18,'maxlength'=>18,'readonly'=>true,)); ?>
                                                <span id="sub_total_product">
                                                    <?php echo CHtml::encode(Yii::app()->numberFormatter->format("#,##0.00", CHtml::value($bodyRepair->header,'subtotal_product'))); ?>
                                                </span>
                                                <?php echo $form->error($bodyRepair->header,'subtotal_product'); ?>
                                            </td>
                                            <td><?php echo $form->labelEx($bodyRepair->header,'discount_product'); ?></td>
                                            <td style="text-align: right">
                                                <?php echo $form->hiddenField($bodyRepair->header,'discount_product',array('size'=>18,'maxlength'=>18,'readonly'=>true,'class'=>'numbers')); ?>
                                                <span id="total_discount_product">
                                                    <?php echo CHtml::encode(Yii::app()->numberFormatter->format("#,##0.00", CHtml::value($bodyRepair->header,'discount_product'))); ?>
                                                </span>
                                                <?php echo $form->error($bodyRepair->header,'discount_product'); ?>
                                            </td>
                                            <td><?php echo $form->labelEx($bodyRepair->header,'total_product_price'); ?></td>
                                            <td style="text-align: right">
                                                <?php echo $form->hiddenField($bodyRepair->header,'total_product_price',array('size'=>18,'maxlength'=>18,'readonly'=>true,)); ?>
                                                <span id="grand_total_product">
                                                    <?php echo CHtml::encode(Yii::app()->numberFormatter->format("#,##0.00", CHtml::value($bodyRepair->header,'total_product_price'))); ?>
                                                </span>
                                                <?php echo $form->error($bodyRepair->header,'total_product_price'); ?>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="font-weight: bold"><?php echo $form->labelEx($bodyRepair->header,'subtotal'); ?></td>
                                            <td style="text-align: right; font-weight: bold">
                                                <?php echo $form->hiddenField($bodyRepair->header,'subtotal',array('size'=>18,'maxlength'=>18,'readonly'=>true,)); ?>
                                                <span id="sub_total_transaction">
                                                    <?php echo CHtml::encode(Yii::app()->numberFormatter->format("#,##0.00", CHtml::value($bodyRepair->header,'subtotal'))); ?>
                                                </span>
                                                <?php echo $form->error($bodyRepair->header,'subtotal'); ?>
                                            </td>
                                            <td style="font-weight: bold"><?php echo $form->labelEx($bodyRepair->header,'ppn_price'); ?></td>
                                            <td style="text-align: right; font-weight: bold">
                                                <?php echo $form->hiddenField($bodyRepair->header,'ppn_price',array('readonly'=>true,)); ?>
                                                <span id="tax_item_amount">
                                                    <?php echo CHtml::encode(Yii::app()->numberFormatter->format("#,##0.00", CHtml::value($bodyRepair->header,'ppn_price'))); ?>
                                                </span>
                                                <?php echo $form->error($bodyRepair->header,'ppn_price'); ?>
                                            </td>
                                            <td style="font-weight: bold"><?php //echo $form->labelEx($bodyRepair->header,'pph_price'); ?></td>
                                            <td style="text-align: right; font-weight: bold">
                                                <?php //echo $form->hiddenField($bodyRepair->header,'pph_price',array('size'=>18,'maxlength'=>18,'readonly'=>true,)); ?>
                                                <span id="tax_service_amount">
                                                    <?php //echo CHtml::encode(Yii::app()->numberFormatter->format("#,##0.00", CHtml::value($bodyRepair->header,'pph_price'))); ?>
                                                </span>
                                                <?php //echo $form->error($bodyRepair->header,'pph_price'); ?>
                                            </td>
                                            <td style="font-weight: bold"><?php echo $form->labelEx($bodyRepair->header,'grand_total'); ?></td>
                                            <td style="text-align: right; font-weight: bold">
                                                <?php echo $form->hiddenField($bodyRepair->header,'grand_total',array('size'=>18,'maxlength'=>18,'readonly'=>true)); ?>
                                                <span id="grand_total_transaction">
                                                    <?php echo CHtml::encode(Yii::app()->numberFormatter->format("#,##0.00", CHtml::value($bodyRepair->header,'grand_total'))); ?>
                                                </span>
                                                <?php echo $form->error($bodyRepair->header,'grand_total'); ?>
                                            </td>
                                        </tr>
                                    </table>
                                </div>
        ...
        <?php $this->widget('zii.widgets.grid.CGridView', array(
            ...
            'selectionChanged'=>'js:function(id){
                ...
                $.ajax({
                    type: "POST",
                    //dataType: "JSON",
                    url: "' . CController::createUrl('ajaxHtmlAddProductDetail', array('id'=>$bodyRepair->header->id,'productId'=>'')). '" + $.fn.yiiGridView.getSelection(id),
                    data:$("form").serialize(),
                    success: function(html) {
                        $("#product").html(html);
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
    ...
    'selectionChanged'=>'js:function(id){
        ...
        $.ajax({
            type: "POST",
            //dataType: "JSON",
            url: "' . CController::createUrl('ajaxHtmlAddDamageDetail', array('id'=> $bodyRepair->header->id,'serviceId'=>'')).'" + $.fn.yiiGridView.getSelection(id),
            data:$("form").serialize(),
            success: function(html) {
                $("#damage").html(html);
            },
