<?php if (count($bodyRepair->productDetails) > 0): ?>
    <table>
        <thead>
            <tr>
                <th>Product name</th>
        ...
        <tbody>
            <?php foreach ($bodyRepair->productDetails as $i => $productDetail): ?>
                    ...
                    <td>
                        ...
                        echo CHtml::activeTextField($productDetail, "[$i]quantity", array(
                            'onchange' => CHtml::ajax(array(
                                'type' => 'POST',
                                'dataType' => 'JSON',
                                'url' => CController::createUrl('ajaxJsonTotalProduct', array('id' => $bodyRepair->header->id, 'index' => $i)),
        ...
        echo CHtml::button('X', array(
            'onclick' => CHtml::ajax(array(
                'type' => 'POST',
                'url' => CController::createUrl('ajaxHtmlRemoveProductDetail', array('id' => $bodyRepair->header->id, 'index' => $i)),
                'update' => '#product',
            )),
        ));
        ?>
