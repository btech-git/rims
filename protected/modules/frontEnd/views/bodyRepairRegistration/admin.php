...
<div id="maincontent">
    <div class="clearfix page-action">
        <?php echo CHtml::link('<span class="fa fa-plus"></span>New Registration', Yii::app()->baseUrl . '/frontEnd/customerRegistration/vehicleList', array('class' => 'button success right', 'visible' => Yii::app()->user->checkAccess("frontEnd.bodyRepairRegistration.admin"))); ?>
        ...
        'columns' => array(
            ...
            array(
                ...
                'buttons' => array(
                    'views' => array(
                        'label' => 'view',
                        'url' => 'Yii::app()->createUrl("frontEnd/bodyRepairRegistration/view", array("id"=>$data->id))',
                        'visible' => 'Yii::app()->user->checkAccess("bodyRepairCreate") || Yii::app()->user->checkAccess("bodyRepairEdit")',
                    ),
                    'edit' => array(
                        'label' => 'edit',
                        'url' => 'Yii::app()->createUrl("frontEnd/bodyRepairRegistration/update", array("id"=>$data->id))',
