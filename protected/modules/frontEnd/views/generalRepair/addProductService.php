                            ...
                            <table>
                                <thead>
                                    <tr>
                                        ...
                                        <th>PPn</th>
                                        <!--<th>PPh</th>-->
                                        <?php if($generalRepair->header->work_order_number != ""): ?>
                                            <th>WO #</th>
                                        <?php endif; ?>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        <td><?php echo CHtml::encode(CHtml::value($generalRepair->header, 'transaction_number')); ?></td>
                                        <td><?php echo CHtml::encode(CHtml::value($generalRepair->header, 'transaction_date')); ?></td>
                                        <td><?php echo CHtml::encode(CHtml::value($generalRepair->header, 'repair_type')); ?></td>
                                        <td><?php echo CHtml::encode(CHtml::value($generalRepair->header, 'vehicle_mileage')); ?></td>
                                        <td><?php echo CHtml::encode(CHtml::value($generalRepair->header, 'branch.name')); ?></td>
                                        <td><?php echo CHtml::encode(CHtml::value($generalRepair->header, 'user.username')); ?></td>
                                        <td>
                                            <?php echo $form->dropDownList($generalRepair->header, 'ppn', array(
                                                '3' => 'Include PPN',
                                                '1' => 'Add PPN', 
                                                '0' => 'Non PPN',
                                            ), array(
                                            ...
                                            <?php /*echo CHtml::activeCheckBox($generalRepair->header,'ppn', array(
                                                'onchange' => CHtml::ajax(array(
                                                    'type' => 'POST',
                                                    'dataType' => 'JSON',
                                                    'url' => CController::createUrl('ajaxJsonGrandTotal', array('id' => $generalRepair->header->id)),
                                            ...
                                            <?php echo CHtml::activeDropDownList($generalRepair->header, 'tax_percentage', array(
                                                0 => 0,
                                                10 => 10,
                                                11 => 11,
                                            ), array(
...
<!--                                        <td>
                                            <?php /*echo CHtml::activeCheckBox($generalRepair->header,'pph', array(
                                                'onchange' => CHtml::ajax(array(
                                                    'type' => 'POST',
                                                    'dataType' => 'JSON',
                                                    'url' => CController::createUrl('ajaxJsonGrandTotal', array('id' => $generalRepair->header->id)),
                                        ...
                                        <?php if ($generalRepair->header->work_order_number != ""): ?>
                                            <td><?php echo CHtml::encode(CHtml::value($generalRepair->header, 'work_order_number')); ?></td>
                                        <?php endif; ?>
                                    </tr>
                                </tbody>
                            </table>
                                        ...
                                        <div class="field">
                                            <div class="row collapse">
                                                <div class="small-4 columns">
                                                    <?php echo CHtml::activeCheckBox($generalRepair->header,'is_quick_service',array(
                                                        1 => 1,
                                                        'disabled' => $generalRepair->header->is_quick_service == 1 ? false : true, 
                                                        'onchange' => '
                                                        if($("#RegistrationTransaction_is_quick_service").is(":checked"))
                                                        {
                                                            ...
                                                            $.ajax({
                                                                type: "POST",
                                                                //dataType: "JSON",
                                                                url: "' . CController::createUrl('ajaxHtmlRemoveQuickServiceDetailAll', array('id'=> $generalRepair->header->id)).'",
                                                                data: $("form").serialize(),
                                                ...
                                                <div class="small-8 columns">
                                                    ...
                                                    <?php $this->widget('zii.widgets.grid.CGridView', array(
                                                        ...
                                                        'selectionChanged'=>'js:function(id){
                                                            ...
                                                            $.ajax({
                                                                type: "POST",
                                                                url: "' . CController::createUrl('ajaxHtmlAddQuickServiceDetail', array('id'=>$generalRepair->header->id,'quickServiceId'=>'')). '" + $.fn.yiiGridView.getSelection(id),
                                                                data: $("form").serialize(),
                                                                success: function(html) {
                                                                    $("#quickService").html(html);
                                                                    $.ajax({
                                        ...
                                        <div class="field" id="quickService">
                                            <div class="row collapse">
                                                <div class="small-12 columns">
                                                    <?php $this->renderPartial('_detailQuickService', array('generalRepair'=>$generalRepair)); ?>
                                                </div>
                                            </div>
                                        </div>
                                    </div>								
                                ...
                                <div class="medium-12 columns">
                                    ...
                                    <div class="detail">
                                        <div class="field" id="service">
                                            <div class="row collapse">
                                                <div class="small-12 columns">
                                                    <?php $this->renderPartial('_detailService', array('generalRepair'=>$generalRepair)); ?>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                <div class="field">
                                    <table>
                                        <tr>
                                            <td><?php echo $form->labelEx($generalRepair->header,'total_quickservice'); ?></td>
                                            <td style="text-align: right">
                                                <?php echo $form->hiddenField($generalRepair->header,'total_quickservice',array('readonly'=>true)); ?>
                                                <span id="total_quick_service_quantity">
                                                    <?php echo CHtml::encode(Yii::app()->numberFormatter->format("#,##0", CHtml::value($generalRepair->header,'total_quickservice'))); ?>                                                
                                                </span>
                                                <?php echo $form->error($generalRepair->header,'total_quickservice'); ?>
                                            </td>
                                            <td colspan="4">&nbsp;</td>
                                            <td><?php echo $form->labelEx($generalRepair->header,'total_quickservice_price'); ?></td>
                                            <td style="text-align: right">
                                                <?php echo $form->hiddenField($generalRepair->header,'total_quickservice_price',array('size'=>18,'maxlength'=>18,'readonly'=>true, )); ?>
                                                <span id="sub_total_quick_service">
                                                    <?php echo CHtml::encode(Yii::app()->numberFormatter->format("#,##0.00", CHtml::value($generalRepair->header,'total_quickservice_price'))); ?>
                                                </span>
                                                <?php echo $form->error($generalRepair->header,'total_quickservice_price'); ?>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><?php echo $form->labelEx($generalRepair->header,'total_service'); ?></td>
                                            <td style="text-align: right">
                                                <?php echo $form->hiddenField($generalRepair->header,'total_service', array('readonly'=>true)); ?>
                                                <span id="total_quantity_service">
                                                    <?php echo CHtml::encode(Yii::app()->numberFormatter->format("#,##0", CHtml::value($generalRepair->header,'total_service'))); ?>
                                                </span>
                                                <?php echo $form->error($generalRepair->header,'total_service'); ?>
                                            </td>
                                            <td><?php echo $form->labelEx($generalRepair->header,'subtotal_service'); ?></td>
                                            <td style="text-align: right">
                                                <?php echo $form->hiddenField($generalRepair->header,'subtotal_service',array('size'=>18,'maxlength'=>18,'readonly'=>true,)); ?>
                                                <span id="sub_total_service">
                                                    <?php echo CHtml::encode(Yii::app()->numberFormatter->format("#,##0.00", CHtml::value($generalRepair->header,'subtotal_service'))); ?>
                                                </span>
                                                <?php echo $form->error($generalRepair->header,'subtotal_service'); ?>
                                            </td>
                                            <td><?php echo $form->labelEx($generalRepair->header,'discount_service'); ?></td>
                                            <td style="text-align: right">
                                                <?php echo $form->hiddenField($generalRepair->header,'discount_service',array('size'=>18,'maxlength'=>18,'readonly'=>true,)); ?>
                                                <span id="total_discount_service">
                                                    <?php echo CHtml::encode(Yii::app()->numberFormatter->format("#,##0.00", CHtml::value($generalRepair->header,'discount_service'))); ?>
                                                </span>
                                                <?php echo $form->error($generalRepair->header,'discount_service'); ?>
                                            </td>
                                            <td><?php echo $form->labelEx($generalRepair->header,'total_service_price'); ?></td>
                                            <td style="text-align: right">
                                                <?php echo $form->hiddenField($generalRepair->header,'total_service_price',array('size'=>18,'maxlength'=>18,'readonly'=>true,)); ?>
                                                <span id="grand_total_service">
                                                    <?php echo CHtml::encode(Yii::app()->numberFormatter->format("#,##0.00", CHtml::value($generalRepair->header,'total_service_price'))); ?>
                                                </span>
                                                <?php echo $form->error($generalRepair->header,'total_service_price'); ?>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><?php echo $form->labelEx($generalRepair->header,'total_product'); ?></td>
                                            <td style="text-align: right">
                                                <?php echo $form->hiddenField($generalRepair->header,'total_product',array('size'=>10,'maxlength'=>10,'readonly'=>true)); ?>
                                                <span id="total_quantity_product">
                                                    <?php echo CHtml::encode(Yii::app()->numberFormatter->format("#,##0", CHtml::value($generalRepair->header,'total_product'))); ?>
                                                </span>
                                                <?php echo $form->error($generalRepair->header,'total_product'); ?>
                                            </td>
                                            <td><?php echo $form->labelEx($generalRepair->header,'subtotal_product'); ?></td>
                                            <td style="text-align: right">
                                                <?php echo $form->hiddenField($generalRepair->header,'subtotal_product',array('size'=>18,'maxlength'=>18,'readonly'=>true,)); ?>
                                                <span id="sub_total_product">
                                                    <?php echo CHtml::encode(Yii::app()->numberFormatter->format("#,##0.00", CHtml::value($generalRepair->header,'subtotal_product'))); ?>
                                                </span>
                                                <?php echo $form->error($generalRepair->header,'subtotal_product'); ?>
                                            </td>
                                            <td><?php echo $form->labelEx($generalRepair->header,'discount_product'); ?></td>
                                            <td style="text-align: right">
                                                <?php echo $form->hiddenField($generalRepair->header,'discount_product',array('size'=>18,'maxlength'=>18,'readonly'=>true,'class'=>'numbers')); ?>
                                                <span id="total_discount_product">
                                                    <?php echo CHtml::encode(Yii::app()->numberFormatter->format("#,##0.00", CHtml::value($generalRepair->header,'discount_product'))); ?>
                                                </span>
                                                <?php echo $form->error($generalRepair->header,'discount_product'); ?>
                                            </td>
                                            <td><?php echo $form->labelEx($generalRepair->header,'total_product_price'); ?></td>
                                            <td style="text-align: right">
                                                <?php echo $form->hiddenField($generalRepair->header,'total_product_price',array('size'=>18,'maxlength'=>18,'readonly'=>true,)); ?>
                                                <span id="grand_total_product">
                                                    <?php echo CHtml::encode(Yii::app()->numberFormatter->format("#,##0.00", CHtml::value($generalRepair->header,'total_product_price'))); ?>
                                                </span>
                                                <?php echo $form->error($generalRepair->header,'total_product_price'); ?>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="font-weight: bold"><?php echo $form->labelEx($generalRepair->header,'subtotal'); ?></td>
                                            <td style="text-align: right; font-weight: bold">
                                                <?php echo $form->hiddenField($generalRepair->header,'subtotal',array('size'=>18,'maxlength'=>18,'readonly'=>true,)); ?>
                                                <span id="sub_total_transaction">
                                                    <?php echo CHtml::encode(Yii::app()->numberFormatter->format("#,##0.00", CHtml::value($generalRepair->header,'subtotal'))); ?>
                                                </span>
                                                <?php echo $form->error($generalRepair->header,'subtotal'); ?>
                                            </td>
                                            <td style="font-weight: bold"><?php echo $form->labelEx($generalRepair->header,'ppn_price'); ?></td>
                                            <td style="text-align: right; font-weight: bold">
                                                <?php echo $form->hiddenField($generalRepair->header,'ppn_price',array('size'=>18,'maxlength'=>18,'readonly'=>true,)); ?>
                                                <span id="tax_item_amount">
                                                    <?php echo CHtml::encode(Yii::app()->numberFormatter->format("#,##0.00", CHtml::value($generalRepair->header,'ppn_price'))); ?>
                                                </span>
                                                <?php echo $form->error($generalRepair->header,'ppn_price'); ?>
                                            </td>
                                            <td style="font-weight: bold"><?php //echo $form->labelEx($generalRepair->header,'pph_price'); ?></td>
                                            <td style="text-align: right; font-weight: bold">
                                                <?php echo $form->hiddenField($generalRepair->header,'pph_price',array('readonly'=>true,)); ?>
                                                <span id="tax_service_amount">
                                                    <?php //echo CHtml::encode(Yii::app()->numberFormatter->format("#,##0.00", CHtml::value($generalRepair->header,'pph_price'))); ?>
                                                </span>
                                                <?php //echo $form->error($generalRepair->header,'pph_price'); ?>
                                            </td>
                                            <td style="font-weight: bold"><?php echo $form->labelEx($generalRepair->header,'grand_total'); ?></td>
                                            <td style="text-align: right; font-weight: bold">
                                                <?php echo $form->hiddenField($generalRepair->header,'grand_total',array('size'=>18,'maxlength'=>18,'readonly'=>true)); ?>
                                                <span id="grand_total_transaction">
                                                    <?php echo CHtml::encode(Yii::app()->numberFormatter->format("#,##0.00", CHtml::value($generalRepair->header,'grand_total'))); ?>
                                                </span>
                                                <?php echo $form->error($generalRepair->header,'grand_total'); ?>
                                            </td>
                                        </tr>
                                    </table>
                                </div>
        ...
        <?php $this->widget('zii.widgets.grid.CGridView', array(
            ...
            'selectionChanged'=>'js:function(id){
                ...
                $.ajax({
                    type: "POST",
                    //dataType: "JSON",
                    url: "' . CController::createUrl('ajaxHtmlAddProductDetail', array('id'=>$generalRepair->header->id,'productId'=>'')). '" + $.fn.yiiGridView.getSelection(id),
                    data:$("form").serialize(),
                    success: function(html) {
                        $("#product").html(html);
