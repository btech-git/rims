...
<div id="maincontent">
    <div class="clearfix page-action">
        <?php echo CHtml::link('<span class="fa fa-plus"></span>New Registration', Yii::app()->baseUrl . '/frontEnd/customerRegistration/vehicleList', array('class' => 'button success right', 'visible' => Yii::app()->user->checkAccess("frontEnd.generalRepair.admin"))); ?>
        ...
        'columns' => array(
            ...
            array(
                ...
                'buttons' => array(
                    'views' => array(
                        'label' => 'view',
                        'url' => 'Yii::app()->createUrl("frontEnd/generalRepair/view", array("id"=>$data->id))',
                        'visible' => 'Yii::app()->user->checkAccess("generalRepairCreate") || Yii::app()->user->checkAccess("generalRepairEdit")'
                    ),
                    'edit' => array(
                        'label' => 'edit',
                        'url' => 'Yii::app()->createUrl("frontEnd/generalRepair/update", array("id"=>$data->id))',
                        'visible' => 'Yii::app()->user->checkAccess("generalRepairEdit")', //' && $data->status != "Finished" && empty($data->invoiceHeaders)',
                    ),
                    'finish' => array(
                        'label' => 'finish',
                        'url' => 'Yii::app()->createUrl("frontEnd/generalRepair/finishTransaction", array("id"=>$data->id))',
