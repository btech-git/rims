<?php if (count($generalRepair->quickServiceDetails) > 0): ?>
    <table>
        <thead>
            <tr>
                <th>Quick Service</th>
        ...
        <tbody>
            <?php foreach ($generalRepair->quickServiceDetails as $i => $quickServiceDetail): ?>
                <tr>
                    ...
                    <td>
                        ...
                        <?php /* echo CHtml::button('add to Service', array(
                          ...
                          type: "POST",
                          //dataType: "JSON",
                          url: "' . CController::createUrl('ajaxHtmlAddQsServiceDetail', array('id'=>$generalRepair->header->id,'quickServiceId'=>'')). '" + $("#RegistrationQuickService_'.$i.'_quick_service_id").val(),
                          data:$("form").serialize(),
                    ...
                    <td>
                        ...
                        echo CHtml::button('X', array(
                            'onclick' => CHtml::ajax(array(
                                'type' => 'POST',
                                'url' => CController::createUrl('ajaxHtmlRemoveQuickServiceDetail', array('id' => $generalRepair->header->id, 'index' => $i)),
                                'update' => '#quickService',
                            )),
                        ));
                        ?>
