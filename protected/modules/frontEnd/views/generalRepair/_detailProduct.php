<?php if (count($generalRepair->productDetails) > 0): ?>
    <table>
        <thead>
            <tr>
                <th>Product name</th>
        ...
        <tbody>
            <?php foreach ($generalRepair->productDetails as $i => $productDetail): ?>
                ...
                <tr>
                    ...
                    <td>
                        <?php
                        echo CHtml::activeTextField($productDetail, "[$i]quantity", array(
                            'onchange' => CHtml::ajax(array(
                                'type' => 'POST',
                                'dataType' => 'JSON',
                                'url' => CController::createUrl('ajaxJsonTotalProduct', array('id' => $generalRepair->header->id, 'index' => $i)),
                    ...
                    <td>
                        <?php
                        echo CHtml::activeTextField($productDetail, "[$i]discount", array(
                            'onchange' => CHtml::ajax(array(
                                'type' => 'POST',
                                'dataType' => 'JSON',
                                'url' => CController::createUrl('ajaxJsonTotalProduct', array('id' => $generalRepair->header->id, 'index' => $i)),
                    ...
                    <td>
                        ...
                        echo CHtml::button('X', array(
                            'onclick' => CHtml::ajax(array(
                                'type' => 'POST',
                                'url' => CController::createUrl('ajaxHtmlRemoveProductDetail', array('id' => $generalRepair->header->id, 'index' => $i)),
                                'update' => '#product',
                            )),
                        ));
                        ?>
