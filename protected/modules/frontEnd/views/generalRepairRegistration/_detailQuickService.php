<?php if (count($generalRepairRegistration->quickServiceDetails)>0): ?>
	<table>
		<thead>
			<tr>
				<th>Quick Service</th>
		...
		<tbody>
			<?php foreach ($generalRepairRegistration->quickServiceDetails as $i => $quickServiceDetail): ?>
				<tr>
						...
						<?php /*echo CHtml::button('add to Service', array(
                            ...
                            'onclick' => '
                                ...
                                $.ajax({
                                    type: "POST",
                                    //dataType: "JSON",
                                    url: "' . CController::createUrl('ajaxHtmlAddQsServiceDetail', array('id'=>$generalRepairRegistration->header->id,'quickServiceId'=>'')). '" + $("#RegistrationQuickService_'.$i.'_quick_service_id").val(),
                                    data:$("form").serialize(),
					...
					<td>
                        <?php echo CHtml::button('X', array(
					     	'onclick' => CHtml::ajax(array(
						       	'type' => 'POST',
						       	'url' => CController::createUrl('ajaxHtmlRemoveQuickServiceDetail', array('id' => $generalRepairRegistration->header->id, 'index' => $i)),
						       	'update' => '#quickService',
				      		)),
				     	)); ?>
                    </td>
