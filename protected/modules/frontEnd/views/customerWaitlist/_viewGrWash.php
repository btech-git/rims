<?php $this->renderPartial('_search_grWash'); ?>

<?php $this->widget('ext.groupgridview.GroupGridView', array(
	'id'=>'grWashDatas-transaction-grid',
	'dataProvider'=>$grWashDatas,
	// 'filter'=>$model,
...
$('form').submit(function(){
	$('#grWashDatas-transaction-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
