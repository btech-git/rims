        ...
        <li class="mdropdown"><a href="#">LAPORAN</a>
            <?php $this->widget('zii.widgets.CMenu', array(
                'items' => array(
                    ...
                    array('label' => '-----------------------'),
                    array('label' => 'Laporan Balance Sheet', 'url' => array('/report/balanceSheet/summary'), 'visible' => Yii::app()->user->checkAccess('generalManager')),
                    ...
                    array('label' => 'Laporan Profit/Loss', 'url' => array('/report/profitLoss/summary'), 'visible' => Yii::app()->user->checkAccess('generalManager')),
