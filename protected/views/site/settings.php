                        ...
                        <div class="small-2 columns">
                            ...
                            <?php $this->widget('zii.widgets.CMenu',array(
                                'items'=>array(
                                    ...
                                    array('label'=>'Pricelist Standard', 'url'=>array('/master/serviceStandardPricelist/admin'), 'visible'=>Yii::app()->user->checkAccess('Master.ServiceStandardPricelist.View')),
                                    array('label'=>'Pricelist Group', 'url'=>array('/master/serviceGroup/admin'), 'visible'=>Yii::app()->user->checkAccess('Master.ServiceType.View')),
                                    array('label'=>'Pricelist Set', 'url'=>array('/master/servicePricelist/admin'), 'visible'=>Yii::app()->user->checkAccess('Master.ServicePricelist.View')),
