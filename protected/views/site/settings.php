                            ...
                            <?php $this->widget('zii.widgets.CMenu', array(
                                'items' => array(
                                    array(
                                        ...
                                        'visible' => Yii::app()->user->checkAccess('masterUserCreate') || Yii::app()->user->checkAccess('masterUserEdit') || 
                                            Yii::app()->user->checkAccess('masterUserView') || Yii::app()->user->checkAccess('masterUserApproval')
                                    ),
                                    array(
                                        'label' => 'Company', 
                                        'url' => array('/master/company/admin'), 
                                        'visible' => Yii::app()->user->checkAccess('masterCompanyCreate') || Yii::app()->user->checkAccess('masterCompanyEdit') || 
                                            Yii::app()->user->checkAccess('masterCompanyView') || Yii::app()->user->checkAccess('masterCompanyApproval')
                                    ),
                                    array(
                                        'label' => 'Branch', 
                                        'url' => array('/master/branch/admin'), 
                                        'visible' => Yii::app()->user->checkAccess('masterBranchCreate') || Yii::app()->user->checkAccess('masterBranchEdit') || 
                                            Yii::app()->user->checkAccess('masterBranchView') || Yii::app()->user->checkAccess('masterBranchApproval')
                                    ),
                                    array(
                                        'label' => 'Supplier', 
                                        'url' => array('/master/supplier/admin'), 
                                        'visible' => Yii::app()->user->checkAccess('masterSupplierCreate') || Yii::app()->user->checkAccess('masterSupplierEdit') || 
                                    ...
                                    array(
                                        ...
                                        'visible' => Yii::app()->user->checkAccess('masterDeductionCreate') || Yii::app()->user->checkAccess('masterDeductionEdit') || 
                                    ...
                                    array(
                                        ...
                                        'visible' => Yii::app()->user->checkAccess('masterIncentiveCreate') || Yii::app()->user->checkAccess('masterIncentiveEdit') || 
                                    ...
                                    array(
                                        ...
                                        'visible' => Yii::app()->user->checkAccess('masterPositionCreate') || Yii::app()->user->checkAccess('masterPositionEdit') || 
                                    ...
                                    array(
                                        ...
                                        'visible' => Yii::app()->user->checkAccess('masterDivisionCreate') || Yii::app()->user->checkAccess('masterDivisionEdit') || 
                                            Yii::app()->user->checkAccess('masterDivisionView') || Yii::app()->user->checkAccess('masterDivisionApproval')
                                    ),
                                    array(
                                        'label' => 'Level',
                                        'url' => array('/master/level/admin'), 
                                        'visible' => Yii::app()->user->checkAccess('masterLevelCreate') || Yii::app()->user->checkAccess('masterLevelEdit') || 
                                            Yii::app()->user->checkAccess('masterLevelView') || Yii::app()->user->checkAccess('masterLevelApproval')
                                    ),
                                ),
                            )); ?>
                        <?php endif; ?>
...
//                                        'linkOptions' => array('class' => 'titleNav'), 
                                        'visible' => Yii::app()->user->checkAccess('masterProductCreate') || Yii::app()->user->checkAccess('masterProductEdit') || 
                                            Yii::app()->user->checkAccess('masterProductView') || Yii::app()->user->checkAccess('masterProductApproval')
                                    ),
                                    array(
                                        'label' => 'Product Category', 
                                        'url' => array('/master/productMasterCategory/admin'), 
                                        'visible' => Yii::app()->user->checkAccess('masterProductCategoryCreate') || Yii::app()->user->checkAccess('masterProductCategoryEdit') || 
                                            Yii::app()->user->checkAccess('masterProductCategoryView') || Yii::app()->user->checkAccess('masterProductCategoryApproval')
                                    ),
                                    array(
                                        'label' => 'Product Sub-Master Category', 
                                        'url' => array('/master/productSubMasterCategory/admin'), 
                                        'visible' => Yii::app()->user->checkAccess('masterProductSubMasterCategoryCreate') || Yii::app()->user->checkAccess('masterProductSubMasterCategoryEdit') || 
                                            Yii::app()->user->checkAccess('masterProductSubMasterCategoryView') || Yii::app()->user->checkAccess('masterProductSubMasterCategoryApproval')
                                    ),
                                    array(
                                        'label' => 'Product Sub-Category', 
                                        'url' => array('/master/productSubCategory/admin'), 
                                        'visible' => Yii::app()->user->checkAccess('masterProductSubCategoryCreate') || Yii::app()->user->checkAccess('masterProductSubCategoryEdit') || 
                                            Yii::app()->user->checkAccess('masterProductSubCategoryView') || Yii::app()->user->checkAccess('masterProductSubCategoryApproval')
                                    ),
                                    array(
                                        'label' => 'Brand', 
                                        'url' => array('/master/brand/admin'), 
                                        'visible' => Yii::app()->user->checkAccess('masterBrandCreate') || Yii::app()->user->checkAccess('masterBrandEdit') || 
                                            Yii::app()->user->checkAccess('masterBrandView') || Yii::app()->user->checkAccess('masterBrandApproval')
                                    ),
                                    array(
                                        'label' => 'Sub Brand', 
                                        'url' => array('/master/subBrand/admin'), 
                                        'visible' => Yii::app()->user->checkAccess('masterSubBrandCreate') || Yii::app()->user->checkAccess('masterSubBrandEdit') || 
                                            Yii::app()->user->checkAccess('masterSubBrandView') || Yii::app()->user->checkAccess('masterSubBrandApproval')
                                    ),
                                    array(
                                        'label' => 'Sub Brand Series', 
                                        'url' => array('/master/subBrandSeries/admin'), 
                                        'visible' => Yii::app()->user->checkAccess('masterSubBrandSeriesCreate') || Yii::app()->user->checkAccess('masterSubBrandSeriesEdit') || 
                                            Yii::app()->user->checkAccess('masterSubBrandSeriesView') || Yii::app()->user->checkAccess('masterSubBrandSeriesApproval')
                                    ),
                                    array(
                                        'label' => 'Satuan', 
                                        'url' => array('/master/unit/admin'), 
                                        'visible' => Yii::app()->user->checkAccess('masterUnitCreate') || Yii::app()->user->checkAccess('masterUnitEdit') || 
                                            Yii::app()->user->checkAccess('masterUnitView') || Yii::app()->user->checkAccess('masterUnitApproval')
                                    ),
                                    array(
                                        'label' => 'Konversi Satuan', 
                                        'url' => array('/master/unitConversion/admin'), 
                                        'visible' => Yii::app()->user->checkAccess('masterConversionCreate') || Yii::app()->user->checkAccess('masterConversionEdit') || 
                                            Yii::app()->user->checkAccess('masterConversionView') || Yii::app()->user->checkAccess('masterConversionApproval')
                                    ),
                                    array(
                                        'label' => 'Ukuran Ban', 
                                        'url' => array('/master/tireSize/admin'), 
                                        'visible' => Yii::app()->user->checkAccess('masterTireSizeCreate') || Yii::app()->user->checkAccess('masterTireSizeEdit') || 
                                            Yii::app()->user->checkAccess('masterTireSizeView') || Yii::app()->user->checkAccess('masterTireSizeApproval')
                                    ),
                                    array(
                                        'label' => 'Spesifikasi Oli (SAE)', 
                                        'url' => array('/master/oilSae/admin'), 
                                        'visible' => Yii::app()->user->checkAccess('masterOilSpecificationCreate') || Yii::app()->user->checkAccess('masterOilSpecificationEdit') || 
                                            Yii::app()->user->checkAccess('masterOilspecificationView') || Yii::app()->user->checkAccess('masterOilSpecificationApproval')
                                    ),
                                ),
                            )); ?>
                        <?php endif; ?>
...
//                                    'linkOptions' => array('class' => 'titleNav'), 
                                    'visible' => Yii::app()->user->checkAccess('masterServiceCreate') || Yii::app()->user->checkAccess('masterServiceEdit') || 
                                        Yii::app()->user->checkAccess('masterServiceView') || Yii::app()->user->checkAccess('masterServiceApproval')
                                ),
                                array(
                                    'label' => 'Service Category', 
                                    'url' => array('/master/serviceCategory/admin'), 
                                    'visible' => Yii::app()->user->checkAccess('masterServiceCategoryCreate') || Yii::app()->user->checkAccess('masterServiceCategoryEdit') || 
                                        Yii::app()->user->checkAccess('masterServiceCategoryView') || Yii::app()->user->checkAccess('masterServiceCategoryApproval')
                                ),
                                array(
                                    'label' => 'Service Type', 
                                    'url' => array('/master/serviceType/admin'), 
                                    'visible' => Yii::app()->user->checkAccess('masterServiceTypeCreate') || Yii::app()->user->checkAccess('masterServiceTypeEdit') || 
                                        Yii::app()->user->checkAccess('masterServiceTypeView') || Yii::app()->user->checkAccess('masterServiceTypeApproval')
                                ),
                                array(
                                    'label' => 'Quick Service', 
                                    'url' => array('/master/quickService/admin'), 
                                    'visible' => Yii::app()->user->checkAccess('masterQuickServiceCreate') || Yii::app()->user->checkAccess('masterQuickServiceEdit') || 
                                        Yii::app()->user->checkAccess('masterQuickServiceView') || Yii::app()->user->checkAccess('masterQuickServiceApproval')
                                ),
                            ),
                        )); ?>
                        <?php endif; ?>
                ...
                <div class="row" style="margin-top:20px" id="noliststyle">
                            ...
                            <?php $this->widget('zii.widgets.CMenu', array(
                                'items' => array(
                                    array(
                                        ...
                                        'visible' => Yii::app()->user->checkAccess('masterBankCreate') || Yii::app()->user->checkAccess('masterBankEdit') || 
                                            Yii::app()->user->checkAccess('masterBankView') || Yii::app()->user->checkAccess('masterBankApproval')
                                    ),
                                    array(
                                        'label' => 'COA', 
                                        'url' => array('/accounting/coa/admin'), 
                                        'visible' => Yii::app()->user->checkAccess('masterCoaCreate') || Yii::app()->user->checkAccess('masterCoaEdit') || 
                                            Yii::app()->user->checkAccess('masterCoaView') || Yii::app()->user->checkAccess('masterCoaApproval')
                                    ),
                                    array(
                                        'label' => 'COA Category', 
                                        'url' => array('/master/coaCategory/admin'), 
                                        'visible' => Yii::app()->user->checkAccess('masterCoaCategoryCreate') || Yii::app()->user->checkAccess('masterCoaCategoryEdit') || 
                                            Yii::app()->user->checkAccess('masterCoaCategoryView') || Yii::app()->user->checkAccess('masterCoaCategoryApproval')
                                    ),
                                    array(
                                        'label' => 'COA Sub Category', 
                                        'url' => array('/master/coaSubCategory/admin'), 
                                        'visible' => Yii::app()->user->checkAccess('masterCoaSubCategoryCreate') || Yii::app()->user->checkAccess('masterCoaSubCategoryEdit') || 
                                            Yii::app()->user->checkAccess('masterCoaSubCategoryView') || Yii::app()->user->checkAccess('masterCoaSubCategoryApproval')
                                    ),
                                    array(
                                        'label' => 'Payment Type', 
                                        'url' => array('/master/paymentType/admin'), 
                                        'visible' => Yii::app()->user->checkAccess('masterPaymentTypeCreate') || Yii::app()->user->checkAccess('masterPaymentTypeEdit') || 
                                            Yii::app()->user->checkAccess('masterPaymentTypeView') || Yii::app()->user->checkAccess('masterPaymentTypeApproval')
                                    ),
                                ),
                            )); ?>
                        <?php endif; ?>
                    ...
                    <div class="small-3 columns">
                        ...
                        <?php if (
                            ...
                            Yii::app()->user->checkAccess('maintenanceRequestCreate') || 
                            Yii::app()->user->checkAccess('maintenanceRequestEdit') || 
                            Yii::app()->user->checkAccess('maintenanceRequestView') || 
                            Yii::app()->user->checkAccess('maintenanceRequestApproval')
                        ): ?>
                            <h2>Equipments</h2>
                            <?php $this->widget('zii.widgets.CMenu', array(
                                'items' => array(
                                    array(
                                        ...
                                        'visible' => Yii::app()->user->checkAccess('masterEquipmentCreate') || Yii::app()->user->checkAccess('masterEquipmentEdit') || 
                                            Yii::app()->user->checkAccess('masterEquipmentView') || Yii::app()->user->checkAccess('masterEquipmentApproval')
                                    ),
                                    array(
                                        'label' => 'Equipment Type', 
                                        'url' => array('/master/equipmentType/admin'), 
                                        'visible' => Yii::app()->user->checkAccess('masterEquipmentTypeCreate') || Yii::app()->user->checkAccess('masterEquipmentTypeEdit') || 
                                            Yii::app()->user->checkAccess('masterEquipmentTypeView') || Yii::app()->user->checkAccess('masterEquipmentTypeApproval')
                                    ),
                                    array(
                                        'label' => 'Equipment Sub Type', 
                                        'url' => array('/master/equipmentSubType/admin'), 
                                        'visible' => Yii::app()->user->checkAccess('masterEquipmentSubTypeCreate') || Yii::app()->user->checkAccess('masterEquipmentSubTypeEdit') || 
                                            Yii::app()->user->checkAccess('masterEquipmentSubTypeView') || Yii::app()->user->checkAccess('masterEquipmentSubTypeApproval')
                                    ),
                                    array(
                                        ...
                                        'visible' => Yii::app()->user->checkAccess('maintenanceRequestCreate') || Yii::app()->user->checkAccess('maintenanceRequestEdit')|| 
                                            Yii::app()->user->checkAccess('maintenanceRequestView') || Yii::app()->user->checkAccess('maintenanceRequestApproval')
                                    ),
                                ),
                            )); ?>
                        <?php endif; ?>
                        ...
                        <?php $this->widget('zii.widgets.CMenu', array(
                            'items' => array(
                                array(
                                    ...
                                    'visible' => Yii::app()->user->checkAccess('masterPricelistStandardCreate') || Yii::app()->user->checkAccess('masterPricelistStandardEdit') || 
                                        Yii::app()->user->checkAccess('masterPricelistStandardView') || Yii::app()->user->checkAccess('masterPricelistStandardApproval')
                                ),
                                array(
                                    'label' => 'Pricelist Group', 
                                    'url' => array('/master/serviceGroup/admin'), 
                                    'visible' => Yii::app()->user->checkAccess('masterPricelistGroupCreate') || Yii::app()->user->checkAccess('masterPricelistGroupEdit') || 
                                        Yii::app()->user->checkAccess('masterPricelistGroupView') || Yii::app()->user->checkAccess('masterPricelistGroupApproval')
                                ),
                                array(
                                    'label' => 'Pricelist Set', 
                                    'url' => array('/master/servicePricelist/admin'), 
                                    'visible' => Yii::app()->user->checkAccess('masterPricelistSetCreate') || Yii::app()->user->checkAccess('masterPricelistSetEdit') || 
                                        Yii::app()->user->checkAccess('masterPricelistSetView') || Yii::app()->user->checkAccess('masterPricelistSetApproval')
                                ),
                                array(
                                    'label' => 'Standard Flat Rate', 
                                    'url' => array('/master/generalStandardFr/admin'), 
                                    'visible' => Yii::app()->user->checkAccess('masterStandardFlatrateCreate') || Yii::app()->user->checkAccess('masterStandardFlatrateEdit') || 
                                        Yii::app()->user->checkAccess('masterStandardFlatrateView') || Yii::app()->user->checkAccess('masterStandardFlatrateApproval')
                                ),
                                array(
                                    'label' => 'Standard Value', 
                                    'url' => array('/master/generalStandardValue/admin'), 
                                    'visible' => Yii::app()->user->checkAccess('masterStandardValueCreate') || Yii::app()->user->checkAccess('masterStandardValueEdit') || 
                                        Yii::app()->user->checkAccess('masterStandardValueView') || Yii::app()->user->checkAccess('masterStandardValueApproval')
                                ),
                            ),
                        )); ?>
                        <?php endif; ?>
                    ...
                    <div class="small-3 columns">
                        ...
                        <?php if (
                            ...
                            Yii::app()->user->checkAccess('masterAssetCategoryCreate') || 
                            Yii::app()->user->checkAccess('masterAssetCategoryEdit') || 
                            Yii::app()->user->checkAccess('masterAssetCategoryView') || 
                            Yii::app()->user->checkAccess('masterAssetCategoryApproval')
                        ): ?>
                            <h2>Warehouse</h2>
                            <?php $this->widget('zii.widgets.CMenu', array(
                                'items' => array(
                                    array(
                                        ...
                                        'visible' => Yii::app()->user->checkAccess('masterWarehouseCreate') || Yii::app()->user->checkAccess('masterWarehouseEdit') || 
                                            Yii::app()->user->checkAccess('masterWarehouseView') || Yii::app()->user->checkAccess('masterWarehouseApproval')
                                    ),
                                    array(
                                        'label' => 'Kategori Aset', 
                                        'url' => array('/master/assetCategory/admin'), 
                                        'visible' => Yii::app()->user->checkAccess('masterAssetCategoryCreate') || Yii::app()->user->checkAccess('masterAssetCategoryEdit') || 
                                            Yii::app()->user->checkAccess('masterAssetCategoryView') || Yii::app()->user->checkAccess('masterAssetCategoryApproval')
                                    ),
                                ),
                            )); ?>
                        <?php endif; ?>
                        ...
                        <?php $this->widget('zii.widgets.CMenu', array(
                            'items' => array(
                                array(
                                    ...
                                    'visible' => Yii::app()->user->checkAccess('masterInspectionCreate') || Yii::app()->user->checkAccess('masterInspectionEdit') || 
                                        Yii::app()->user->checkAccess('masterInspectionView') || Yii::app()->user->checkAccess('masterInspectionApproval')
                                ),
                                array(
                                    'label' => 'System(s) to Check', 
                                    'url' => array('/master/inspectionSection/admin'), 
                                    'visible' => Yii::app()->user->checkAccess('masterInspectionSectionCreate') || Yii::app()->user->checkAccess('masterInspectionSectionEdit') || 
                                        Yii::app()->user->checkAccess('masterInspectionSectionView') || Yii::app()->user->checkAccess('masterInspectionSectionApproval')
                                ),
                                array(
                                    'label' => 'Function & Components in System', 
                                    'url' => array('/master/inspectionModule/admin'), 
                                    'visible' => Yii::app()->user->checkAccess('masterInspectionModuleCreate') || Yii::app()->user->checkAccess('masterInspectionModuleEdit') || 
                                        Yii::app()->user->checkAccess('masterInspectionModuleView') || Yii::app()->user->checkAccess('masterInspectionModuleApproval')
                                ),
                            ),
                        )); ?>
                        <?php endif; ?>
