...
;(function ($, window, document, undefined) {
    ...
    $(document).ready(function () {
        // apply dropdownHover to all elements with the data-toggle="dropdown" attribute
